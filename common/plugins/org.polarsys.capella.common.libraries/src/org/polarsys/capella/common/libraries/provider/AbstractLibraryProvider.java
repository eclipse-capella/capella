...
public abstract class AbstractLibraryProvider implements ILibraryProvider {
  ...
  private Collection<ILibraryProviderListener> listeners = new ArrayList<ILibraryProviderListener>();
  ...
  public void notifyListeners(ILibraryProviderListener.ILibraryProviderEvent event_p) {
    for (ILibraryProviderListener listener : listeners) {
      listener.onLibraryProviderChanged(event_p);
    }
  }
}
