      ...
      try {
        ...
        if (severity instanceof Integer){
          switch ((Integer)severity){
            case IMarker.SEVERITY_ERROR :    result = ERROR; break;
            case IMarker.SEVERITY_WARNING :  result = WARNING; break;
            case IMarker.SEVERITY_INFO :     result = INFO; break;
          }
        }
        else {
          ...
          if (severity.equals(Level.DEBUG)) {
            result = DEBUG;
          } else if (severity.equals(Level.INFO)) {
            result = INFO;
          } else if (severity.equals(Level.WARN)){
            result = WARNING;
          } else if (severity.equals(Level.ERROR)) {
            result = ERROR;
          } else if (severity.equals(Level.FATAL)) {
            result = FATAL;
          }
        }
