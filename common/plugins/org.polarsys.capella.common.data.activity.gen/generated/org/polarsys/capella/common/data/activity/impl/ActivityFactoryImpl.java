...
public class ActivityFactoryImpl extends EFactoryImpl implements ActivityFactory {
	...
	public static ActivityFactory init() {
		try {
			ActivityFactory theActivityFactory = (ActivityFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.polarsys.org/capella/common/activity/1.0.0"); //$NON-NLS-1$ 
