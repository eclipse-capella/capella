 ...
 * <ul>
 *   <li>{@link org.polarsys.capella.common.data.activity.impl.OutputPinImpl#isIsControl <em>Is Control</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class OutputPinImpl extends ObjectNodeImpl implements OutputPin {
	...
	protected EClass eStaticClass() {
		return ActivityPackage.Literals.OUTPUT_PIN;
	}
	...
	public void setIsControl(boolean newIsControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.OUTPUT_PIN__IS_CONTROL, oldIsControl, isControl));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityPackage.OUTPUT_PIN__IS_CONTROL:
				return isIsControl();
		}
