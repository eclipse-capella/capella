 ...
 *******************************************************************************/
package org.polarsys.capella.common.ui.toolkit.browser.viewer;
...
public class BrowserComposite extends Composite {
  ...
  public BrowserComposite(Composite parent_p, int style_p, String labelText_p) {
    ...
    // Style given to the Tree should contain SWT.MULTI (as in this constructor) to have a beautiful drag feedback (else it's just a rectangle).
