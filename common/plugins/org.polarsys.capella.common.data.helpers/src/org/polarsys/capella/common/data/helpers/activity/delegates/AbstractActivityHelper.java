...
public class AbstractActivityHelper {
	...
	public Object doSwitch(AbstractActivity element_p, EStructuralFeature feature_p){
		Object ret = null;
		
		if (feature_p.equals(ActivityPackage.Literals.ABSTRACT_ACTIVITY__OWNED_STRUCTURED_NODES)) {
			ret = getOwnedStructureNodes(element_p);
		}
	...
	protected List<StructuredActivityNode> getOwnedStructureNodes (AbstractActivity element_p) {
