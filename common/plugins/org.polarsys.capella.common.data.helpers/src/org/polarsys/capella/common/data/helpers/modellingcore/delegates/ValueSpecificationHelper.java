...
public class ValueSpecificationHelper {
  ...
  public Object doSwitch(ValueSpecification element_p, EStructuralFeature feature_p) {
    Object ret = null;

    // no helper found... searching in super classes...
    if (null == ret) {
      ret = AbstractTypedElementHelper.getInstance().doSwitch(element_p, feature_p);
    }
