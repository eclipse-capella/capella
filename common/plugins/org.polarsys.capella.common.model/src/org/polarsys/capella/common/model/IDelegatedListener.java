...
public interface IDelegatedListener {
  ...
  /**
   * @return {@code TRUE} if the given notification {@code notification_p} has to be filtered, and {@code FALSE} otherwise.
   */
   ...
   * @return {@code TRUE} if the given object {@code object_p} is modifiable.
   */
