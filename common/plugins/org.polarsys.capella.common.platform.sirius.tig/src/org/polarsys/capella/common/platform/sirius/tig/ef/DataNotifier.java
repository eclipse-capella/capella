...
public class DataNotifier extends EContentAdapter {
  ...
  public void notifyChanged(Notification notification_p) {
    try {
	  ...
	  PlatformSiriusTigActivator.getDefault().getLog().log(
          new Status(IStatus.ERROR, PlatformSiriusTigActivator.getDefault().getPluginId(), exception_p.getMessage(), exception_p));
