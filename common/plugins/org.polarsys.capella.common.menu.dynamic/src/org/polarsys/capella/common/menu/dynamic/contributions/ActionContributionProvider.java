...
public class ActionContributionProvider {
  ...
  private ActionContributionProvider() {
    ...
    // Load contributions.
    IConfigurationElement[] contributors = ExtensionPointHelper.getConfigurationElements(FrameworkUtil.getBundle(ActionContributionProvider.class).getSymbolicName(), MENU_ITEM_CONTRIBUTION_EXTENSION_ID);
