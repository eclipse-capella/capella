...
public class IdManager {
  ...
  private List<IIdHandler> getContributedIdHandlers() {
    if (null == __contributedIdHandlers) {
      ...
      IConfigurationElement[] element = ExtensionPointHelper.getConfigurationElements(FrameworkUtil.getBundle(IdHandlerPlugin.class).getSymbolicName(), "IdHandler"); //$NON-NLS-1$
