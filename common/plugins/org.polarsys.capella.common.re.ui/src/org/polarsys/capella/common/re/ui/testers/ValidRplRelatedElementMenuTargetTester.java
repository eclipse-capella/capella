...
public class ValidRplRelatedElementMenuTargetTester extends PropertyTester {

  public static final String PROPERTY_IS_VALID_MENU_TARGET = "hasRelatedRplElements"; //$NON-NLS-1$
  ...
  public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
    ...
    if (receiver instanceof IStructuredSelection) {
      ...
      if (PROPERTY_IS_VALID_MENU_TARGET.equals(property)) {
        return RplDynamicMenu.hasCommonRpls(selection);
      }
    } else {
