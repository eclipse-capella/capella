...
public class InitializeDiffMergeUpdateReActivity extends InitializeDiffMergeFromTransformationActivity {
  ...
  public IStatus _run(ActivityParameters activityParams_p) {
    ...
    Collection<EObject> sources =
        OptionsHandlerHelper.getInstance(context).getCollectionValue(context, IReConstants.UPDATE_REPLICABLE_ELEMENT,
    ...
    if (sources.iterator().hasNext()) {
      ...
      ReplicableElementHandlerHelper.getInstance(context).setReplica(context, source);
    ...
    if (targets.iterator().hasNext()) {
      ...
      ReplicableElementHandlerHelper.getInstance(context).setReplicableElement(context, target);
