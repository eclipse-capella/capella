...
public class LibrariesFactoryImpl extends EFactoryImpl implements LibrariesFactory {
	...
	public static LibrariesFactory init() {
		try {
			LibrariesFactory theLibrariesFactory = (LibrariesFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.polarsys.org/capella/common/libraries/1.0.0"); //$NON-NLS-1$ 
