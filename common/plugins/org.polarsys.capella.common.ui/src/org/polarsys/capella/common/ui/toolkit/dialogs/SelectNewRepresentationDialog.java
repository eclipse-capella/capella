...
public class SelectNewRepresentationDialog extends AbstractSelectionDialog<RepresentationDescription> {
	...
	public SelectNewRepresentationDialog(Shell parentShell, String message, EObject selectedEObject, Collection<RepresentationDescription> descriptions) {
		...
		setTitle("New representation for " + ((NamedElement)selectedEObject).getName());
	...
	protected Control createDialogArea(Composite parent) {
		...
		// Add a selection change listener on the combo to update the default name in text field 
		comboViewer.addSelectionChangedListener(
				event -> text.setText(computeDefaultName(selectedEObject,(RepresentationDescription) ((StructuredSelection)event.getSelection()).getFirstElement())));
