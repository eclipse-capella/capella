...
public abstract class AbstractMdeElementListSelectionDialog extends SelectionStatusDialog {
   ...
   * @param renderer_p ILabelProvider for the list
   */
  protected AbstractMdeElementListSelectionDialog(Shell parent_p, ILabelProvider renderer_p) {
    super(parent_p);
   ...
   * @param ignoreCase_p
   */
  public void setIgnoreCase(boolean ignoreCase_p) {
    _ignoreCase = ignoreCase_p;
  }
   ...
   * @param matchEmptyString_p boolean
   */
  public void setMatchEmptyString(boolean matchEmptyString_p) {
    _matchEmptyString = matchEmptyString_p;
  }

  /**
   * Specifies if multiple selection is allowed.
   * @param multipleSelection_p
   */
  public void setMultipleSelection(boolean multipleSelection_p) {
    _isMultipleSelection = multipleSelection_p;
  }

  /**
   * Specifies whether duplicate entries are displayed or not.
   * @param allowDuplicates_p
   */
  public void setAllowDuplicates(boolean allowDuplicates_p) {
    _allowDuplicates = allowDuplicates_p;
  }

  /**
   * Sets the list size in unit of characters.
   * @param width_p the width of the list.
   * @param height_p the height of the list.
   */
  public void setSize(int width_p, int height_p) {
    _width = width_p;
    _height = height_p;
  }
   ...
   * @param message_p the message to be displayed.
   */
  public void setEmptyListMessage(String message_p) {
    _emptyListMessage = message_p;
  }
   ...
   * @param message_p the message to be displayed.
   */
  public void setEmptySelectionMessage(String message_p) {
    _emptySelectionMessage = message_p;
  }

  /**
   * Sets an optional validator to check if the selection is valid. The validator is invoked whenever the selection changes.
   * @param validator_p the validator to validate the selection.
   */
  public void setValidator(ISelectionStatusValidator validator_p) {
  ...
  protected void setListElements(Object[] elements_p) {
    ...
    _filteredList.setElements(elements_p);
  }

  /**
   * Sets the filter pattern.
   * @param filter_p the filter pattern.
   */
  public void setFilter(String filter_p) {
    if (_filterText == null) {
      _filter = filter_p;
    } else {
      _filterText.setText(filter_p);
    }
  }
   ...
   * @param selection_p the indices of the selection.
   */
  protected void setSelection(Object[] selection_p) {
    Assert.isNotNull(_filteredList);
    _filteredList.setSelection(selection_p);
  }
   ...
   * @param index_p the index selecting the entry in the list.
   * @return returns an array of elements folded together.
   */
  public Object[] getFoldedElements(int index_p) {
    Assert.isNotNull(_filteredList);
    return _filteredList.getFoldedElements(index_p);
  }

  /**
   * Creates the message text widget and sets layout data.
   * @param composite_p the parent composite of the message area.
   */
  @Override
  protected Label createMessageArea(Composite composite_p) {
    Label label = super.createMessageArea(composite_p);
   ...
   */
  protected MdeFilteredList createFilteredList(Composite parent_p) {
    int flags = SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL | (_isMultipleSelection ? SWT.MULTI : SWT.SINGLE);

    MdeFilteredList list = new MdeFilteredList(parent_p, flags, _renderer, _ignoreCase, _allowDuplicates, _matchEmptyString);
