...
/**
 * This category hides component allocation of function if the function is decomposed in the target architecture
 * (indeed allocations of parent functions are not semantically valid)
 */
public class NoLeafFunctionalAllocationCategoryFilter extends CategoryFilter {
  ...
  public NoLeafFunctionalAllocationCategoryFilter(IContext context) {
    super(context, ID, Messages.NoLeafFunctionalAllocationCategoryFilter, Messages.NoLeafFunctionalAllocationCategoryFilter, null);
