...
public class DiffModelViewerFactory implements IDiffModelViewerFactory {
   ...
   * {@inheritDoc}
   */
  public IDiffModelViewer createDiffModelViewer(IDifference diff, DiffScope diffScope, FilterAction action, IContext context, boolean isReadOnly) {
    return new DiffModelViewer(diff, diffScope, action, context, isReadOnly);
  }
}
