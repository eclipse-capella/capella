...
import org.polarsys.capella.core.re.ui.commands.DeleteReplicaAndRelatedElementsUiCommand;
...
public class DeleteReplicaAndRelatedElementsUiHandler extends org.polarsys.capella.core.re.handlers.DeleteReplicaAndRelatedElementsHandler {
	...
	/**
	  ...
	  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
	    return new DeleteReplicaAndRelatedElementsUiCommand(selection_p, progressMonitor_p) {
	      //
	    };
	  }
