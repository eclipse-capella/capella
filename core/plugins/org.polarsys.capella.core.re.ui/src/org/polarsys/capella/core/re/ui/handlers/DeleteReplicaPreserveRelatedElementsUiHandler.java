...
import org.polarsys.capella.core.re.ui.commands.DeleteReplicaPreserveRelatedElementsUiCommand;
...
public class DeleteReplicaPreserveRelatedElementsUiHandler extends org.polarsys.capella.core.re.handlers.DeleteReplicaPreserveRelatedElementsHandler {
	...
	/**
	  ...
	  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
	    return new DeleteReplicaPreserveRelatedElementsUiCommand(selection_p, progressMonitor_p);
	  }
