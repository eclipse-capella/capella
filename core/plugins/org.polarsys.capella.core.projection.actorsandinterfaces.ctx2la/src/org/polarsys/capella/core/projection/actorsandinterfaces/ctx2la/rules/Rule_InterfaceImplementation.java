...
/**
 */
public class Rule_InterfaceImplementation extends TransfoRule {
  ...
  public EObject transform_(EObject element_p, ITransfo transfo_p) {
    return CsFactory.eINSTANCE.createInterfaceImplementation();    
  }
  ...
  public void attach_(EObject element_p, ITransfo transfo_p) throws TransfoException {
	    ...
	    InterfaceImplementation targetElement = (InterfaceImplementation) Query.retrieveTransformedElement(sourceElement, transfo_p);
	    
	    Actor sourceActor = (Actor) sourceElement.getInterfaceImplementor();
	    Interface sourceInterface = sourceElement.getImplementedInterface();
	    ...
	    if (targetActor != null && targetInterface != null) {
	    	targetActor.getOwnedInterfaceImplementations().add(targetElement);
	    	targetElement.setImplementedInterface(targetInterface);
	    }
	  }
