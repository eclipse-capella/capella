...
public class ModelPreferencePage extends AbstractDefaultPreferencePage {
  ...
  protected void createFieldEditors() {
    ...
    Group group0 = createGroup(Messages.ReuseOfComponentsPreferencePage_Group_Title, Messages.ReuseOfComponentsPreferencePage_Group_Title, fieldEditorParent);
    ...
    Group group2 = createGroup(Messages.DeploymentPreferencePage_Group_Title, Messages.DeploymentPreferencePage_Group_Title, fieldEditorParent);
    addField(new PreferenceField(IDeploymentPreferences.PREFS_ALLOW_MULTIPLE_DEPLOYMENT, Messages.DeploymentPreferencePage_Allowed_Title, group2),
        UserProfileModeEnum.Expert, group2, ProjectScope.class);

    addField(new SpacerFieldEditor(fieldEditorParent));
    Group group3 = createGroup(Messages.DataPreferencePage_Group_Title, Messages.DataPreferencePage_Group_Title, fieldEditorParent);
    addField(new PreferenceField(IDataPreferences.PREFS_ALLOW_PRIMITIVE_SYNCHRONIZATION, Messages.DataPreferencePage_PrimitiveSynchroAllowed_Title, group3),
        UserProfileModeEnum.Expert, group3, ProjectScope.class);

    addField(new SpacerFieldEditor(fieldEditorParent));
    Group group4 = createGroup(Messages.SyncPreferencePage_Group_Title, Messages.SyncPreferencePage_Group_Title, fieldEditorParent);
    addField(new PreferenceField(ISynchronizationPreferences.PREFS_ALLOW_SYNC_COMPONENTPORT_TO_FUNCTIONPORT,
        Messages.SyncPreferencePage_SyncComponentPort2FunctionPortAllowed_Title, group4), UserProfileModeEnum.Expert, group4, ProjectScope.class);
    addField(new PreferenceField(ISynchronizationPreferences.PREFS_ALLOW_SYNC_PHYSICALPORT_TO_COMPONENTPORT_ON_PHYSICALLINK,
