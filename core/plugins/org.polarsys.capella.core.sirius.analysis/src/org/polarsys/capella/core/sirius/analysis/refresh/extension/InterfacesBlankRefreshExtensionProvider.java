...
/**
 */
public class InterfacesBlankRefreshExtensionProvider implements IRefreshExtensionProvider {

    private static final InterfacesBlankRefreshExtension REFRESH_EXTENSION = new InterfacesBlankRefreshExtension();
    ...
    public boolean provides(DDiagram viewPoint) {
        return IDiagramNameConstants.INTERFACES_BLANK_DIAGRAM_NAME.equals(viewPoint.getDescription().getName());
    }
