...
public class CapellaDefaultAttachmentHandler extends DefaultAttachmentHandler {
  ...
  protected boolean shouldUpdateAttribute(EObject sourceElement, EObject targetElement, EAttribute feature, Object valueSource, Object valueTarget,
    ...
    if (ModellingcorePackage.Literals.ABSTRACT_NAMED_ELEMENT__NAME.equals(feature) || CapellacorePackage.Literals.CAPELLA_ELEMENT__SUMMARY.equals(feature)
  ...
  protected boolean shouldUpdateAttributeIfEmpty(EObject sourceElement, EObject targetElement, EAttribute feature, Object valueSource,
      Object valueTarget, IContext context) {
  ...
  public void removeElements(Collection<EObject> objects, IContext context) {
    ...
    DeleteStructureCommand command =
        new DeleteStructureCommand(TransactionHelper.getEditingDomain((Collection) context.get(ITransitionConstants.TRANSITION_SOURCES)), objects,
            true);
