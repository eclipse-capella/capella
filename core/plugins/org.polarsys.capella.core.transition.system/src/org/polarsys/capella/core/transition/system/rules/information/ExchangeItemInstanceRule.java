...
public class ExchangeItemInstanceRule extends AbstractCapellaElementRule {

  public ExchangeItemInstanceRule() {
  ...
  protected void retrieveGoDeep(EObject source, List<EObject> result, IContext context) {
    ...
    ExchangeItemInstance element = (ExchangeItemInstance) source;
