...
public class CollectionValueReferenceRule extends DataValueRule {
  ...
  protected void retrieveGoDeep(EObject source_p, List<EObject> result_p, IContext context_p) {
    ...
    if (handler.contains(ITransitionConstants.SOURCE_SCOPE, source_p, context_p)) {
      handler.add(ITransitionConstants.SOURCE_SCOPE, element.getReferencedProperty(), context_p);
      handler.add(ITransitionConstants.SOURCE_SCOPE, element.getReferencedValue(), context_p);
  ...
  protected void premicesRelated(EObject element_p, ArrayList<IPremise> needed_p) {
    ...
    needed_p.addAll(createDefaultPrecedencePremices(element_p, InformationPackage.Literals.COLLECTION_VALUE_REFERENCE__REFERENCED_PROPERTY));
    needed_p.addAll(createDefaultPrecedencePremices(element_p, InformationPackage.Literals.COLLECTION_VALUE_REFERENCE__REFERENCED_VALUE));
  }
