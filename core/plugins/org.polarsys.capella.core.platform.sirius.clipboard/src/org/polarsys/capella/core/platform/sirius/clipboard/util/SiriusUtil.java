...
public final class SiriusUtil {
  ...
  /**
   * This restricted conformity checking is applicable to elements which are not bound to their
   * model yet. It only considers the domain class of the mapping, ignoring the precondition and
...
//  }
   ...
   */
  public static UniqueEList<AbstractNodeMapping> fiterOutImported(
  ...
  public static UniqueEList<AbstractNodeMapping> getApplicableMappingsIn(
      DRefreshable graphicalContext_p) {
   ...
   */
  public static UniqueEList<AbstractNodeMapping> getApplicableMappingsInDiagram(
      DDiagram diagram_p) {
   ...
   */
  public static UniqueEList<AbstractNodeMapping> getApplicableMappingsInContainer(
  ...
  /**
   * Return the DDiagram which is the parent of the given Sirius element, or the
   * Sirius element itself if it is a DDiagram
   */
  ...
  public static DDiagram getOwningDiagram(EObject element_p) {
    if (null == element_p) return null;
    if (element_p instanceof DDiagram) return (DDiagram)element_p;
  ...
  /**
   * Return whether the given Sirius element is or is in a diagram whose
   * layout should not be altered other than by the diagram GUI
   */
  ...
  public static boolean refreshDiagram(DDiagram diagram_p) {
    boolean result = false;
    if (diagram_p != null) {
      DialectManager.INSTANCE.refresh(
          diagram_p, new NullProgressMonitor());
      result = true;
    }
    return result;
  }
