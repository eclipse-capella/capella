...
/**
 * Utility class on resource
 * //TODO to remove, probably available in another plug-ins
 */
public class Utils {
  ...
  public static String getText(EObject eObject_p) {
    String result = EObjectLabelProviderHelper.getText(eObject_p);
    if (ICommonConstants.EMPTY_STRING.equals(result) || (null == result)) {
      ItemProviderAdapter itemProvider = getItemProvider(eObject_p);
      if (null != itemProvider) {
