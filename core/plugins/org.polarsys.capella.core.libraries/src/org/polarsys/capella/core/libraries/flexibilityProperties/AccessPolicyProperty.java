...
public class AccessPolicyProperty extends AbstractProperty implements IEditableProperty, ICompoundProperty {
  ...
  public void setValue(IPropertyContext context_p) {
    ...
    Collection<IAbstractLibrary> directReferencedLibraries = model.getReferencedLibrariesByRootModel();
    for (IAbstractLibrary library : directReferencedLibraries) {
      ...
      if (currentAccessPolicy != model.getInitialAccessPolicy(library)) {
        ILibraryManager.INSTANCE.setAccessPolicy(rootModel, library, currentAccessPolicy);
      }
    }
  }
