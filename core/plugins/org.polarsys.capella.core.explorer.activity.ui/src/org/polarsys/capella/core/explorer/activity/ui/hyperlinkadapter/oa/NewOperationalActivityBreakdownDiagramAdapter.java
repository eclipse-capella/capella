 ...
 */
public class NewOperationalActivityBreakdownDiagramAdapter extends AbstractCapellaNewDiagramHyperlinkAdapter {


	public NewOperationalActivityBreakdownDiagramAdapter() {
		super();
	}
