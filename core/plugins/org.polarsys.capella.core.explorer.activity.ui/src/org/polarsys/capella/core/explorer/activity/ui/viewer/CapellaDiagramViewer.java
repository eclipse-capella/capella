...
public class CapellaDiagramViewer extends DiagramViewer {
	...
	private final CapellaSessionManagerListener sessionManagerListener = new CapellaSessionManagerListener(this);
		...
		contextMenuManager.addMenuListener(new IMenuListener2() {
			...
			public void menuAboutToShow(IMenuManager manager) {
				manager.appendToGroup(GROUP_MOVE,
						_moveDiagramAction.fillContextMenu((IStructuredSelection) treeViewer.getSelection()));
			}
		});
	...
	protected IContentProvider getContentProvider() {
		return new CapellaArchitectureContentProvider(((AbstractCapellaPage)page).getHandledViewpoint(), ((AbstractCapellaPage)page).getFilteringMetaClassForCommonViewpoint());
	}
	 ...
	 * 
	 * Copied from: org.eclipse.amalgam.explorer.activity.ui.internal.DelegatedViewerFilter
	 * 
	 */
