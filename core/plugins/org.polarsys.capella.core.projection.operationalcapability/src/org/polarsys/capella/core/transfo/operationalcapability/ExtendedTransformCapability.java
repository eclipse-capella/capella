 ...
 */
public class ExtendedTransformCapability extends TransformOperationalCapability {

  /**
   * Tiger context used. This context is declared implementing an extension point.
   */
  private static final String CAPELLA_RULES = "org.polarsys.capella.core.projection.capability"; //$NON-NLS-1$
  ...
  protected ITransfo createTransfo(ITransfoRuleBase ruleBase_p) throws ClassNotFoundException {
    return super.createTransfo(ruleBase_p, CAPELLA_RULES);
  }
