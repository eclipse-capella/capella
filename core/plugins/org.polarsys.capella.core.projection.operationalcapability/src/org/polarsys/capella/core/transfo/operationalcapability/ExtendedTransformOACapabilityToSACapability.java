 ...
 */
public class ExtendedTransformOACapabilityToSACapability extends TransformOperationalCapability {

  /**
   * Tiger context used. This context is declared implementing an extension point.
   */
  private static final String CAPELLA_OPERATIONALCAPABILITIES_RULES = "capella.operationalcapabilities.rules.tocapability"; //$NON-NLS-1$
