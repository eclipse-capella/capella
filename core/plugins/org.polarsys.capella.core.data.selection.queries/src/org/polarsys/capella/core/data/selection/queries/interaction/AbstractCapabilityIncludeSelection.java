...
public class AbstractCapabilityIncludeSelection implements ILinkSelection {
  ...
  public EObject getDisplayedTarget(EObject object_p, EObject context_p) {
    if ((object_p instanceof AbstractCapabilityInclude) && (context_p instanceof AbstractCapability)) {
      AbstractCapabilityInclude currentGeneralization = (AbstractCapabilityInclude) object_p;
      if (currentGeneralization.getIncluded().equals(context_p)) {
