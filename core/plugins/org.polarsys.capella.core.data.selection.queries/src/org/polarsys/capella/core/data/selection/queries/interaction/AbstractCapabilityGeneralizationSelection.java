...
public class AbstractCapabilityGeneralizationSelection implements ILinkSelection {
  ...
  public EObject getDisplayedTarget(EObject object_p, EObject context_p) {
    if ((object_p instanceof AbstractCapabilityGeneralization) && (context_p instanceof AbstractCapability)) {
      AbstractCapabilityGeneralization currentGeneralization = (AbstractCapabilityGeneralization) object_p;
      if (currentGeneralization.getSuper().equals(context_p)) {
