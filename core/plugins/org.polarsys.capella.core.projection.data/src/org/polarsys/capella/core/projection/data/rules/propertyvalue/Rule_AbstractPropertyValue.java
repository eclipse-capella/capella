...
public class Rule_AbstractPropertyValue extends Rule_CapellaElement {

  public Rule_AbstractPropertyValue(EClass source, EClass target) {
    super(source, target);
  }
  ...
  protected EStructuralFeature getTargetContainementFeature(EObject element_p, EObject result_p, EObject container_p, IContext context_p) {
    return CapellacorePackage.Literals.CAPELLA_ELEMENT__OWNED_PROPERTY_VALUES;
  }
