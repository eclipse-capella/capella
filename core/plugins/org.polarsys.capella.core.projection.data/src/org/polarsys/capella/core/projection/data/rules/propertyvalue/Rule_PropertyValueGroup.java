...
public class Rule_PropertyValueGroup extends Rule_CapellaElement {

  public Rule_PropertyValueGroup() {
    super(CapellacorePackage.Literals.PROPERTY_VALUE_GROUP, CapellacorePackage.Literals.PROPERTY_VALUE_GROUP);
  }
  ...
  protected void retrieveGoDeep(EObject source_p, List<EObject> result_p, IContext context_p) {
    ...
    PropertyValueGroup element = (PropertyValueGroup) source_p;
    result_p.addAll(element.getOwnedConstraints());
  }
  ...
  protected EObject getSourceContainer(EObject element_p, EObject result_p, IContext context_p) {
    ...
    if (EcoreUtil2.isContainedBy(element_p, CsPackage.Literals.BLOCK_ARCHITECTURE)) {
      while (parent != null) {
        if (TransformationHandlerHelper.getInstance(context_p).getBestTracedElement(parent, context_p, CapellacorePackage.Literals.CAPELLA_ELEMENT) != null) {
          return parent;
        }
        parent = parent.eContainer();
      }
  ...
  protected EStructuralFeature getTargetContainementFeature(EObject element_p, EObject result_p, EObject container_p, IContext context_p) {
    return CapellacorePackage.Literals.CAPELLA_ELEMENT__OWNED_PROPERTY_VALUE_GROUPS;
  }
