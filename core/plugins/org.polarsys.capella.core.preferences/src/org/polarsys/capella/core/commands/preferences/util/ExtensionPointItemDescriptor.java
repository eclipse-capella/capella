/*******************************************************************************
 * Copyright (c) 2003, 2015 Corporation and others.
...
public final class ExtensionPointItemDescriptor extends AbstractItemDescriptor implements IExtensionPointItemDescriptor {
   ...
   * @throws ItemExistsException if the <code>config</code>uration element specified a constraint ID that already exists in the system
   */
   ...
   * @return the normalized ID, which either the original ID if it already starts with the plug-in ID; the original ID prefixed by the plug-in ID, otherwise
   */
   ...
   * @param extConfig the Eclipse configuration element representing the XML extension data
   */
