...
/**
 * AbstractBoolean Value type check
 */
public class BooleanValueFamilyTypeCheck extends AbstractDataValueTypeCheck {
  ...
  public boolean isInstanceOf(EObject eObj_p) {
    if ((eObj_p instanceof AbstractBooleanValue) && !(eObj_p instanceof AbstractExpressionValue)) {
      return true;
    }
    return false;
  }
