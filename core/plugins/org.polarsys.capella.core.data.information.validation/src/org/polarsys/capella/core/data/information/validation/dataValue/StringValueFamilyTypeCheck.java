...
/**
 * AbstractStringValue Value type check
 */
public class StringValueFamilyTypeCheck extends AbstractDataValueTypeCheck {
  ...
  public boolean isInstanceOf(EObject eObj_p) {
    if ((eObj_p instanceof AbstractStringValue) && !(eObj_p instanceof AbstractExpressionValue)) {
      return true;
    }
    return false;
  }
