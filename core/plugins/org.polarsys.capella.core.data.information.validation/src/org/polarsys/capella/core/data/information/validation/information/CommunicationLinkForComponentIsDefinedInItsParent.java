	...
	public IStatus validate(IValidationContext ctx_p) {	
      ...
      if (eObj instanceof CommunicationLink) {
    	  ...
    	  if (parentsInError.size() > 0) {
    		  ...
    		  return ctx_p.createFailureStatus(link.getKind(), CapellaElementExt.getCapellaExplorerLabel(component), CapellaElementExt.getCapellaExplorerLabel(item),  b.toString()); 
    	  }
	  }        
