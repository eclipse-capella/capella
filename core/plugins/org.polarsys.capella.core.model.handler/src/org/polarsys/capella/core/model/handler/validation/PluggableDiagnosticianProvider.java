...
public class PluggableDiagnosticianProvider extends AbstractDiagnosticianProvider {
  ...
  public static final String DIAGNOSTICIAN_PROVIDER_EXTENSION = FrameworkUtil.getBundle(ModelHandlerPlugin.class).getSymbolicName() + ".diagnosticianProviders"; //$NON-NLS-1$
