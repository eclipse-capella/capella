...
public class PhysicalLinkCategorySection extends NamedElementSection {
  ...
  public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
    ...
    _linksField = new MultipleSemanticField(getReferencesGroup(), Messages.PhysicalLinkCategorySection_Links_Label, getWidgetFactory(), new AbstractMultipleSemanticFieldController() {
      ...
      protected IBusinessQuery getReadOpenValuesQuery(CapellaElement semanticElement_p) {
        return BusinessQueriesProvider.getInstance().getContribution(semanticElement_p.eClass(), CsPackage.eINSTANCE.getPhysicalLinkCategory_Links());
      }
    });
  ...
  public void loadData(CapellaElement capellaElement_p) {
    ...
    _linksField.loadData(capellaElement_p, CsPackage.eINSTANCE.getPhysicalLinkCategory_Links());
  }
