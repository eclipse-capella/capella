 ...
 */
public class PhysicalPathRealizationSection extends AllocationSection {
  /**
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CsPackage.eINSTANCE.getPhysicalPathRealization()));
  }
}
