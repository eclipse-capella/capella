 ...
 */
public class PhysicalPortRealizationSection extends AllocationSection {
  /**
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CsPackage.eINSTANCE.getPhysicalPortRealization()));
  }
}
