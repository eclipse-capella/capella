...
import org.polarsys.capella.core.refinement.commands.actions.PropagateLinksAction;

public class PropagateLinksHandler extends AbstractHandler {

  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    PropagateLinksAction action = new PropagateLinksAction();
