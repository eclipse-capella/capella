 ...
 */
public class EnumerationReference_ReferencedValue extends AbstractReference_ReferencedValue implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  protected boolean isAValidExpressionType(DataType dataType_p) {
    if (dataType_p instanceof Enumeration) {
      return true;
    }
    return false;
  }
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_EnumerationReference_ReferencedValue", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}