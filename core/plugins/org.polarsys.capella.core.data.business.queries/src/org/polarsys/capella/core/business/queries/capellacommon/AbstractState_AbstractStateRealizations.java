...
/**
 */
public abstract class AbstractState_AbstractStateRealizations implements IBusinessQuery {
   ...
   * @return
   */
  private List<CapellaElement> getElementsFromBlockArchitecture(BlockArchitecture arch_p, AbstractState state_p) {
   ...
   * @param state_p
   */
  private List<CapellaElement> getRule_MQRY_State_AvailableStates_11(AbstractState state_p) {
    List<CapellaElement> availableElements = new ArrayList<CapellaElement>(1);
