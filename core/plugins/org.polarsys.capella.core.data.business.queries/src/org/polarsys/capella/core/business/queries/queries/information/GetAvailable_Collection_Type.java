...
public class GetAvailable_Collection_Type extends AbstractQuery {
  ...
  public List<EObject> getDataFromLevel(DataPkg dataPkg, CapellaElement capellaElement) {
    List<EObject> returnValue = CapellaElementsHelperForBusinessQueries.getCapellaElementsInstancesOf(dataPkg, DatatypePackage.Literals.DATA_TYPE, null);
    List<EObject> collections =
    ...
    List<EObject> classes = CapellaElementsHelperForBusinessQueries.getCapellaElementsInstancesOf(dataPkg, InformationPackage.Literals.CLASS, null);
