...
public class GetAvailable_Collection_Type extends AbstractQuery {
  ...
  public List<CapellaElement> getDataFromLevel(DataPkg dataPkg_p, CapellaElement capellaElement_p) {
    List<CapellaElement> returnValue = CapellaElementsHelperForBusinessQueries.getCapellaElementsInstancesOf(dataPkg_p, DatatypePackage.Literals.DATA_TYPE, null);
    List<CapellaElement> collections =
        CapellaElementsHelperForBusinessQueries.getCapellaElementsInstancesOf(dataPkg_p, InformationPackage.Literals.COLLECTION, capellaElement_p);
