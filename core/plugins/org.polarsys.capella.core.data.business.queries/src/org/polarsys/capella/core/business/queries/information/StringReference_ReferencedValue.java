 ...
 */
public class StringReference_ReferencedValue extends AbstractReference_ReferencedValue implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  @Override
  protected EClass getSearchedEClassForValues() {
  ...
  public List<CapellaElement> getOldCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    ...
    if (element_p instanceof StringReference) {
      StringReference reference = (StringReference) element_p;
  ...
  @Override
  protected boolean isAValidExpressionType(DataType dataType_p) {
    if (dataType_p instanceof StringType) {
      return true;
    }
    return false;
  }
  ...
  public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
    ...
    parameters.add(getSearchedEClassForValues());
    parameters.add(DatatypePackage.Literals.STRING_TYPE);
    return RefactorDebugger.callAndTestQuery(
        "GetAvailable_Generic_ReferencedValue__Lib", parameters, getOldAvailableElements(element_p), getEClass(), getClass());//$NON-NLS-1$
  }

  @Override
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_StringReference_ReferencedValue", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}