...
public class GetAvailable_SystemComponent_InvolvingCapabilities extends AbstractQuery {
    ...
    return (List) CapellaElementExt.getAllCapabilities(systemEngineering);
	}
