...
public class GetAvailable_PhysicalQuantity_InheritedType extends AbstractQuery {
  ...
  /** 
	 */
  private List<CapellaElement> getDataFromComponentHierarchy(CapellaElement element_p) {
  ...
  /** 
	 */
  private List<CapellaElement> getDataFromRealizedComponentsHierarchy(CapellaElement element_p) {
    List<CapellaElement> allDatas = new ArrayList<CapellaElement>();
  ...
  /** 
	 */
  private List<CapellaElement> getTypesFromComponentHierarchy(CapellaElement element_p) {
    List<CapellaElement> allDatas = new ArrayList<CapellaElement>();
    for (Component cpnt : CapellaElementExt.getComponentHierarchy(element_p)) {
      DataPkg dataPkg = cpnt.getOwnedDataPkg();
      if (null != dataPkg) {
   ...
   */
  private List<CapellaElement> filterUnNamedElements(List<CapellaElement> list_p) {
