...
public class GetAvailable_PhysicalQuantity_InheritedType extends AbstractQuery {
  ...
  /** 
	 */
  private List<EObject> getDataFromComponentHierarchy(CapellaElement element) {
  ...
  /** 
	 */
  private List<EObject> getDataFromRealizedComponentsHierarchy(CapellaElement element) {
    List<EObject> allDatas = new ArrayList<EObject>();
  ...
  /** 
	 */
  private List<EObject> getTypesFromComponentHierarchy(CapellaElement element) {
    List<EObject> allDatas = new ArrayList<EObject>();
    for (Component cpnt : CapellaElementExt.getComponentHierarchy(element)) {
      DataPkg dataPkg = cpnt.getOwnedDataPkg();
      if (null != dataPkg) {
   ...
   */
  private List<EObject> filterUnNamedElements(List<EObject> list) {
