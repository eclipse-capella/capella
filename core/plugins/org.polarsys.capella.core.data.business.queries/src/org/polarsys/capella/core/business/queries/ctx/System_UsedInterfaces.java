...
/**
 */
public class System_UsedInterfaces implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery, IBusinessQuery {
	...
	private List<CapellaElement> getRule_MQRY_System_UsedInterface_11(SystemEngineering sysEng_p, System system_p) {
		...
		availableElements.addAll(InterfacePkgExt.getAllInterfacesFiltered(SystemEngineeringExt.getOwnedSystemAnalysis(sysEng_p).getOwnedInterfacePkg(), system_p, true));
	...
	public List<CapellaElement> getOldCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
		...
		if (element_p instanceof System) {
			System system = (System) element_p;
			currentElements.addAll(ComponentExt.getUsedInterfaces(system));
		}
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
	  return RefactorDebugger.callAndTestQuery("GetAvailable_System_UsedInterfaces__Lib", element_p, getOldAvailableElements(element_p), getEClass(), getClass());//$NON-NLS-1$
	}

	@Override
	public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
	  return RefactorDebugger.callAndTestQuery("GetCurrent_System_UsedInterfaces", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
	}
}
