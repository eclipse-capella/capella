...
public class GetCurrent_CapabilityRealization_InvolvedComponents extends AbstractQuery {
	...
	public List<Object> execute(Object input, IQueryContext context) {
      ...
      CapabilityRealization currentCapabilityUseCase = (CapabilityRealization) capellaElement;
      currentElements.addAll(currentCapabilityUseCase.getInvolvedComponents());
    }
