...
public class FunctionInputPort_InComingExchangeItems extends AbstractFunctionalExchangeItems implements IBusinessQuery {
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__FUNCTION_INPUT_PORT__IN_COMING_EXCHANGE_ITEMS___LIB, element_p, context);
	}
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__FUNCTION_INPUT_PORT__IN_COMING_EXCHANGE_ITEMS, element_p, context);
	}
