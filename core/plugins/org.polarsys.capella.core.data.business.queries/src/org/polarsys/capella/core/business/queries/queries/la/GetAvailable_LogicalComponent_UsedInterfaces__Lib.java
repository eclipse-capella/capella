...
@ExtendingQuery (extendingQuery = GetAvailable_LogicalComponent_UsedInterfaces.class)
public class GetAvailable_LogicalComponent_UsedInterfaces__Lib extends AbstractQuery {
