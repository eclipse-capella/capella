...
public class Capability_InheritedCapabilities implements IBusinessQuery {
	 ...
	 */
	private List<CapellaElement> getRule_MQRY_CapabiiltyUseCase_Inherited_11(SystemEngineering sysEng_p, Capability currentCapabilityUseCase_p, boolean isFilterRequired) {
