...
public abstract class CapellaElement_CurrentAndHigherLevelsQuery extends AbstractSystemEngineeringQuery {
  ...
  /**
   * This method must be overridden in the concrete class.<br>
   * Its purpose is to get the available data related to the given element in the given data package
   * @param dataPkg_p the data package
   * @param capellaElement_p the capella element
   * @return the available elements
   */
  public abstract List<CapellaElement> getDataFromLevel(DataPkg dataPkg_p, CapellaElement capellaElement_p);
