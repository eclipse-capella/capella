...
public class GetAvailable_Property_MinValue extends AbstractQuery {
		...
		if (capellaElement_p instanceof Property) {
			...
			if (null != abstractType) {
				if (abstractType instanceof StringType) {
					returnValue = CapellaElementsHelperForBusinessQueries.getStandardApplicableValuesForMultiplicityElementInLevel(dataPkg_p,
					...
					returnValue = super_getDataFromLevel(dataPkg_p, capellaElement_p);
				}
			}
		}
		return returnValue;
