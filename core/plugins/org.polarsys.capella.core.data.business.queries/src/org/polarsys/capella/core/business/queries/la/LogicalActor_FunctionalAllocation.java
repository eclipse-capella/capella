...
public class LogicalActor_FunctionalAllocation extends Component_FunctionalAllocation implements IBusinessQuery {
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__LOGICAL_ACTOR__FUNCTIONAL_ALLOCATION, element, context);
	}
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__LOGICAL_ACTOR__FUNCTIONAL_ALLOCATION, element, context);
	}
}
