 ...
 */
public class ComponentPort_RequiredInterfaces implements IBusinessQuery, RefactoredBusinessQuery {

  @Override
  public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
    return RefactorDebugger.callAndTestQuery("GetAvailable_ComponentPort_RequiredInterfaces__Lib", element_p, getOldAvailableElements(element_p), getEClass(),//$NON-NLS-1$
        getClass());
  }
  ...
  private List<CapellaElement> getElementsFromBlockArchitecture(BlockArchitecture arch_p, Port element_p) {
    ...
    for (Interface itf : element_p.getRequiredInterfaces()) {
