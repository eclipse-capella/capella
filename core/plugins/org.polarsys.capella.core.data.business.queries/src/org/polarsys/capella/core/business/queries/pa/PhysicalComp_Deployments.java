...
public class PhysicalComp_Deployments implements IBusinessQuery {
	 ...
	 */
	private List<CapellaElement> getRule_MQRY_PC_Deployments_11(PhysicalComponent currentPC_p) {
		...
		for (PhysicalComponent physicalComponent : comps) {
			// currentPC is not a PhysicalNode, it can not deploy PhysicalNode
