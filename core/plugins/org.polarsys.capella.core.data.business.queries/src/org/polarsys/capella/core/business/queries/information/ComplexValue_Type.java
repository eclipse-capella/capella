 ...
 */
public class ComplexValue_Type extends AbstractValue_Type implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  protected List<CapellaElement> removeNonPrimitiveClasses(List<CapellaElement> elements_p) {
    return super.removePrimitiveOrNonPrimitiveClasses(elements_p, true);
  }

  @Override
  protected List<CapellaElement> removeNonPrimitiveCollections(List<CapellaElement> elements_p) {
    return super.removePrimitiveOrNonPrimitiveCollections(elements_p, true);
  }
  ...
  public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
    ...
    parameters.add(getAvailableEClassForType());
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery("GetCurrent_ComplexValue_Type", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}