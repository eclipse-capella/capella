...
public class InterfaceImpl_ImplementedInterface implements IBusinessQuery {
	 ...
	 * @param currentInterfaceImpl
	 * @param systemEngineering
	 * @return List of Interfaces
	 */
	private List<CapellaElement> getRule_MQRY_InterfaceImpl_ImplInterface_11(InterfaceImplementation currentInterfaceImpl, SystemEngineering systemEngineering) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>();
		// current Element's 'Implemented Interfaces' to
		Interface implementedInterface = currentInterfaceImpl.getImplementedInterface();
		
		BlockArchitecture rootBlockArchitecture = SystemEngineeringExt.getRootBlockArchitecture(currentInterfaceImpl);  
		...
		if (interfacePkg != null) {
            ...
            if (inter.equals(implementedInterface)) {
		...
		EObject container = currentInterfaceImpl.eContainer();
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
		...
		if (element_p instanceof InterfaceImplementation) {
		  InterfaceImplementation implementedInterface = (InterfaceImplementation) element_p;
				availableElements.addAll(getRule_MQRY_InterfaceImpl_ImplInterface_11(implementedInterface, systemEngineering));
		}
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
		...
		if (element_p instanceof InterfaceImplementation) {
		  InterfaceImplementation ele = (InterfaceImplementation) element_p;
