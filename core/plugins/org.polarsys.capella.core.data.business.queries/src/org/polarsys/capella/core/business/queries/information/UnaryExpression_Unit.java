...
public class UnaryExpression_Unit extends NumericValue_Unit implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery("GetCurrent_UnaryExpression_Unit", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
