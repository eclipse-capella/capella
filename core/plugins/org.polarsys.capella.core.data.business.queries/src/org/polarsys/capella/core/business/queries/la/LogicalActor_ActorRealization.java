...
public class LogicalActor_ActorRealization implements IBusinessQuery {
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__LOGICAL_ACTOR__ACTOR_REALIZATION, element_p, context);
	}
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__LOGICAL_ACTOR__ACTOR_REALIZATION, element_p, context);
	}
