...
public class PhysicalQuantity_Property implements IBusinessQuery {
	...
	/*
	 * All the Property contained by the DataPackages (and
	 * all of its sub-packages) of the current Element's parents hierarchy
	 * according to layer visibility and multiple decomposition rules.
	 */
 	private List<CapellaElement> getRule_MQRY_BooleanValue_Type_11(PhysicalQuantity currentBooleanType_p) {
	 ...
	 * layer visibility
	 */
	private List<CapellaElement> getRule_MQRY_BooleanValue_Type_11_1(PhysicalQuantity currentBooleanType_p) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>();
	...
	/*
	 * All the Property contained by the Data Package (and all of its
	 * subPackages) of the Shared Assets Package.
	 */
	private List<CapellaElement> getRule_MQRY_BooleanValue_Type_13(PhysicalQuantity currentBooleanType_p, SystemEngineering systemEngineering_p) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>();
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
		...
		if (element_p instanceof PhysicalQuantity) {
		  PhysicalQuantity currentBooleanType = (PhysicalQuantity) element_p;
