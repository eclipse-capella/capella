...
public class StringType_Property implements IBusinessQuery {
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__STRING_TYPE__PROPERTY, element_p, context);
	}
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__STRING_TYPE__PROPERTY, element_p, context);
	}
}
