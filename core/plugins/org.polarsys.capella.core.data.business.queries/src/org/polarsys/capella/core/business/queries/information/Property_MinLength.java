 ...
 */
public class Property_MinLength extends CapellaElement_AbstractCardinality implements RefactoredBusinessQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery("GetCurrent_Property_MinLength", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}