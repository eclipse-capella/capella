...
public class ComponentPort_ConnectedPorts implements IBusinessQuery {
  ...
  public ComponentPort_ConnectedPorts() {
  }

  public ComponentPort_ConnectedPorts(ComponentPort currentPort) {
    super();
    thePort = currentPort;
  }
  ...
  public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
    ...
    if (element_p instanceof Part) {
      ...
      availableElements
      .addAll(getRule_MQRY_StandardPort_ConnectedPorts_11(property));
    }
