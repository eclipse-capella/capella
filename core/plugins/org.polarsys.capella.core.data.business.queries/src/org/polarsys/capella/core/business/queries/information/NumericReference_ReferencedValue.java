 ...
 */
public class NumericReference_ReferencedValue extends AbstractReference_ReferencedValue implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  public List<CapellaElement> getOldCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    ...
    if (element_p instanceof NumericReference) {
      NumericReference reference = (NumericReference) element_p;
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_NumericReference_ReferencedValue", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
