...
@ExtendingQuery (extendingQuery = GetAvailable_LogicalComponent_ImplementedInterfaces.class)
public class GetAvailable_LogicalComponent_ImplementedInterfaces__Lib extends AbstractQuery {
