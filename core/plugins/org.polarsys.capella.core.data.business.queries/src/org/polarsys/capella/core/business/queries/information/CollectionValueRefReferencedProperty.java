 ...
 */
public class CollectionValueRefReferencedProperty extends AbstractReference_ReferencedProperty implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  protected List<EClass> getAvailableEClassForPropertiesTypes() {
    return Collections.singletonList(InformationPackage.Literals.COLLECTION);
  }
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_CollectionValueRefReferencedProperty", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
