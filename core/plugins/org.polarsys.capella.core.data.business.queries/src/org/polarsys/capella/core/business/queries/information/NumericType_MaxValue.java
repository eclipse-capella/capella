 ...
 */
public class NumericType_MaxValue extends NumericType_AbstractValue implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery("GetCurrent_NumericType_MaxValue", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
