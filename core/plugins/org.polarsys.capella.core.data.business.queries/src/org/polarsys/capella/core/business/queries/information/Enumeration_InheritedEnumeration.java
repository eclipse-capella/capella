 ...
 */
public class Enumeration_InheritedEnumeration extends GeneralizableElement_AbstractInheritedType implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  /**
...
public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
  return RefactorDebugger.callAndTestQuery("GetAvailable_Enumeration_InheritedEnumeration__Lib", element_p, getOldAvailableElements(element_p), getEClass(), getClass());//$NON-NLS-1$
}

@Override
public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
  return RefactorDebugger.callAndTestQuery("GetCurrent_Enumeration_InheritedEnumeration", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
}
}
