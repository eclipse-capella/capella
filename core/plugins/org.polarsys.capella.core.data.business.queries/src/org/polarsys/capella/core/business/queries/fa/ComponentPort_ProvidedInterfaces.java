 ...
 */
public class ComponentPort_ProvidedInterfaces implements IBusinessQuery, RefactoredBusinessQuery {

  @Override
  public List<CapellaElement> getAvailableElements(CapellaElement element_p) {
    return RefactorDebugger.callAndTestQuery("GetAvailable_ComponentPort_ProvidedInterfaces__Lib", element_p, getOldAvailableElements(element_p), getEClass(),//$NON-NLS-1$
        getClass());
  }
