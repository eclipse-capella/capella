 ...
 */
public class NumericReference_AbstractType extends NumericValue_Type implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery, IBusinessQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_NumericReference_AbstractType", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
