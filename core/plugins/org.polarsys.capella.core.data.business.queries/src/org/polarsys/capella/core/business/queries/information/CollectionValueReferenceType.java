 ...
 */
public class CollectionValueReferenceType extends CapellaElement_CurrentAndHigherLevelsQuery implements ExtendedBusinessQueryForLib, RefactoredBusinessQuery {
  ...
  public List<CapellaElement> getOldCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    ...
    if (element_p instanceof CollectionValueReference) {
      CollectionValueReference collection = (CollectionValueReference) element_p;
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element_p, boolean onlyGenerated_p) {
    return RefactorDebugger.callAndTestQuery(
        "GetCurrent_CollectionValueReferenceType", element_p, getOldCurrentElements(element_p, false), getEClass(), getClass());//$NON-NLS-1$
  }
}
