...
public class OpaqueExpressionHelper {
  ...
  public Object doSwitch(OpaqueExpression object_p, EStructuralFeature feature_p) {
    Object ret = null;

    // no helper found... searching in super classes...
    if(null == ret) {
      ret = CapellaElementHelper.getInstance().doSwitch(object_p, feature_p);
    }
    if (null == ret) {
      ret = ValueSpecificationHelper.getInstance().doSwitch(object_p, feature_p);
    }
