...
public class GenericTraceHelper {
	...
	public Object doSwitch(GenericTrace element_p, EStructuralFeature feature_p) {
		Object ret = null;

    if (feature_p.equals(CapellacommonPackage.Literals.GENERIC_TRACE__SOURCE)) {
      ret = getSource(element_p);
    }
    else if (feature_p.equals(CapellacommonPackage.Literals.GENERIC_TRACE__TARGET)) {
  ...
  protected TraceableElement getSource(GenericTrace element_p) {
    return element_p.getSourceElement();
  }

  protected TraceableElement getTarget(GenericTrace element_p) {
