...
public class InteractionStateHelper {
	...
	public Object doSwitch(InteractionState element_p, EStructuralFeature feature_p) {
		Object ret = null;

    if (feature_p.equals(InteractionPackage.Literals.INTERACTION_STATE__COVERED)) {
  ...
  protected InstanceRole getCovered(InteractionState element_p) {
    if (element_p != null) {
