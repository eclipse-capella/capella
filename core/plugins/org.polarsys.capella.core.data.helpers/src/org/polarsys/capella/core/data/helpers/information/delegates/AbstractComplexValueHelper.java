...
public class AbstractComplexValueHelper {
  ...
  public Object doSwitch(AbstractComplexValue element_p, EStructuralFeature feature_p) {
    Object ret = null;

    if (feature_p.equals(DatavaluePackage.Literals.ABSTRACT_COMPLEX_VALUE__COMPLEX_TYPE)) {
      return getComplexType(element_p);
    }
  ...
  protected Classifier getComplexType(AbstractComplexValue element_p) {
