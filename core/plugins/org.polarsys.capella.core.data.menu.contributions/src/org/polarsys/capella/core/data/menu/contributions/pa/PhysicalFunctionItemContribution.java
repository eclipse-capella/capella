...
public class PhysicalFunctionItemContribution extends AbstractFunctionItemContribution {
   ...
   * <br>
   * The current element's level is 'Physical Architecture'<br>
   * AND<br>
   * &nbsp;&nbsp;(The current element is a 'Physical Function'<br>
   * &nbsp;&nbsp;OR<br>
   * &nbsp;&nbsp;The current element is contained by a 'Physical Function'<br>
   * &nbsp;&nbsp;OR<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;(The current element is a 'Physical Function Package'<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;AND<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;is not contained by a 'Physical Function'<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;AND<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;doesn't contain any 'Physical Function')<br>
   * &nbsp;&nbsp;)<br>
   * <br>
  ...
  public boolean selectionContribution(ModelElement modelElement_p, EClass cls_p, EStructuralFeature feature_p) {
    return super.selectionContribution(modelElement_p, cls_p, feature_p)
        ...
        && ((modelElement_p instanceof PhysicalFunction)
          || EcoreUtil2.isContainedBy(modelElement_p, PaPackage.Literals.PHYSICAL_FUNCTION)
          || ((modelElement_p instanceof PhysicalFunctionPkg)
           && !EcoreUtil2.isContainedBy(modelElement_p, PaPackage.Literals.PHYSICAL_FUNCTION)
           && ((PhysicalFunctionPkg) modelElement_p).getOwnedPhysicalFunctions().isEmpty()));
  }
