...
public class LogicalComponentTransfo extends Transfo {
  ...
  private static final String ORG_POLARSYS_CAPELLA_CORE_PROJECTION_LC2PC_LEAFSTRATEGY = "org.polarsys.capella.core.projection.lc2pc.leafstrategy"; //$NON-NLS-1$
...
private static final long serialVersionUID = 0L;
  ...
  public LogicalComponentTransfo(ITransfoRuleBase transfoRuleBase_p) throws ClassNotFoundException {
    super (ORG_POLARSYS_CAPELLA_CORE_PROJECTION_LC2PC_LEAFSTRATEGY);
