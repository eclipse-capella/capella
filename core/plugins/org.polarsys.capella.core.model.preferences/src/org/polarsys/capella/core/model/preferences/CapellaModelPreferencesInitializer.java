...
public class CapellaModelPreferencesInitializer extends AbstractPreferencesInitializer {
  ...
  public void initializeDefaultPreferences() {
    ...
    putString(IReuseComponentsPreferences.PREFS_ALLOW_REUSE_COMPONENTS, IReuseComponentsPreferences.PREFS_ALLOW_REUSE_COMPONENTS_DEFAULT.toString(),
        ProjectScope.class);

    putString(IInheritancePreferences.PREFS_ALLOW_MULTIPLE_INHERITANCE, IInheritancePreferences.PREFS_ALLOW_MULTIPLE_INHERITANCE_DEFAULT.toString(),
        ProjectScope.class);

    putString(IDeploymentPreferences.PREFS_ALLOW_MULTIPLE_DEPLOYMENT, IDeploymentPreferences.PREFS_ALLOW_MULTIPLE_DEPLOYMENT_DEFAULT.toString(),
        ProjectScope.class);
    putString(IDataPreferences.PREFS_ALLOW_PRIMITIVE_SYNCHRONIZATION, IDataPreferences.PREFS_ALLOW_PRIMITIVE_SYNCHRONIZATION_DEFAULT.toString(),
        ProjectScope.class);

    // Set synchronization preferences
    putBoolean(ISynchronizationPreferences.PREFS_ALLOW_SYNC_COMPONENTPORT_TO_FUNCTIONPORT,
        ISynchronizationPreferences.PREFS_ALLOW_SYNC_COMPONENTPORT_TO_FUNCTIONPORT_DEFAULT.booleanValue(), ProjectScope.class);
