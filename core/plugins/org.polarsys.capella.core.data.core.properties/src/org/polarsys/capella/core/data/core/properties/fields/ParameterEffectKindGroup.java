...
public class ParameterEffectKindGroup extends AbstractSemanticKindGroup {
   ...
   */
  public ParameterEffectKindGroup(Composite parent_p, TabbedPropertySheetWidgetFactory widgetFactory_p) {
    super(parent_p, widgetFactory_p, Messages.getString("ParameterEffectKind.Label"), 4); //$NON-NLS-1$
