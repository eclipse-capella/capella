...
import org.polarsys.capella.core.platform.sirius.ui.actions.ConvertPrimitiveAction;

public class ConvertPrimitiveHandler extends AbstractHandler {

  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ActionCommandDelegate delegate = new ActionCommandDelegate(event);
    ConvertPrimitiveAction action = new ConvertPrimitiveAction();
