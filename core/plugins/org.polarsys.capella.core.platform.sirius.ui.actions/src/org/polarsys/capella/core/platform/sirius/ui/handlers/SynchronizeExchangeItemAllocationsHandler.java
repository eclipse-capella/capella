...
import org.polarsys.capella.core.platform.sirius.ui.actions.SynchronizeExchangeItemAllocationsAction;

public class SynchronizeExchangeItemAllocationsHandler extends AbstractHandler {

  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ActionCommandDelegate delegate = new ActionCommandDelegate(event);
    SynchronizeExchangeItemAllocationsAction action = new SynchronizeExchangeItemAllocationsAction();
