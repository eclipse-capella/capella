...
public class TransitionLogPreferencePage extends AbstractDefaultPreferencePage implements IWorkbenchPreferencePage {
  ...
  public TransitionLogPreferencePage() {
    ...
    setDescription(Messages.Preferences_Message);
  }
  ...
  public void createFieldEditors() {
    ...
    addField(new PreferenceField(PreferenceConstants.P_IC, PreferenceConstants.P_IC_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_Actor, PreferenceConstants.P_Actor_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    ...
    addField(new PreferenceField(PreferenceConstants.P_FEA, PreferenceConstants.P_FEA_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_FPort, PreferenceConstants.P_FPort_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_CPort, PreferenceConstants.P_CPort_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_PPort, PreferenceConstants.P_PPort_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_EI, PreferenceConstants.P_EI_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_Iface, PreferenceConstants.P_Iface_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
    ...
    addField(new PreferenceField(PreferenceConstants.P_Generalization, PreferenceConstants.P_Generalization_TEXT,
        getFieldEditorParent()), UserProfileModeEnum.User, getFieldEditorParent());
    addField(new PreferenceField(PreferenceConstants.P_Other, PreferenceConstants.P_Other_TEXT, getFieldEditorParent()),
        UserProfileModeEnum.User, getFieldEditorParent());
  }
  ...
  protected String getPageDescription() {
    return Messages.Preferences_Message;
  }
