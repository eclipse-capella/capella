...
public class GenericPkgExt {
   ...
   */
  public static List<Interface> getAllInterfaces(GenericPkg pkg_p) {
    List<Interface> lst = new ArrayList<Interface>();

    for (CapellaElement elt : pkg_p.getCapellaElements()) {
   ...
   * @return List<Class>
   */
  public static List<Class> getAllClasses(GenericPkg pkg_p) {
   ...
   * @return List<Class>
   */
  public static List<Union> getAllUnions(GenericPkg pkg_p) {
   ...
   * @return List<Signal>
   */
  public static List<Signal> getAllSignals(GenericPkg pkg_p) {
   ...
   * @return List<Message>
   */
  public static List<Message> getAllMessages(GenericPkg pkg_p) {
   ...
   */
  public static List<DataType> getAllDataTypes(GenericPkg pkg_p) {
   ...
   * @return List<DataType>
   */
  public static List<DataValue> getAllDataValues(GenericPkg pkg_p) {
   ...
   * @return List<Actor>
   */
  public static List<Actor> getAllActors(GenericPkg pkg_p) {
  ...
  public static List<Unit> getAllUnits(GenericPkg pkg_p) {
  ...
  public static List<Exception> getAllExceptions(GenericPkg pkg_p) {
