...
/**
 */
public class GetAllInterfacePcks extends AbstractQuery {
  ...
  public List<Object> execute(Object input_p, IQueryContext context_p) throws QueryException {
    ...
    for (BlockArchitecture anArchitecture : BlockArchitectureExt.getRootAndPreviousBlockArchitectures((EObject) input_p)) {
      for (EObject aInterfacePkg : EObjectExt.getAll(anArchitecture, CsPackage.Literals.INTERFACE_PKG)) {
        returnedList.add(aInterfacePkg);
      }
    }
    return returnedList;
  }
