...
public class CapellaModelDataListenerForDataPkg extends CapellaModelDataListener {
  /**
   * organise associations after a move of a data pkg within the project explorer
   */
  /**
  ...
  public void notifyChanged(Notification notif_p) {
    ...
    if ((notif_p.getNotifier() instanceof DataPkg)
        && InformationPackage.Literals.DATA_PKG__OWNED_DATA_PKGS.equals(notif_p.getFeature())) {
