...
public class GetComponents extends AbstractQuery {
  ...
  public List<Object> execute(Object input_p, IQueryContext context_p) throws QueryException {
    ...
    BlockArchitecture block = BlockArchitectureExt.getRootBlockArchitecture((EObject) input_p);
    for (EObject aComponent : EObjectExt.getAll(block, CsPackage.Literals.COMPONENT)) {
