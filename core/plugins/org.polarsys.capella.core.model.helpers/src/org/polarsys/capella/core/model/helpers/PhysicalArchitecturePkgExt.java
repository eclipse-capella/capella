...
public class PhysicalArchitecturePkgExt {
	 ...
	 */
	public static List<PhysicalComponent> getAllPhysicalComponents(PhysicalArchitecturePkg currentElement_p) {
		Set<EObject> pcSet = EObjectExt.getAll(currentElement_p, PaPackage.Literals.PHYSICAL_COMPONENT);
