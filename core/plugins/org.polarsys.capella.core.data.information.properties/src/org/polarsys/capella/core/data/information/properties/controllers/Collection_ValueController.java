...
public class Collection_ValueController extends AbstractSimpleEditableSemanticFieldController {
  ...
  public EObject editValue(CapellaElement semanticElement_p, EStructuralFeature semanticFeature_p, String defaultName_p) {
    if (semanticElement_p != null) {
      AbstractCollectionValue currentValue = (AbstractCollectionValue) semanticElement_p.eGet(semanticFeature_p);
      if (currentValue != null) {
        editValueWizard(currentValue);
      } else {
        CollectionValue newValue = InformationFactory.eINSTANCE.createCollectionValue(defaultName_p);
