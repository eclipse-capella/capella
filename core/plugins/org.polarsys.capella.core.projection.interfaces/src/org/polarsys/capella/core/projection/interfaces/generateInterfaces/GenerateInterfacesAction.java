 ...
 */
public class GenerateInterfacesAction extends AbstractTigAction implements IObjectActionDelegate {
  final String PROGRESS_BAR_NAME = Messages.GenerateInterfacesAction_CreatingInterfaces;
  /**
  ...
  public void run(IAction action) {
    IRunnableWithProgress runnable = new IRunnableWithProgress() {
      ...
      public void run(IProgressMonitor progressMonitor_p) throws InvocationTargetException, InterruptedException {
        ...
        getExecutionManager().execute(new GenerateInterfacesCommand((Collection) getSelectedElements(), progressMonitor_p));
