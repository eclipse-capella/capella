  ...
  public Object getImage(Object object) {
    ...
    if (link.eContainer() instanceof OperationalProcess) {
      if (involvedElement instanceof AbstractFunction) {
        imagePath = "full/obj16/FunctionalChainInvolvementLinkOA_ToFunction"; //$NON-NLS-1$
      } else {
        imagePath = "full/obj16/FunctionalChainInvolvementLinkOA_ToExchange"; //$NON-NLS-1$
      }
    } else {
      if (involvedElement instanceof AbstractFunction) {
        imagePath = "full/obj16/FunctionalChainInvolvementLink_ToFunction"; //$NON-NLS-1$
      } else {
        imagePath = "full/obj16/FunctionalChainInvolvementLink_ToExchange"; //$NON-NLS-1$
      }
    }
