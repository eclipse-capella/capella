...
public class DescriptionLinkParserHandler extends DefaultHandler {
	...
	private ILinkParserHandler linkParserHandler;
	...
	public DescriptionLinkParserHandler(EObject element, IValidationContext ctx, ILinkParserHandler linkParserHandler) {
	...
	private class LinkParserHandler extends DefaultHandler {
		...
		public void endElement(String uri, String localName, String qName) throws SAXException {
			...
			if ((qName.equalsIgnoreCase(IConstantValidation.XHTML_A_TAG))) {
				...
				LinkDescription parsedLink = new LinkDescription(formattedLinkContent, currentLinkHref, currentTargetElement,(Attributes) new AttributesImpl());
