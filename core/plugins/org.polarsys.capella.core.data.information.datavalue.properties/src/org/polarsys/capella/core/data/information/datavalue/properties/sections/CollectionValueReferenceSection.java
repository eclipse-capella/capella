...
public class CollectionValueReferenceSection extends DataValueReferenceSection {
  ...
  public void loadData(CapellaElement capellaElement_p) {
    ...
    _referencedValueField.loadData(capellaElement_p, InformationPackage.eINSTANCE.getCollectionValueReference_ReferencedValue());
    _referencedPropertyField.loadData(capellaElement_p, InformationPackage.eINSTANCE.getCollectionValueReference_ReferencedProperty());
  }
