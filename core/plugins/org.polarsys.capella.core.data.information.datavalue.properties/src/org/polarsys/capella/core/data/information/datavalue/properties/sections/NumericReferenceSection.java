...
public class NumericReferenceSection extends DataValueReferenceSection {
  ...
  public void loadData(CapellaElement capellaElement_p) {
    ...
    _referencedValueField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getNumericReference_ReferencedValue());
    _referencedPropertyField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getNumericReference_ReferencedProperty());
