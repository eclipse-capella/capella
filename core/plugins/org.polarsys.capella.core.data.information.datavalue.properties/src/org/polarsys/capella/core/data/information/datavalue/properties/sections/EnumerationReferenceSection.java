...
public class EnumerationReferenceSection extends DataValueReferenceSection {
  ...
  public void loadData(CapellaElement capellaElement_p) {
    ...
    _referencedValueField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getEnumerationReference_ReferencedValue());
    _referencedPropertyField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getEnumerationReference_ReferencedProperty());
  }
