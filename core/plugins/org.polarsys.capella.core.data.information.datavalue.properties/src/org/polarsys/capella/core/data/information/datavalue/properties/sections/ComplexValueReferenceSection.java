...
public class ComplexValueReferenceSection extends DataValueReferenceSection {
  ...
  public void loadData(CapellaElement capellaElement_p) {
    ...
    _referencedValueField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getComplexValueReference_ReferencedValue());
    _referencedPropertyField.loadData(capellaElement_p, DatavaluePackage.eINSTANCE.getComplexValueReference_ReferencedProperty());
  }
