...
/**
 */
public class Rule_FunctionInputPort extends Rule_CapellaElement {

  public Rule_FunctionInputPort() {
    super(FaPackage.Literals.FUNCTION_INPUT_PORT, FaPackage.Literals.FUNCTION_INPUT_PORT, InformationPackage.Literals.PORT_REALIZATION);
  }
  ...
  protected void retrieveGoDeep(EObject source_p, List<EObject> result_p, IContext context_p) {
    ...
    FunctionInputPort sourceElement = (FunctionInputPort) source_p;
  ...
  protected void attachRelated(EObject element_p, EObject result_p, IContext context_p) {
    ...
    AttachmentHelper.getInstance(context_p)
        .attachToBestElement(element_p, result_p, FaPackage.Literals.FUNCTION_INPUT_PORT__INCOMING_EXCHANGE_ITEMS, context_p);
  }
  ...
  protected EStructuralFeature getTargetContainementFeature(EObject element_p, EObject result_p, EObject container_p, IContext context_p) {
    return ActivityPackage.Literals.ABSTRACT_ACTION__INPUTS;
  }
