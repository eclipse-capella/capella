...
public class SelectInvokedOperationModel implements ISelectInvokedOperationModel {
  ...
  public boolean isValid() {
    ...
    return validInterfaceName && interfaceSet && (
				elementMustBeCreated && createdElementNameSet
				|| !elementMustBeCreated && selectedElement != null 
  		);    		
  }
  ...
  public MessageKind getMessageKind() {
    ...
    IBusinessQuery query = BusinessQueriesProvider.getInstance().getContribution(InteractionPackage.Literals.SEQUENCE_MESSAGE, InteractionPackage.Literals.SEQUENCE_MESSAGE__RECEIVING_END);
    for (CapellaElement capellaElement : query.getAvailableElements(sourceIR)) {
	...
	public CapellaElement createOrUpdateElement() {
		...
		if (elementMustBeCreated) {
			...
			com = new UndefinedCommunication((ExchangeItem) item);
		}
