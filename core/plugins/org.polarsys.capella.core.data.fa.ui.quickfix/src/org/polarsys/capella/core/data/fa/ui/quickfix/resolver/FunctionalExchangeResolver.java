...
public class FunctionalExchangeResolver extends AbstractCapellaMarkerResolution {
  @Override
  public void run(IMarker marker) {
    ...
    if ((null != modelElement) && (modelElement instanceof FunctionalExchange)) {
      QuickFixNavigationHelper.showCapellaElement((FunctionalExchange) modelElement);
    }
  }
