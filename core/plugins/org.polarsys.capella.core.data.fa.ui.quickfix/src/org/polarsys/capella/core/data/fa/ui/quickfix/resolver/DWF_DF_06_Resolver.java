...
/**
 * Move Functional exchanges to their default container
 *
 */
public class DWF_DF_06_Resolver extends AbstractCapellaMarkerResolution {
        ...
        public void run() {
          for (EObject object : modelElements) {
            if (object instanceof FunctionalExchange) {
              FunctionalExchangeExt.attachToDefaultContainer((FunctionalExchange) object);
            }
          }
        }
      };
