...
/**
 */
public class OACapabilityToSACapabilityTransitionCommand extends AbstractTransitionCommand {

  public OACapabilityToSACapabilityTransitionCommand(Collection<EObject> rootElements_p) {
    super(rootElements_p);
  }

  public OACapabilityToSACapabilityTransitionCommand(Collection<EObject> rootElements_p, IProgressMonitor progressMonitor_p) {
    super(rootElements_p, progressMonitor_p);
  }

  @Override
  public String getName() {
    return Messages.transitionOC2SC_label;
  }
