...
import org.polarsys.capella.core.projection.commands.LCtoPCTransitionCommand;
import org.polarsys.capella.common.tig.ef.command.ICommand;

/**
 */
public class LCtoPCTransitionAction extends AbstractTransitionAction {

  @Override
  protected ICommand createCommand(Collection<EObject> elements_p, IProgressMonitor progressMonitor_p) {
    return new LCtoPCTransitionCommand(elements_p, progressMonitor_p);
  }
