...
import org.polarsys.capella.core.projection.commands.InterfaceTransitionCommand;
import org.polarsys.capella.common.tig.ef.command.ICommand;

/**
 */
public class InterfaceTransitionAction extends AbstractTransitionAction {

  @Override
  protected ICommand createCommand(Collection<EObject> elements_p, IProgressMonitor progressMonitor_p) {
    return new InterfaceTransitionCommand(elements_p, progressMonitor_p);
  }
