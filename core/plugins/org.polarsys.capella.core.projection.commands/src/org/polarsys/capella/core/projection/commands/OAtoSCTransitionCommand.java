...
import org.polarsys.capella.core.transfo.operationalcapability.ExtendedTransformOAtoSC;

/**
 */
public class OAtoSCTransitionCommand extends AbstractTransitionCommand {

  public OAtoSCTransitionCommand(Collection<EObject> rootElements_p) {
    super(rootElements_p);
  }

  public OAtoSCTransitionCommand(Collection<EObject> rootElements_p, IProgressMonitor progressMonitor_p) {
    super(rootElements_p, progressMonitor_p);
  }

  @Override
  public String getName() {
    return Messages.transitionOA2SC_label;
  }
  ...
  protected AbstractTransform getTransformation(EObject element_p) {
    ...
    if ((element_p != null) && (element_p instanceof CapellaElement)) {
      ...
      if (CapellaLayerCheckingExt.isAOrInOperationalAnalysisLayer(element)) {
        return new ExtendedTransformOAtoSC();
      }
    }
