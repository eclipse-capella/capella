...
public class AddExchangeCategoryToPhysicalLinkCommand extends AbstractQueryBasedCommand {
	   ...
	   */
	  public AddExchangeCategoryToPhysicalLinkCommand(EClass linkType_p, EReference linkRefInSource_p) {
	    super("Add Exchange Category to Physical Link", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
	  }
