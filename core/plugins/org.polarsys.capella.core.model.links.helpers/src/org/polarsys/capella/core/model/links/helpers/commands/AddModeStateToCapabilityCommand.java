...
public class AddModeStateToCapabilityCommand extends AbstractQueryBasedCommand {
	   ...
	   */
	  public AddModeStateToCapabilityCommand(EClass linkType_p, EReference linkRefInSource_p) {
	    super("Add Mode or State to Capability", LinkStyle.LINE_SOLID, linkType_p, linkRefInSource_p);
	  }
