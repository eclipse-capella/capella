...
public class CreateFunctionalAllocationCommand extends CreateTraceCommand {
  public CreateFunctionalAllocationCommand(EClass linkType_p, EReference linkRefInSource_p) {
    super("Allocation", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
  }
}
