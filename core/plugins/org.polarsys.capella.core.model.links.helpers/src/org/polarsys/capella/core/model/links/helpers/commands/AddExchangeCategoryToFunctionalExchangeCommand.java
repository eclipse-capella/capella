...
public class AddExchangeCategoryToFunctionalExchangeCommand extends AbstractQueryBasedCommand {
	   ...
	   */
	  public AddExchangeCategoryToFunctionalExchangeCommand(EClass linkType_p, EReference linkRefInSource_p) {
	    super("Add Exchange Category to Functional Exchange", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
	  }
