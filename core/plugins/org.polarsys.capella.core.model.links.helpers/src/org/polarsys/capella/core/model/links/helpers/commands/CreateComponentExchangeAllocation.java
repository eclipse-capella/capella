 ...
 * 
 */
  public CreateComponentExchangeAllocation(EClass linkType_p, EReference linkRefInSource_p) {
    super("Component Exchange Allocation", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
  }
}
