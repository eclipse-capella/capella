...
public class AddComponentExchangeToPhysicalLinkCommand extends AbstractQueryBasedCommand {
	   ...
	   */
	  public AddComponentExchangeToPhysicalLinkCommand(EClass linkType_p, EReference linkRefInSource_p) {
	    super("Add Component Exchange to Physical Link", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
	  }
