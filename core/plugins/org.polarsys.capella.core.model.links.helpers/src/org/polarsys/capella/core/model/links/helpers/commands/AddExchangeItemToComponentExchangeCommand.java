...
public class AddExchangeItemToComponentExchangeCommand extends AbstractQueryBasedCommand {
	   ...
	   */
	  public AddExchangeItemToComponentExchangeCommand(EClass linkType_p, EReference linkRefInSource_p) {
	    super("Add Exchange Item to Component Exchange", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
	  }
