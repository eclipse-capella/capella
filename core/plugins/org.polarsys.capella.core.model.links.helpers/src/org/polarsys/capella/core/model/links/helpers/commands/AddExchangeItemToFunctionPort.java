...
public class AddExchangeItemToFunctionPort extends AbstractQueryBasedCommand {
   ...
   */
  public AddExchangeItemToFunctionPort(EClass linkType_p, EReference linkRefInSource_p) {
    super("Add ExchangeItem to FunctionPort", LinkStyle.LINE_DASHED, linkType_p, linkRefInSource_p);
  }
