...
/**
 * Functional exchanges on the same input port must have the same EI. On the checked FE, signals the EI on other FE that
 * are on the same port.
 */
public class FunctionalExchangesOnOneInPortSameEI extends AbstractValidationRule {
