...
public class Rule_Event extends CommonRule {
  ...
  private AbstractEventOperation getRelatedConnection(AbstractEventOperation operation_p, Event event_p, int n, ITransfo transfo_p) {
    ...
    if (operation_p instanceof FunctionalExchange) {
      ...
      ComponentExchange connection = null;
    ...
    notifyMessage(NLS.bind(Messages.Rule_Event_FunctionalExchangeNotAllocated, EObjectLabelProviderHelper.getText(operation_p), EObjectLabelProviderHelper
        .getText(relatedMessage)), new Object[] { relatedMessage, operation_p }, ReportManagerConstants.LOG_LEVEL_WARN, transfo_p);
