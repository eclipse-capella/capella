...
import org.polarsys.capella.core.projection.scenario.es2is.handlers.ScenarioES2ISHandler;
...
/**
 */
public class ES2ISTransform extends ScenarioTransform {

  /**
   * Tiger context used. This context is declared implementing an extension point.
   */
  private static final String CAPELLA_SCENARIO_RULES = "org.polarsys.capella.core.projection.scenario.es2is"; //$NON-NLS-1$
  ...
  protected IScenarioHandler createScenarioHandler(IContext context_p) {
    return new ScenarioES2ISHandler();
  }
  ...
  protected boolean isValidTransitionedScenario(Scenario contextElement_p, Scenario scenario_p) {
    ...
    return (scenario_p.getKind() == ScenarioKind.INTERFACE) && sourceBlock.equals(targetBlock);
  }
