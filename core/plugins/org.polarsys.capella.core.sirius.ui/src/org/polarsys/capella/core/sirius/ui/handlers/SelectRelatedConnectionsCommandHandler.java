...
public class SelectRelatedConnectionsCommandHandler extends AbstractSelectInEditorCommandHandler {

  @Override
  protected Collection<? extends DRepresentationElement> getElementsToSelect() {
    IStructuredSelection selection = getSelection();
    return SelectionHelper.eINSTANCE.getRelatedConnections(selection);
  }
}
