...
public class SelectRelatedPPElementsCommandHandler extends AbstractSelectInEditorCommandHandler {

  @Override
  protected Collection<? extends DRepresentationElement> getElementsToSelect() {
    IStructuredSelection selection = getSelection();
    return SelectionHelper.eINSTANCE.getRelatedPhysicalPathElements(selection);
  }
}
