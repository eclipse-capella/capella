...
public class DWF_DS_22_Resolutions extends AbstractMarkerResolutionGenerator {
  ...
  protected IMarkerResolution[] doGetResolutions(IMarker marker) {
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.GOTO_RelatedModeState, stateFragment.getRelatedAbstractState()));
    ...
    resolutions.add(new CapellaElementGoToResolver(Messages.GOTO_RoleFunction, abstractFunction));
    ...
    // Delete.
    resolutions.add(new DeleteCommandResolver(Messages.DWF_DS_20_21_22_Resolutions_Delete, stateFragment));
