...
/**
 * Section filter for Define Interfaces and describe scenarios.
 */
public class DefineInterfacesDescribeScenariosFilteringAction extends AbstractSAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public DefineInterfacesDescribeScenariosFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
