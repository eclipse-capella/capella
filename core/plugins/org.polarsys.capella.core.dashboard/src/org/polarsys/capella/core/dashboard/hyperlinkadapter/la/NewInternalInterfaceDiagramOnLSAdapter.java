...
/**
 * Create a new internal interface diagram on the Logical System.
 */
public class NewInternalInterfaceDiagramOnLSAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewInternalInterfaceDiagramOnLSAdapter(Project capellaProject_p, Session session_p) {
    super(session_p);
  }
