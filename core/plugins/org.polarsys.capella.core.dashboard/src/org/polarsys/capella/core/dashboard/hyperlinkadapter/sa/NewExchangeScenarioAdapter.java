 ...
 */
public class NewExchangeScenarioAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewExchangeScenarioAdapter(Session session_p) {
    super(session_p);
  }
  ...
  protected ModelElement getModelElement(Project project_p) {
    ...
    return ModelCreationHelper.selectCapabilityAndCreateScenario(project_p, systemAnalysis, ScenarioKind.DATA_FLOW);
  }
}
