 ...
 */
public class NewPhysicalComponentLogicalComponentMatrixAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewPhysicalComponentLogicalComponentMatrixAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected String getDiagramName() {
    return IDiagramNameConstants.PHYSICAL_COMPONENTS_LOGICAL_COMPONENTS_DIAGRAM_NAME;
  }
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getPhysicalArchitecture(project_p);
  }
}
