 ...
 */
public class NewActorsAllocationsDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewActorsAllocationsDiagramAdapter(Project capellaProject_p, Session session_p) {
