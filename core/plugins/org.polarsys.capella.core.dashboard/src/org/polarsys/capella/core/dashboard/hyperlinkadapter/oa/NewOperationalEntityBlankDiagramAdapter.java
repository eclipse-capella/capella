 ...
 */
public class NewOperationalEntityBlankDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewOperationalEntityBlankDiagramAdapter(Project capellaProject_p, Session session_p) {
