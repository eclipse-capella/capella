...
/**
 * Create a new internal interface diagram on the Physical System.
 */
public class NewInternalInterfaceDiagramOnPSAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewInternalInterfaceDiagramOnPSAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getPhysicalSystem(project_p);
  }
}
