 ...
 */
public class NewAllocationPcPfMatrixAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewAllocationPcPfMatrixAdapter(Project capellaProject_p, Session session_p) {
