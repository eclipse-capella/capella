 ...
 */
public class PerformAutomatedTransitionOfSystemActorsAdapter extends AbstractHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public PerformAutomatedTransitionOfSystemActorsAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getSystemActorPkg(project_p);
  }
}
