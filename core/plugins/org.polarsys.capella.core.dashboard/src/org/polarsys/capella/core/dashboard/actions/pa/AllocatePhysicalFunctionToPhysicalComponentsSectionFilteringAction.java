...
/**
 * Section filter for Allocate Physical functions to Physical components and manage deployments.
 */
public class AllocatePhysicalFunctionToPhysicalComponentsSectionFilteringAction extends AbstractPAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public AllocatePhysicalFunctionToPhysicalComponentsSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions =
        { IDiagramNameConstants.PHYSICAL_ARCHITECTURE_BLANK_DIAGRAM_NAME, IDiagramNameConstants.PHYSICAL_COMPONENTS_PHYSICAL_FUNCTIONS_DIAGRAM_NAME,
