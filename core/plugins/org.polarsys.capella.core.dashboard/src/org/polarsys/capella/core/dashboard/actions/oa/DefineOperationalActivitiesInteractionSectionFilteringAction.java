...
/**
 * Section filter for Define operational activities and describe interactions Section.
 */
public class DefineOperationalActivitiesInteractionSectionFilteringAction extends AbstractOAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public DefineOperationalActivitiesInteractionSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions = {
      ...
      IDiagramNameConstants.CONTEXTUAL_OPERATIONAL_ACTIVITY_INTERACTION_DIAGRAM_NAME
    };
