...
/**
 * Section filter for Refine System Capability to EPBS Architecture.
 */
public class RefineSystemCapabilityToEpbsArchitectureSectionFilteringAction extends AbstractEPBSViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public RefineSystemCapabilityToEpbsArchitectureSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
