...
/**
 * Section filter for Create Delegate Logical Interfaces and create Physical Interfaces.
 */
public class DelegateLogicalInterfacesCreatePhysicalInterfacesSectionFilteringAction extends AbstractPAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public DelegateLogicalInterfacesCreatePhysicalInterfacesSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions =
        { IDiagramNameConstants.CONTEXTUAL_COMPONENT_DETAILED_INTERFACES_DIAGRAM_NAME,
         IDiagramNameConstants.CONTEXTUAL_COMPONENT_EXTERNAL_INTERFACES_DIAGRAM_NAME, IDiagramNameConstants.INTERFACES_BLANK_DIAGRAM_NAME };
