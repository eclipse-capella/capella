 ...
 */
public class NewAllocationLcLfMatrixAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewAllocationLcLfMatrixAdapter(Project capellaProject_p, Session session_p) {
