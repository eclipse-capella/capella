 ...
 */
public class NewActivityScenarioAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * @param capellaProject_p
   * @param session_p
   */
  public NewActivityScenarioAdapter(Project capellaProject_p, Session session_p) {
