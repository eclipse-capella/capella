 ...
 */
public class NewInteractionScenarioAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewInteractionScenarioAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelCreationHelper.selectOperationalCapabilityAndCreateInteractionScenario(project_p);
  }
}
