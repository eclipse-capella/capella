...
/**
 * Create a new Operational Activity Breakdown diagram.
 */
public class NewOperationalActivityBreakdownDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewOperationalActivityBreakdownDiagramAdapter(Project capellaProject_p, Session session_p) {
