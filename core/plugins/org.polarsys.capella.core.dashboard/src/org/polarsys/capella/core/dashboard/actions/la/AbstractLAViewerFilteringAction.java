...
/**
 */
public abstract class AbstractLAViewerFilteringAction extends AbstractViewerFilteringAction {
  /**
   * Default constructor.
   * @param capellaArchitecturePage_p
   */
  public AbstractLAViewerFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
