...
/**
 */
public abstract class AbstractPAViewerFilteringAction extends AbstractViewerFilteringAction {
  /**
   * Default constructor.
   * @param capellaArchitecturePage_p
   */
  public AbstractPAViewerFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
