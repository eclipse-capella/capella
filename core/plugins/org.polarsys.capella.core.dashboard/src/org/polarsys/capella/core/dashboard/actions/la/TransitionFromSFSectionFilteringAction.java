...
/**
 * Section filter for Transition from System Functions.
 */
public class TransitionFromSFSectionFilteringAction extends AbstractLAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public TransitionFromSFSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions = {
      IDiagramNameConstants.LOGICAL_FUNCTIONS_SYSTEM_FUNCTIONS_DIAGRAM_NAME
    };
