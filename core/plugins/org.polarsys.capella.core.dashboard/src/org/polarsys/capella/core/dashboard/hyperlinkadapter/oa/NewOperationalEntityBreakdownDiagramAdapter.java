...
/**
 * Create a new Operational Entity Breakdown diagram.
 */
public class NewOperationalEntityBreakdownDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewOperationalEntityBreakdownDiagramAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getOperationalContext(project_p);
  }
}
