...
public class PhysicalFunctionsLogicalFunctionsAction extends AbstractCapellaAction {
   ...
   * @param session_p
   */
  public PhysicalFunctionsLogicalFunctionsAction(Project capellaProject_p, Session session_p) {
    super(Messages.PhysicalFunctionsLogicalFunctionsAction_Title, IImageKeys.IMAGE_DESCRIPTOR_NEW_TABLE, capellaProject_p, session_p);
  }
