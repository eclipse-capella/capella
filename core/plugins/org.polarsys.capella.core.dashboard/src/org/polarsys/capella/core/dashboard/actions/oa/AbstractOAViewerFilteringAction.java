...
/**
 */
public abstract class AbstractOAViewerFilteringAction extends AbstractViewerFilteringAction {
  /**
   * Default constructor.
   * @param capellaArchitecturePage_p
   */
  public AbstractOAViewerFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
