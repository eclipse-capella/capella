...
public abstract class AbstractDescriptionAction extends Action {
	...
	public AbstractDescriptionAction(Shell shell_p) {
		...
		setImageDescriptor(CapellaDashboardActivator.getDefault()
				.getImageDescriptor(IImageKeys.IMAGE_DESCRIPTOR_DESCRIPTION));
		_shell = shell_p;
	}
	...
	@Override
	public void run() {
		String descriptionContent = FileHelper.readFile(getDescriptionFolder()
				+ getDescriptionFile());
	 ...
	 * <code>org.polarsys.capella.core.dashboard/xml/</code> that is only
	 * convenient for actions implemented in this plug-in.<br>
