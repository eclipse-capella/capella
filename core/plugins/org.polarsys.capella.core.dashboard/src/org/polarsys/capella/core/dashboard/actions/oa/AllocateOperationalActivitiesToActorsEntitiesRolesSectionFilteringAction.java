...
/**
 * Section filter for Allocate operational activities to operational actors, entities or roles.
 */
public class AllocateOperationalActivitiesToActorsEntitiesRolesSectionFilteringAction extends AbstractOAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public AllocateOperationalActivitiesToActorsEntitiesRolesSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions =
        { IDiagramNameConstants.OPERATIONAL_ENTITY_BLANK_DIAGRAM_NAME, IDiagramNameConstants.OPERATIONAL_INTERACTION_SCENARIO_DIAGRAM_NAME };
