 ...
 */
public class NewDetailedInterfaceDiagramOnSystemAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewDetailedInterfaceDiagramOnSystemAdapter(Project capellaProject_p, Session session_p) {
