 ...
 */
public class NewOperationalCapabilityBlankDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewOperationalCapabilityBlankDiagramAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getRootOperationalCapability(project_p);
  }
}
