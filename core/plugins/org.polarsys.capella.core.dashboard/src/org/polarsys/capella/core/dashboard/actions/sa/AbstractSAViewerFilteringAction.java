...
/**
 */
public abstract class AbstractSAViewerFilteringAction extends AbstractViewerFilteringAction {
  /**
   * Default constructor.
   * @param capellaArchitecturePage_p
   */
  public AbstractSAViewerFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
