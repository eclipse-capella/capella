 ...
 */
public class NewContextualSystemActorsDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewContextualSystemActorsDiagramAdapter(Project capellaProject_p, Session session_p) {
