 ...
 */
public class NewFunctionalBreakdownDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewFunctionalBreakdownDiagramAdapter(Project capellaProject_p, Session session_p) {
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelQueryHelper.getRootLogicalFunction(project_p);
  }
}
