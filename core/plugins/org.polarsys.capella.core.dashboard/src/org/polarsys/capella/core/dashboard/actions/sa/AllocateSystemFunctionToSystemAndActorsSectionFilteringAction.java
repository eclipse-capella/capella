...
/**
 * Section filter for Allocate system function to system and actors.
 */
public class AllocateSystemFunctionToSystemAndActorsSectionFilteringAction extends AbstractSAViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public AllocateSystemFunctionToSystemAndActorsSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
  ...
  protected List<String> getRetainedRepresentationDescriptions() {
    String[] retainedRepresentationDescriptions =
        { IDiagramNameConstants.SYSTEM_ARCHITECTURE_BLANK_DIAGRAM_NAME, IDiagramNameConstants.DATA_FLOW_SCENARIO_DIAGRAM_NAME };
