...
/**
 * Section filter for Define CI Components.
 */
public class DefineCiComponentsSectionFilteringAction extends AbstractEPBSViewerFilteringAction {
  /**
   * Constructor.
   * @param capellaArchitecturePage_p
   */
  public DefineCiComponentsSectionFilteringAction(AbstractCapellaArchitectureDashboardPage capellaArchitecturePage_p) {
