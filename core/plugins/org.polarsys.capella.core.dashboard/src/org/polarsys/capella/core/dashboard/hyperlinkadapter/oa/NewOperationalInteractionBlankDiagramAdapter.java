 ...
 */
public class NewOperationalInteractionBlankDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewOperationalInteractionBlankDiagramAdapter(Project capellaProject_p, Session session_p) {
