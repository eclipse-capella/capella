 ...
 */
public class NewExternalInterfaceDiagramOnSystemAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewExternalInterfaceDiagramOnSystemAdapter(Project capellaProject_p, Session session_p) {
