 ...
 */
public class NewStateMachineDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewStateMachineDiagramAdapter(Session session_p) {
    super(session_p);
  }
  ...
  protected ModelElement getModelElement(Project project_p) {
    return ModelCreationHelper.selectComponentAtSALevelAndCreateStateMachineRegion(project_p);
  }
