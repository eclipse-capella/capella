...
public class NewScenarioDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
   ...
   * @param session_p
   */
  public NewScenarioDiagramAdapter(Session session_p) {
    super(session_p);
  }
  ...
  protected ModelElement getModelElement(Project project_p) {
    PhysicalArchitecture physicalArchitecture = ModelQueryHelper.getPhysicalArchitecture(project_p);
    return ModelCreationHelper.selectCapabilityAndCreateScenario(project_p, physicalArchitecture, ScenarioKind.INTERFACE);
  }
}
