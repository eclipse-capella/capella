 ...
 */
public class NewSystemFunctionsOperationalActivitiesMatrixAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewSystemFunctionsOperationalActivitiesMatrixAdapter(Project capellaProject_p, Session session_p) {
