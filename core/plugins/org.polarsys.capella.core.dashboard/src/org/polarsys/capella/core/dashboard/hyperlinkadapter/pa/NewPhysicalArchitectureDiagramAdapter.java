 ...
 */
public class NewPhysicalArchitectureDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewPhysicalArchitectureDiagramAdapter(Project capellaProject_p, Session session_p) {
