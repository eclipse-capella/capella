 ...
 */
public class NewRoleBlankDiagramAdapter extends AbstractNewDiagramHyperlinkAdapter {
  /**
   * Constructor.
   * @param capellaProject_p
   * @param session_p
   */
  public NewRoleBlankDiagramAdapter(Project capellaProject_p, Session session_p) {
