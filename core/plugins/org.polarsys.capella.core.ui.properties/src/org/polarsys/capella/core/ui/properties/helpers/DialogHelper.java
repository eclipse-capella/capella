...
public class DialogHelper {
   ...
   * @return
   */
  public static EObject openSimpleSelectionDialog(Control control_p, Collection<? extends EObject> list_p) {
    boolean expandViewer = CapellaUIPropertiesPlugin.getDefault().isAllowedExpandSingleViewerContent();

    return SelectionDialogHelper.simplePropertySelectionDialogWizard(list_p, control_p.getShell(), expandViewer ? AbstractTreeViewer.ALL_LEVELS : 0);
  }
   ...
   * @return
   */
  public static Collection<? extends EObject> openMultiSelectionDialog(Control control_p, Collection<? extends EObject> list_p) {
    boolean expandViewer = CapellaUIPropertiesPlugin.getDefault().isAllowedExpandSingleViewerContent();

    return SelectionDialogHelper.simplePropertiesSelectionDialogWizard(list_p, control_p.getShell(), expandViewer ? AbstractTreeViewer.ALL_LEVELS : 0);
  }
