...
public class TraceTreeViewer implements IDoubleClickListener {
  ...
  public Composite getControl(Composite parent_p) {
    ...
    _addItem.setImage(AbstractUIPlugin.imageDescriptorFromPlugin(FrameworkUtil.getBundle(MDTrace.class).getSymbolicName(), IImageKeys.ACTION_ADD).createImage());
    prepareMenuItems();
    ...
    _removeItem.setImage(MDTrace.imageDescriptorFromPlugin(FrameworkUtil.getBundle(MDTrace.class).getSymbolicName(), IImageKeys.ACTION_REMOVE).createImage());
  ...
  public void prepareMenuItems() {
    ...
    for (String traceName : TraceNameHelper.getManualTraceTypes()) {
      ...
      item.setImage(AbstractUIPlugin.imageDescriptorFromPlugin(FrameworkUtil.getBundle(MDTrace.class).getSymbolicName(), IImageKeys.MENU_ITEM).createImage());
