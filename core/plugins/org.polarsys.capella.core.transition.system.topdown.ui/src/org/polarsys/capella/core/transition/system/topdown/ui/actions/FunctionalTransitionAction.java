 ...
 *
 */
public class FunctionalTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getFunctionalTransitionCommand(selection_p, progressMonitor_p);
  }
}
