 ...
 *
 */
public class OA2SCTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getOAtoSCTransitionCommand(selection_p, progressMonitor_p);
  }
}
