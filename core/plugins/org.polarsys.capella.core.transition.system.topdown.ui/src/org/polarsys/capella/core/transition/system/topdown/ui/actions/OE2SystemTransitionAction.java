 ...
 *
 */
public class OE2SystemTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getOE2SystemTransitionCommand(selection_p, progressMonitor_p);
  }
}
