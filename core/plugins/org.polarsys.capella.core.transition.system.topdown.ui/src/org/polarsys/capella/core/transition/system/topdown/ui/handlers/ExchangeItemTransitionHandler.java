 ...
 *
 */
public class ExchangeItemTransitionHandler extends IntramodelTransitionHandler {

  @Override
  protected ICommand createCommand(Collection<?> selection, IProgressMonitor progressMonitor) {
    return TransitionUICommandHelper.getInstance().getExchangeItemTransitionCommand(selection, progressMonitor);
  }
}
