 ...
 *
 */
public class StateMachineTransitionHandler extends IntramodelTransitionHandler {

  @Override
  protected ICommand createCommand(Collection<?> selection, IProgressMonitor progressMonitor) {
    return TransitionUICommandHelper.getInstance().getStateMachineTransitionCommand(selection, progressMonitor);
  }
}
