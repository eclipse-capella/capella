 ...
 *
 */
public class StateMachineTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getStateMachineTransitionCommand(selection_p, progressMonitor_p);
  }
}
