 ...
 *
 */
public class CapabilityTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getCapabilityTransitionCommand(selection_p, progressMonitor_p);
  }
