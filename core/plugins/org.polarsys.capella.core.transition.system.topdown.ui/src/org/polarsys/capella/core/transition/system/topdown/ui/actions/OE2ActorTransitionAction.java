 ...
 *
 */
public class OE2ActorTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getOE2ActorTransitionCommand(selection_p, progressMonitor_p);
  }
}
