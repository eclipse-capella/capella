...
/**
 */
public class InterfaceTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getInterfaceTransitionCommand(selection_p, progressMonitor_p);
  }
