 ...
 *
 */
public class OA2SMTransitionAction extends IntramodelTransitionAction {

  @Override
  protected ICommand createCommand(Collection<Object> selection_p, IProgressMonitor progressMonitor_p) {
    return TransitionUICommandHelper.getInstance().getOAtoSMTransitionCommand(selection_p, progressMonitor_p);
  }
}
