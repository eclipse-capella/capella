...
public class PhysicalActor_RealizedLogicalActor extends AbstractValidationRule {
  /**
    ...
    if (eType == EMFEventType.NULL) {
      if (eObj instanceof PhysicalComponent && ComponentExt.isActor(eObj)) {
        ...
        return ctx.createFailureStatus(
           NLS.bind(Messages.PhysicalActor_RealizedLogicalActor_0, CapellaElementExt.getValidationRuleMessagePrefix(actor)));
      }
    }
    return ctx.createSuccessStatus();
  }
