...
public interface StateTransition extends NamedElement, Relationship {
   ...
   *        annotation=
   *        "http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='' explanation='none' constraints='none'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.core.data.capellacommon.StateTransition#getGuard <em>Guard</em>}
   * ' reference.
   * 
   ...
   * {@link org.polarsys.capella.core.data.capellacommon.TransitionKind}.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   *        annotation=
   *        "http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='uml::Transition::kind' explanation='none' constraints='none'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.core.data.capellacommon.StateTransition#getKind <em>Kind</em>}'
   * attribute.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.core.data.capellacommon.StateTransition#getTriggerDescription
   * <em>Trigger Description</em>}' attribute.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Trigger Description</em>' attribute.
   ...
   * {@link org.polarsys.capella.core.data.capellacommon.AbstractState#getOutgoing <em>Outgoing</em>}'.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @model opposite="outgoing" required="true" annotation=
   ...
   *        annotation=
   *        "http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='uml::Transition::source' explanation='none' constraints='none'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.core.data.capellacommon.StateTransition#getSource
   ...
   * {@link org.polarsys.capella.core.data.capellacommon.AbstractState#getIncoming <em>Incoming</em>}'.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @model opposite="incoming" required="true" annotation=
   ...
   *        annotation=
   *        "http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='uml::Transition::target' explanation='none' constraints='none'"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.core.data.capellacommon.StateTransition#getTarget
  ...
  /**
   * Returns the value of the '<em><b>Effect</b></em>' reference list. The list contents are of type
   * {@link org.polarsys.capella.common.data.behavior.AbstractEvent}.
   * 
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Triggers</b></em>' reference list. The list contents are of type
   * {@link org.polarsys.capella.common.data.behavior.AbstractEvent}.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   *        annotation=
   *        "http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='uml::Transition::trigger' explanation='none' constraints='none'"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Owned State Transition Realizations</b></em>' containment reference list. The list
   * contents are of type {@link org.polarsys.capella.core.data.capellacommon.StateTransitionRealization}.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @model containment="true" resolveProxies="true" annotation=
  ...
  /**
   * Returns the value of the '<em><b>Realized State Transitions</b></em>' reference list. The list contents are of type
   * {@link org.polarsys.capella.core.data.capellacommon.StateTransition}.
   * 
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Realizing State Transitions</b></em>' reference list. The list contents are of
   * type {@link org.polarsys.capella.core.data.capellacommon.StateTransition}.
   * 
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @model resolveProxies="false" transient="true" changeable="false" volatile="true" derived="true" annotation=
