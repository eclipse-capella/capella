 ...
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getContainedGenericTraces <em>Contained
 ...
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#isIsControlOperator <em>Is Control
 * Operator</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedParameterSet <em>Owned Parameter
 * Set</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedParameter <em>Owned
 * Parameter</em>}</li>
 ...
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getPostCondition <em>Post
 * Condition</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedInstanceRoles <em>Owned Instance
 * Roles</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedMessages <em>Owned
 * Messages</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedInteractionFragments <em>Owned
 * Interaction Fragments</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedTimeLapses <em>Owned Time
 * Lapses</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedEvents <em>Owned Events</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedFormalGates <em>Owned Formal
 * Gates</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedScenarioRealization <em>Owned
 * Scenario Realization</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getOwnedConstraintDurations <em>Owned
 * Constraint Durations</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getContainedFunctions <em>Contained
 * Functions</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getContainedParts <em>Contained
 * Parts</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getReferencedScenarios <em>Referenced
 * Scenarios</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getRealizedScenarios <em>Realized
 * Scenarios</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.ScenarioImpl#getRealizingScenarios <em>Realizing
 * Scenarios</em>}</li>
 * </ul>
 *
 * @generated
...
public class ScenarioImpl extends NamedElementImpl implements Scenario {
  ...
  /**
   * The cached value of the '{@link #getOwnedParameter() <em>Owned Parameter</em>}' reference list. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The default value of the '{@link #isMerged() <em>Merged</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #isMerged()
   * @generated
  ...
  /**
   * The cached value of the '{@link #isMerged() <em>Merged</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @see #isMerged()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getOwnedInstanceRoles() <em>Owned Instance Roles</em>}' containment reference
  ...
  /**
   * The cached value of the '{@link #getOwnedInteractionFragments() <em>Owned Interaction Fragments</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getOwnedScenarioRealization() <em>Owned Scenario Realization</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getOwnedConstraintDurations() <em>Owned Constraint Durations</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public EList<NamingRule> getNamingRules() {
    ...
    if (namingRules == null) {
      namingRules = new EObjectContainmentEList<NamingRule>(NamingRule.class, this,
          InteractionPackage.SCENARIO__NAMING_RULES);
    }
    return namingRules;
  }
  ...
  public void setIsControlOperator(boolean newIsControlOperator) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SCENARIO__IS_CONTROL_OPERATOR,
          oldIsControlOperator, isControlOperator));
  ...
  public EList<AbstractParameterSet> getOwnedParameterSet() {
    ...
    if (ownedParameterSet == null) {
      ownedParameterSet = new EObjectResolvingEList<AbstractParameterSet>(AbstractParameterSet.class, this,
          InteractionPackage.SCENARIO__OWNED_PARAMETER_SET);
    }
  ...
  public EList<AbstractParameter> getOwnedParameter() {
    ...
    if (ownedParameter == null) {
      ownedParameter = new EObjectResolvingEList<AbstractParameter>(AbstractParameter.class, this,
          InteractionPackage.SCENARIO__OWNED_PARAMETER);
    }
  ...
  public Constraint getPreCondition() {
    ...
    if (preCondition != null && preCondition.eIsProxy()) {
      ...
      if (preCondition != oldPreCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.SCENARIO__PRE_CONDITION,
  ...
  public void setPreCondition(Constraint newPreCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SCENARIO__PRE_CONDITION, oldPreCondition,
          preCondition));
  ...
  public Constraint getPostCondition() {
    ...
    if (postCondition != null && postCondition.eIsProxy()) {
      ...
      if (postCondition != oldPostCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.SCENARIO__POST_CONDITION,
  ...
  public void setPostCondition(Constraint newPostCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SCENARIO__POST_CONDITION,
          oldPostCondition, postCondition));
  ...
  public EList<InstanceRole> getOwnedInstanceRoles() {
    ...
    if (ownedInstanceRoles == null) {
      ownedInstanceRoles = new EObjectContainmentEList<InstanceRole>(InstanceRole.class, this,
          InteractionPackage.SCENARIO__OWNED_INSTANCE_ROLES);
    }
  ...
  public EList<SequenceMessage> getOwnedMessages() {
    ...
    if (ownedMessages == null) {
      ownedMessages = new EObjectContainmentEList<SequenceMessage>(SequenceMessage.class, this,
          InteractionPackage.SCENARIO__OWNED_MESSAGES);
    }
  ...
  public EList<InteractionFragment> getOwnedInteractionFragments() {
    ...
    if (ownedInteractionFragments == null) {
      ownedInteractionFragments = new EObjectContainmentEList<InteractionFragment>(InteractionFragment.class, this,
          InteractionPackage.SCENARIO__OWNED_INTERACTION_FRAGMENTS);
    }
  ...
  public EList<TimeLapse> getOwnedTimeLapses() {
    ...
    if (ownedTimeLapses == null) {
      ownedTimeLapses = new EObjectContainmentEList<TimeLapse>(TimeLapse.class, this,
          InteractionPackage.SCENARIO__OWNED_TIME_LAPSES);
    }
  ...
  public EList<Gate> getOwnedFormalGates() {
    ...
    if (ownedFormalGates == null) {
      ownedFormalGates = new EObjectContainmentEList.Resolving<Gate>(Gate.class, this,
          InteractionPackage.SCENARIO__OWNED_FORMAL_GATES);
    }
  ...
  public EList<ScenarioRealization> getOwnedScenarioRealization() {
    ...
    if (ownedScenarioRealization == null) {
      ownedScenarioRealization = new EObjectContainmentEList.Resolving<ScenarioRealization>(ScenarioRealization.class,
          this, InteractionPackage.SCENARIO__OWNED_SCENARIO_REALIZATION);
    }
  ...
  public EList<ConstraintDuration> getOwnedConstraintDurations() {
    ...
    if (ownedConstraintDurations == null) {
      ownedConstraintDurations = new EObjectContainmentEList.Resolving<ConstraintDuration>(ConstraintDuration.class,
          this, InteractionPackage.SCENARIO__OWNED_CONSTRAINT_DURATIONS);
    }
  ...
  public EList<AbstractFunction> getContainedFunctions() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.SCENARIO__CONTAINED_FUNCTIONS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractFunction>(this,
          InteractionPackage.Literals.SCENARIO__CONTAINED_FUNCTIONS, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<Part> getContainedParts() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.SCENARIO__CONTAINED_PARTS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<Part>(this, InteractionPackage.Literals.SCENARIO__CONTAINED_PARTS,
  ...
  public EList<Scenario> getReferencedScenarios() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.SCENARIO__REFERENCED_SCENARIOS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<Scenario>(this,
          InteractionPackage.Literals.SCENARIO__REFERENCED_SCENARIOS, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<Scenario> getRealizedScenarios() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.SCENARIO__REALIZED_SCENARIOS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      @SuppressWarnings("unchecked")
      Collection<Scenario> resultAsList = (Collection<Scenario>) result;
      return new EcoreEList.UnmodifiableEList<Scenario>(this, InteractionPackage.Literals.SCENARIO__REALIZED_SCENARIOS,
          resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<Scenario> getRealizingScenarios() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.SCENARIO__REALIZING_SCENARIOS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      @SuppressWarnings("unchecked")
      Collection<Scenario> resultAsList = (Collection<Scenario>) result;
      return new EcoreEList.UnmodifiableEList<Scenario>(this, InteractionPackage.Literals.SCENARIO__REALIZING_SCENARIOS,
          resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == AbstractBehavior.class) {
      ...
      case InteractionPackage.SCENARIO__IS_CONTROL_OPERATOR:
        return BehaviorPackage.ABSTRACT_BEHAVIOR__IS_CONTROL_OPERATOR;
      case InteractionPackage.SCENARIO__OWNED_PARAMETER_SET:
        return BehaviorPackage.ABSTRACT_BEHAVIOR__OWNED_PARAMETER_SET;
      case InteractionPackage.SCENARIO__OWNED_PARAMETER:
        return BehaviorPackage.ABSTRACT_BEHAVIOR__OWNED_PARAMETER;
      default:
        return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == AbstractBehavior.class) {
      ...
      case BehaviorPackage.ABSTRACT_BEHAVIOR__IS_CONTROL_OPERATOR:
        return InteractionPackage.SCENARIO__IS_CONTROL_OPERATOR;
      case BehaviorPackage.ABSTRACT_BEHAVIOR__OWNED_PARAMETER_SET:
        return InteractionPackage.SCENARIO__OWNED_PARAMETER_SET;
      case BehaviorPackage.ABSTRACT_BEHAVIOR__OWNED_PARAMETER:
        return InteractionPackage.SCENARIO__OWNED_PARAMETER;
      default:
        return -1;
      }
    }
