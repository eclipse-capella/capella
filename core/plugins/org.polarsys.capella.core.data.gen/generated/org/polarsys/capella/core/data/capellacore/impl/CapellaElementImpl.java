...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Capella Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.CapellaElementImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class CapellaElementImpl extends ModelElementImpl implements CapellaElement {
	...
	public void setVisibleInDoc(boolean newVisibleInDoc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
	...
	public void setVisibleInLM(boolean newVisibleInLM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_LM, oldVisibleInLM, visibleInLM));
	...
	public void setSummary(String newSummary) {
		...
		summary = newSummary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__SUMMARY, oldSummary, summary));
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__DESCRIPTION, oldDescription, description));
	...
	public void setReview(String newReview) {
		...
		review = newReview;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__REVIEW, oldReview, review));
	...
	public EList<AbstractPropertyValue> getOwnedPropertyValues() {
		...
		if (ownedPropertyValues == null) {
			ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class, this, CapellacorePackage.CAPELLA_ELEMENT__OWNED_PROPERTY_VALUES);
		}
	...
	public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
		...
		if (ownedEnumerationPropertyTypes == null) {
			ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(EnumerationPropertyType.class, this, CapellacorePackage.CAPELLA_ELEMENT__OWNED_ENUMERATION_PROPERTY_TYPES);
		}
	...
	public EList<AbstractPropertyValue> getAppliedPropertyValues() {
		...
		if (appliedPropertyValues == null) {
			appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this, CapellacorePackage.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
		}
	...
	public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
		...
		if (ownedPropertyValueGroups == null) {
			ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class, this, CapellacorePackage.CAPELLA_ELEMENT__OWNED_PROPERTY_VALUE_GROUPS);
		}
	...
	public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
		...
		if (appliedPropertyValueGroups == null) {
			appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this, CapellacorePackage.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUE_GROUPS);
		}
	...
	public EnumerationPropertyLiteral getStatus() {
		...
		if (status != null && status.eIsProxy()) {
			...
			if (status != oldStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CapellacorePackage.CAPELLA_ELEMENT__STATUS, oldStatus, status));
			}
		}
		return status;
	}
	...
	public void setStatus(EnumerationPropertyLiteral newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.CAPELLA_ELEMENT__STATUS, oldStatus, status));
	...
	public EList<EnumerationPropertyLiteral> getFeatures() {
		...
		if (features == null) {
			features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this, CapellacorePackage.CAPELLA_ELEMENT__FEATURES);
		}
		return features;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CapellacorePackage.CAPELLA_ELEMENT__INCOMING_TRACES:
				return getIncomingTraces();
			case CapellacorePackage.CAPELLA_ELEMENT__OUTGOING_TRACES:
				return getOutgoingTraces();
			case CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_DOC:
				return isVisibleInDoc();
			case CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_LM:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (derivedFeatureID) {
				case CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_DOC: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC;
				case CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_LM: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (baseFeatureID) {
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC: return CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_DOC;
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM: return CapellacorePackage.CAPELLA_ELEMENT__VISIBLE_IN_LM;
				default: return -1;
			}
		}
