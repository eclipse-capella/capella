...
public class SharedmodelPackageImpl extends EPackageImpl implements SharedmodelPackage {
   ...
   *
   * <p>
   * This method is used to initialize {@link SharedmodelPackage#eINSTANCE} when that field is accessed. Clients should
  ...
  public static SharedmodelPackage init() {
    if (isInited)
      return (SharedmodelPackage) EPackage.Registry.INSTANCE.getEPackage(SharedmodelPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredSharedmodelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    SharedmodelPackageImpl theSharedmodelPackage = registeredSharedmodelPackage instanceof SharedmodelPackageImpl
        ? (SharedmodelPackageImpl) registeredSharedmodelPackage
        : new SharedmodelPackageImpl();
  ...
  public void initializePackageContents() {
    ...
    CapellamodellerPackage theCapellamodellerPackage = (CapellamodellerPackage) EPackage.Registry.INSTANCE
        .getEPackage(CapellamodellerPackage.eNS_URI);
    ...
    initEReference(getSharedPkg_OwnedDataPkg(), theInformationPackage.getDataPkg(), null, "ownedDataPkg", null, 0, 1, //$NON-NLS-1$
        SharedPkg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSharedPkg_OwnedGenericPkg(), this.getGenericPkg(), null, "ownedGenericPkg", null, 0, 1, //$NON-NLS-1$
        SharedPkg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(genericPkgEClass, GenericPkg.class, "GenericPkg", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getGenericPkg_SubGenericPkgs(), this.getGenericPkg(), null, "subGenericPkgs", null, 0, -1, //$NON-NLS-1$
        GenericPkg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGenericPkg_CapellaElements(), theCapellacorePackage.getCapellaElement(), null, "capellaElements", //$NON-NLS-1$
        null, 0, -1, GenericPkg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
  ...
  protected void createDocumentationAnnotations() {
    ...
    addAnnotation(sharedPkgEClass, source, new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(getSharedPkg_OwnedDataPkg(), source,
        new String[] { "description", "the data packages contained in this shared package\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getSharedPkg_OwnedGenericPkg(), source,
        new String[] { "description", //$NON-NLS-1$
            "the generic packages contained in this shared package\r\n[source: Capella study]", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(genericPkgEClass, source,
        new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(getGenericPkg_SubGenericPkgs(), source,
        new String[] { "description", "sub-packages contained in this package\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getGenericPkg_CapellaElements(), source,
        new String[] { "description", //$NON-NLS-1$
            "the Capella model elements stored directly under this package\r\n[source: Capella study]", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
  }
  ...
  protected void createSemanticAnnotations() {
    ...
    addAnnotation(sharedPkgEClass, source, new String[] {});
  }
  ...
  protected void createBusinessInformationAnnotations() {
    ...
    addAnnotation(sharedPkgEClass, source, new String[] { "Label", "SharedPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSharedPkg_OwnedDataPkg(), source, new String[] { "Label", "ownedDataPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSharedPkg_OwnedGenericPkg(), source, new String[] { "Label", "genericPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(genericPkgEClass, source, new String[] { "Label", "GenericPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getGenericPkg_SubGenericPkgs(), source, new String[] { "Label", "subGenericPkgs" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getGenericPkg_CapellaElements(), source, new String[] { "Label", "capellaElements" //$NON-NLS-1$ //$NON-NLS-2$
    });
  }
  ...
  protected void createUML2MappingAnnotations() {
    ...
    addAnnotation(sharedPkgEClass, source, new String[] { "metaclass", "Package", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.SharedPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSharedPkg_OwnedDataPkg(), source, new String[] { "featureName", "packagedElement", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Package" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSharedPkg_OwnedGenericPkg(), source, new String[] { "featureName", "packagedElement", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Package" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(genericPkgEClass, source, new String[] { "metaclass", "Package", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.GenericPkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getGenericPkg_SubGenericPkgs(), source, new String[] { "featureName", "packagedElement", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Package" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getGenericPkg_CapellaElements(), source, new String[] { "featureName", "packagedElement", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Package" //$NON-NLS-1$ //$NON-NLS-2$
    });
  }
  ...
  protected void createMappingAnnotations() {
    ...
    addAnnotation(sharedPkgEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "uml::Package", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSharedPkg_OwnedDataPkg(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
    ...
    addAnnotation(getSharedPkg_OwnedGenericPkg(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
        "uml::Package::nestedPackage#uml::Package::packagedElement", //$NON-NLS-1$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", //$NON-NLS-1$
        "uml::Package::nestedPackage elements on which GenericPkg stereotype or any stereotype that inherits from it is applied\r\nMultiplicity must be [0..1]" //$NON-NLS-1$
    });
    addAnnotation(genericPkgEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "uml::Package", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getGenericPkg_SubGenericPkgs(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
        "uml::Package::nestedPackage#uml::Package::packagedElement", //$NON-NLS-1$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", //$NON-NLS-1$
        "uml::Package::nestedPackage elements on which GenericPkg stereotype or any stereotype that inherits from it is applied\r\nOrder must be computed" //$NON-NLS-1$
    });
    addAnnotation(getGenericPkg_CapellaElements(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
        "uml::Package::packagedElement", //$NON-NLS-1$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", //$NON-NLS-1$
        "uml::Package::packagedElement elements on which CapellaElement stereotype or any stereotype that inherits from it is applied\r\nOrder must be computed" //$NON-NLS-1$
    });
  }
  ...
  protected void createSegmentAnnotations() {
    ...
    addAnnotation(getSharedPkg_OwnedDataPkg(), source, new String[] {});
    addAnnotation(getSharedPkg_OwnedGenericPkg(), source, new String[] {});
    addAnnotation(getGenericPkg_SubGenericPkgs(), source, new String[] {});
    addAnnotation(getGenericPkg_CapellaElements(), source, new String[] {});
  }
