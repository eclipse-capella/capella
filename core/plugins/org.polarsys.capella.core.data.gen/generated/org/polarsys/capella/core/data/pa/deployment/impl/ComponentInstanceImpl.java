...
public class ComponentInstanceImpl extends AbstractPhysicalInstanceImpl implements ComponentInstance {
	...
	public EList<AbstractDeploymentLink> getDeploymentLinks() {
		...
		if (deploymentLinks == null) {
			deploymentLinks = new EObjectWithInverseResolvingEList<AbstractDeploymentLink>(AbstractDeploymentLink.class, this, DeploymentPackage.COMPONENT_INSTANCE__DEPLOYMENT_LINKS, CsPackage.ABSTRACT_DEPLOYMENT_LINK__LOCATION);
		}
