...
public class CommunicationPackageImpl extends EPackageImpl implements CommunicationPackage {
  ...
  public void initializePackageContents() {
    ...
    initEClass(communicationItemEClass, CommunicationItem.class, "CommunicationItem", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCommunicationItem_Visibility(), theCapellacorePackage.getVisibilityKind(), "visibility", null, 0, //$NON-NLS-1$
        1, CommunicationItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationItem_OwnedStateMachines(), theCapellacommonPackage.getStateMachine(), null,
        "ownedStateMachines", null, 0, -1, CommunicationItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
        IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationItem_Properties(), theInformationPackage.getProperty(), null, "properties", null, 0, //$NON-NLS-1$
        -1, CommunicationItem.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

    initEClass(exceptionEClass, org.polarsys.capella.core.data.information.communication.Exception.class, "Exception", //$NON-NLS-1$
    ...
    initEClass(messageReferenceEClass, MessageReference.class, "MessageReference", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMessageReference_Message(), this.getMessage(), null, "message", null, 1, 1, //$NON-NLS-1$
        MessageReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(messageReferencePkgEClass, MessageReferencePkg.class, "MessageReferencePkg", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMessageReferencePkg_OwnedMessageReferences(), this.getMessageReference(), null,
        "ownedMessageReferences", null, 0, -1, MessageReferencePkg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
        IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(signalEClass, Signal.class, "Signal", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
    initEReference(getSignal_SignalInstances(), this.getSignalInstance(), null, "signalInstances", null, 0, -1, //$NON-NLS-1$
        Signal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(signalInstanceEClass, SignalInstance.class, "SignalInstance", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);

    initEClass(communicationLinkEClass, CommunicationLink.class, "CommunicationLink", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getCommunicationLink_Kind(), this.getCommunicationLinkKind(), "kind", null, 0, 1, //$NON-NLS-1$
        CommunicationLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCommunicationLink_Protocol(), this.getCommunicationLinkProtocol(), "protocol", null, 0, 1, //$NON-NLS-1$
        CommunicationLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLink_ExchangeItem(), theInformationPackage.getExchangeItem(), null, "exchangeItem", //$NON-NLS-1$
        null, 0, 1, CommunicationLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
        IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(communicationLinkExchangerEClass, CommunicationLinkExchanger.class, "CommunicationLinkExchanger", //$NON-NLS-1$
        IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCommunicationLinkExchanger_OwnedCommunicationLinks(), this.getCommunicationLink(), null,
        "ownedCommunicationLinks", null, 0, -1, CommunicationLinkExchanger.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
        IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Produce(), this.getCommunicationLink(), null, "produce", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Consume(), this.getCommunicationLink(), null, "consume", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Send(), this.getCommunicationLink(), null, "send", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Receive(), this.getCommunicationLink(), null, "receive", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Call(), this.getCommunicationLink(), null, "call", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Execute(), this.getCommunicationLink(), null, "execute", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Write(), this.getCommunicationLink(), null, "write", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Access(), this.getCommunicationLink(), null, "access", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Acquire(), this.getCommunicationLink(), null, "acquire", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getCommunicationLinkExchanger_Transmit(), this.getCommunicationLink(), null, "transmit", null, 0, -1, //$NON-NLS-1$
        CommunicationLinkExchanger.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
  ...
  protected void createDocumentationAnnotations() {
    ...
    addAnnotation(communicationItemEClass, source,
    ...
    addAnnotation(getCommunicationItem_Visibility(), source,
        new String[] { "description", "refer to VisibilityKind description\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "type", "refer to VisibilityKind definition\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationItem_OwnedStateMachines(), source, new String[] { "description", //$NON-NLS-1$
        "state machines associated to this communication item, as a mean to specify communication protocols\r\n[source: Capella study]", //$NON-NLS-1$
        "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationItem_Properties(), source,
        new String[] { "description", "attributes of the communication item\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(exceptionEClass, source, new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(messageEClass, source,
        new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(messageReferenceEClass, source,
        new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(getMessageReference_Message(), source,
        new String[] { "description", "The message being referenced\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(messageReferencePkgEClass, source,
        new String[] { "description", "a container for message references elements\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "usage guideline", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "used in levels", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "usage examples", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source,
        new String[] { "description", //$NON-NLS-1$
            "the list of MessageReference elements contained in this package\r\n[source: Capella study]", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(signalEClass, source, new String[] { "description", //$NON-NLS-1$
    ...
    addAnnotation(getSignal_SignalInstances(), source,
        new String[] { "description", "list of signal instances associated with this Signal\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(signalInstanceEClass, source,
        new String[] { "description", "instance of a Signal element\r\n[source: Capella study]", //$NON-NLS-1$ //$NON-NLS-2$
            "usage guideline", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "used in levels", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "usage examples", "n/a", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    addAnnotation(communicationLinkKindEEnum, source,
        new String[] { "description", //$NON-NLS-1$
            "enumeration listing the various possibilities of communication links\r\n[source: Capella study]", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(0), source,
        new String[] { "description", "used when the CommunicationLink protocol is not yet set", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(1), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a production of ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(2), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a comsumption of ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(3), source,
        new String[] { "description", "used when the CommunicationLink is used to describe a sending of ExchangeItem", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(4), source,
        new String[] { "description", "used when the CommunicationLink is used to describe a reception of ExchangeItem", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(5), source,
        new String[] { "description", "used when the CommunicationLink is used to describe a call of ExchangeItem", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(6), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe an execution of ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(7), source,
        new String[] { "description", "used when the CommunicationLink is used to describe a writing of ExchangeItem", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(8), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe an access to the ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(9), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe an acquisition of ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(10), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a transmission of ExchangeItem", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum, source,
        new String[] { "description", //$NON-NLS-1$
            "enumeration listing the various possibilities for the protocol of the communication link", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(0), source,
        new String[] { "description", "used when the CommunicationLink protocol is not yet set", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(1), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a sending of ExchangeItem using the unicast protocol", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(2), source, new String[] { "description", //$NON-NLS-1$
        "used when the CommunicationLink is used to describe a sending of ExchangeItem using the multicast protocol", //$NON-NLS-1$
        "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(3), source, new String[] { "description", //$NON-NLS-1$
        "used when the CommunicationLink is used to describe a sending of ExchangeItem using the broadcast protocol", //$NON-NLS-1$
        "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(4), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a call of ExchangeItem using the synchronous protocol", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(5), source, new String[] { "description", //$NON-NLS-1$
        "used when the CommunicationLink is used to describe a call of ExchangeItem using the asynchronous protocol", //$NON-NLS-1$
        "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(6), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a access to the ExchangeItem by reading it", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(7), source,
        new String[] { "description", //$NON-NLS-1$
            "used when the CommunicationLink is used to describe a access to the ExchangeItem by accepting it", //$NON-NLS-1$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkEClass, source,
        new String[] { "description", "describes a link of communication using exchange items", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLink_Kind(), source,
        new String[] { "description", "refer to CommunicationLinkKind description", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "type", "refer to CommunicationLinkKind definition", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLink_Protocol(), source,
        new String[] { "description", "refer to CommunicationLinkProtocol description", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "type", "refer to CommunicationLinkProtocol definition", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLink_ExchangeItem(), source,
        new String[] { "description", "describes the exchange item related to the link", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "type", "refer to CommunicationLinkProtocol definition", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkExchangerEClass, source,
        new String[] { "description", "describes an element which can communicate using ExchangeItems", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_OwnedCommunicationLinks(), source,
        new String[] { "description", "list of all communication links owned by the communication exchanger", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Produce(), source,
        new String[] { "description", "(automatically computed) list of all production CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Consume(), source,
        new String[] { "description", "(automatically computed) list of all consumption CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Send(), source,
        new String[] { "description", "(automatically computed) list of all sending CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Receive(), source,
        new String[] { "description", "(automatically computed) list of all receiving CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Call(), source,
        new String[] { "description", "(automatically computed) list of all calling CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Execute(), source,
        new String[] { "description", "(automatically computed) list of all execution CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Write(), source,
        new String[] { "description", "(automatically computed) list of all writing CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Access(), source,
        new String[] { "description", "(automatically computed) list of all accessing CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Acquire(), source,
        new String[] { "description", "(automatically computed) list of all acquiring CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(getCommunicationLinkExchanger_Transmit(), source,
        new String[] { "description", "(automatically computed) list of all transmitting CommunicationLinks", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "comment/notes", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
  }
  ...
  protected void createSemanticAnnotations() {
    ...
    addAnnotation(getCommunicationItem_Visibility(), source, new String[] {});
    addAnnotation(getCommunicationItem_OwnedStateMachines(), source, new String[] {});
    addAnnotation(exceptionEClass, source, new String[] {});
    addAnnotation(messageEClass, source, new String[] {});
    addAnnotation(messageReferenceEClass, source, new String[] {});
    addAnnotation(getMessageReference_Message(), source, new String[] {});
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source, new String[] {});
    addAnnotation(signalEClass, source, new String[] {});
    addAnnotation(getSignal_SignalInstances(), source, new String[] {});
    addAnnotation(signalInstanceEClass, source, new String[] {});
    addAnnotation(communicationLinkKindEEnum, source, new String[] {});
    addAnnotation(communicationLinkProtocolEEnum, source, new String[] {});
    addAnnotation(communicationLinkEClass, source, new String[] {});
    addAnnotation(getCommunicationLink_Kind(), source, new String[] {});
    addAnnotation(getCommunicationLink_Protocol(), source, new String[] {});
    addAnnotation(getCommunicationLink_ExchangeItem(), source, new String[] {});
    addAnnotation(getCommunicationLinkExchanger_OwnedCommunicationLinks(), source, new String[] {});
  }
  ...
  protected void createBusinessInformationAnnotations() {
    ...
    addAnnotation(communicationItemEClass, source, new String[] { "Label", "CommunicationItem" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationItem_Properties(), source, new String[] { "Label", "properties" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(exceptionEClass, source, new String[] { "Label", "Exception" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageEClass, source, new String[] { "Label", "Message" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageReferenceEClass, source, new String[] { "Label", "MessageReference" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getMessageReference_Message(), source, new String[] { "Label", "message" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageReferencePkgEClass, source, new String[] { "Label", "MessageReferencePkg" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source,
        new String[] { "Label", "ownedMessageReferences" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(signalEClass, source, new String[] { "Label", "Signal" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSignal_SignalInstances(), source, new String[] { "Label", "signalInstances" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(signalInstanceEClass, source, new String[] { "Label", "SignalInstance" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_OwnedCommunicationLinks(), source,
        new String[] { "Label", "ownedCommunicationLinks" //$NON-NLS-1$ //$NON-NLS-2$
        });
  }
  ...
  protected void createUML2MappingAnnotations() {
    ...
    addAnnotation(communicationItemEClass, source, new String[] { "metaclass", "Classifier" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationItem_Properties(), source, new String[] { "featureName", "ownedAttribute", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "StructuredClassifier" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(exceptionEClass, source, new String[] { "metaclass", "Class", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.Exception" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageEClass, source, new String[] { "metaclass", "Class", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.Message" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageReferenceEClass, source, new String[] { "metaclass", "Dependency", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.MessageReference" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getMessageReference_Message(), source, new String[] { "featureName", "supplier", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Dependency" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageReferencePkgEClass, source, new String[] { "metaclass", "Package" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source,
        new String[] { "featureName", "packagedElement", //$NON-NLS-1$ //$NON-NLS-2$
            "featureOwner", "Package" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(signalEClass, source, new String[] { "metaclass", "Signal", //$NON-NLS-1$ //$NON-NLS-2$
        "stereotype", "eng.Signal" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSignal_SignalInstances(), source, new String[] { "featureName", "ownedAttribute", //$NON-NLS-1$ //$NON-NLS-2$
        "featureOwner", "Signal" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(signalInstanceEClass, source, new String[] { "metaclass", "Property", //$NON-NLS-1$ //$NON-NLS-2$
  ...
  protected void createMappingAnnotations() {
    ...
    addAnnotation(communicationItemEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    addAnnotation(getCommunicationItem_OwnedStateMachines(), source,
        new String[] { "UML/SysML semantic equivalences", "keyword::specific", //$NON-NLS-1$ //$NON-NLS-2$
            ...
            "Elements on which StateMachine stereotype or any stereotype that inherits from it is applied" //$NON-NLS-1$
        });
    addAnnotation(getCommunicationItem_Properties(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
        "keyword::specific", //$NON-NLS-1$
        "explanation", //$NON-NLS-1$
        "no found equivalent since the three children (Exception, Signal, Message) have different hierarchies. The specific rule should  create a package, stored the Properties in this package, and finally create a packageImport under the NamedElement reference for the element", //$NON-NLS-1$
        "constraints", //$NON-NLS-1$
        "elements inside the imported package on which a Property stereotype or any stereotype that inherits from it  is applied" //$NON-NLS-1$
    });
    addAnnotation(exceptionEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "uml::Class", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "uml::Message", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(messageReferenceEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    addAnnotation(messageReferencePkgEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source, new String[] {
        ...
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", //$NON-NLS-1$
        "uml::Package::packagedElement elements on which MessageReference stereotype or any stereotype that inherits from it is applied\r\nOrder must be computed" //$NON-NLS-1$
    });
    addAnnotation(signalEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "uml::Signal", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getSignal_SignalInstances(), source, new String[] { "UML/SysML semantic equivalences", //$NON-NLS-1$
        "uml::Signal::ownedAttribute", //$NON-NLS-1$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", //$NON-NLS-1$
        "uml::Signal::ownedAttribute elements on which SignalInstance stereotype or any stereotype that inherits from it is applied" //$NON-NLS-1$
    });
    addAnnotation(signalInstanceEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "uml::Property", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkKindEEnum, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkKindEEnum.getELiterals().get(0), source,
    ...
    addAnnotation(communicationLinkProtocolEEnum, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(0), source,
    ...
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(2), source,
        new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
            "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(3), source,
        new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
            "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    ...
    addAnnotation(communicationLinkProtocolEEnum.getELiterals().get(5), source,
        new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
            "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
            "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
        });
    ...
    addAnnotation(communicationLinkEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "base metaclass in UML/SysML profile ", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLink_Kind(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLink_Protocol(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLink_ExchangeItem(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(communicationLinkExchangerEClass, source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_OwnedCommunicationLinks(), source,
    ...
    addAnnotation(getCommunicationLinkExchanger_Produce(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Consume(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Send(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Receive(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Call(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Execute(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Write(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Access(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Acquire(), source, new String[] { "UML/SysML semantic equivalences", "", //$NON-NLS-1$ //$NON-NLS-2$
        "explanation", "none", //$NON-NLS-1$ //$NON-NLS-2$
        "constraints", "none" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Transmit(), source,
  ...
  protected void createSegmentAnnotations() {
    ...
    addAnnotation(getCommunicationItem_Properties(), source, new String[] {});
    addAnnotation(getMessageReference_Message(), source, new String[] {});
    addAnnotation(getMessageReferencePkg_OwnedMessageReferences(), source, new String[] {});
    addAnnotation(getSignal_SignalInstances(), source, new String[] {});
  }
  ...
  protected void createDerivedAnnotations() {
    ...
    addAnnotation(getCommunicationItem_Properties(), source, new String[] { "viatra.variant", "alias", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", "ownedFeatures" //$NON-NLS-1$ //$NON-NLS-2$
    });
    addAnnotation(getCommunicationLinkExchanger_Produce(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::PRODUCE);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Consume(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::CONSUME);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Send(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::SEND);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Receive(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::RECEIVE);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Call(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::CALL);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Execute(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::EXECUTE);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Write(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::WRITE);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Access(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::ACCESS);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Acquire(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::ACQUIRE);" //$NON-NLS-1$
    });
    addAnnotation(getCommunicationLinkExchanger_Transmit(), source, new String[] { "viatra.variant", "patternbody", //$NON-NLS-1$ //$NON-NLS-2$
        "viatra.expression", //$NON-NLS-1$
        "CommunicationLinkExchanger.ownedCommunicationLinks(self, target);\r\nCommunicationLink.kind(target, ::TRANSMIT);" //$NON-NLS-1$
    });
  }
