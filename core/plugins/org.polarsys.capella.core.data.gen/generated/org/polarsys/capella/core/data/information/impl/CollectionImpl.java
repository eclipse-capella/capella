...
public class CollectionImpl extends ClassifierImpl implements Collection {
    ...
    EAnnotation annotation = InformationPackage.Literals.COLLECTION__CONTAINED_OPERATIONS.getEAnnotation(org.polarsys.capella.common.tig.model.IModelConstants.HELPER_ANNOTATION_SOURCE);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case InformationPackage.COLLECTION__KIND:
				// begin-extension-code
				if (newValue == null || newValue instanceof CollectionKind) {
				// end-extension-code
			...
			case InformationPackage.COLLECTION__TYPE:
				// begin-extension-code
				if (newValue == null || newValue instanceof Type) {
				// end-extension-code
