 ...
 * <ul>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.NamespaceImpl#getOwnedTraces <em>Owned Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.NamespaceImpl#getContainedGenericTraces <em>Contained Generic Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.NamespaceImpl#getContainedRequirementsTraces <em>Contained Requirements Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.capellacore.impl.NamespaceImpl#getNamingRules <em>Naming Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamespaceImpl extends NamedElementImpl implements Namespace {
	...
	public EList<Trace> getOwnedTraces() {
		...
		if (ownedTraces == null) {
			ownedTraces = new EObjectContainmentEList<Trace>(Trace.class, this, CapellacorePackage.NAMESPACE__OWNED_TRACES);
		}
		return ownedTraces;
	}
	...
	public EList<NamingRule> getNamingRules() {
		...
		if (namingRules == null) {
			namingRules = new EObjectContainmentEList<NamingRule>(NamingRule.class, this, CapellacorePackage.NAMESPACE__NAMING_RULES);
		}
		return namingRules;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CapellacorePackage.NAMESPACE__CONTAINED_REQUIREMENTS_TRACES:
