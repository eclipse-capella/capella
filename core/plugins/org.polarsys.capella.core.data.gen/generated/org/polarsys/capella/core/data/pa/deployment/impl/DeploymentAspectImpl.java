...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Aspect</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getOwnedTraces <em>Owned
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getContainedGenericTraces
 * <em>Contained Generic Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getNamingRules <em>Naming
 * Rules</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getOwnedPropertyValuePkgs <em>Owned
 * Property Value Pkgs</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getOwnedConfigurations <em>Owned
 * Configurations</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.DeploymentAspectImpl#getOwnedDeploymentAspects <em>Owned
 * Deployment Aspects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentAspectImpl extends NamedElementImpl implements DeploymentAspect {
  ...
  /**
   * The cached value of the '{@link #getOwnedConfigurations() <em>Owned Configurations</em>}' containment reference
  ...
  /**
   * The cached value of the '{@link #getOwnedDeploymentAspects() <em>Owned Deployment Aspects</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public EList<Trace> getOwnedTraces() {
    ...
    if (ownedTraces == null) {
      ownedTraces = new EObjectContainmentEList<Trace>(Trace.class, this,
          DeploymentPackage.DEPLOYMENT_ASPECT__OWNED_TRACES);
    }
    return ownedTraces;
  }
  ...
  public EList<NamingRule> getNamingRules() {
    ...
    if (namingRules == null) {
      namingRules = new EObjectContainmentEList<NamingRule>(NamingRule.class, this,
          DeploymentPackage.DEPLOYMENT_ASPECT__NAMING_RULES);
    }
    return namingRules;
  }
  ...
  public EList<PropertyValuePkg> getOwnedPropertyValuePkgs() {
    ...
    if (ownedPropertyValuePkgs == null) {
      ownedPropertyValuePkgs = new EObjectContainmentEList.Resolving<PropertyValuePkg>(PropertyValuePkg.class, this,
          DeploymentPackage.DEPLOYMENT_ASPECT__OWNED_PROPERTY_VALUE_PKGS);
    }
  ...
  public EList<DeploymentConfiguration> getOwnedConfigurations() {
    ...
    if (ownedConfigurations == null) {
      ownedConfigurations = new EObjectContainmentEList.Resolving<DeploymentConfiguration>(
          DeploymentConfiguration.class, this, DeploymentPackage.DEPLOYMENT_ASPECT__OWNED_CONFIGURATIONS);
    }
  ...
  public EList<DeploymentAspect> getOwnedDeploymentAspects() {
    ...
    if (ownedDeploymentAspects == null) {
      ownedDeploymentAspects = new EObjectContainmentEList<DeploymentAspect>(DeploymentAspect.class, this,
          DeploymentPackage.DEPLOYMENT_ASPECT__OWNED_DEPLOYMENT_ASPECTS);
    }
