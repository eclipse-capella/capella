...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Abstract Capability</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedTraces <em>Owned
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getContainedGenericTraces
 * <em>Contained Generic Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getNamingRules <em>Naming
 * Rules</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedPropertyValuePkgs <em>Owned
 * Property Value Pkgs</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getInvolvedInvolvements
 * <em>Involved Involvements</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedFunctionalChains <em>Owned
 * Functional Chains</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getPreCondition <em>Pre
 * Condition</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getPostCondition <em>Post
 * Condition</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedScenarios <em>Owned
 * Scenarios</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getIncomingCapabilityAllocation
 * <em>Incoming Capability Allocation</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOutgoingCapabilityAllocation
 * <em>Outgoing Capability Allocation</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getExtends <em>Extends</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getExtending
 * <em>Extending</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getAbstractCapabilityExtensionPoints
 * <em>Abstract Capability Extension Points</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getSuperGeneralizations <em>Super
 * Generalizations</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getSubGeneralizations <em>Sub
 * Generalizations</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getIncludes <em>Includes</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getIncluding
 * <em>Including</em>}</li>
 ...
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getIncludedAbstractCapabilities
 * <em>Included Abstract Capabilities</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getIncludingAbstractCapabilities
 * <em>Including Abstract Capabilities</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getExtendedAbstractCapabilities
 * <em>Extended Abstract Capabilities</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getExtendingAbstractCapabilities
 * <em>Extending Abstract Capabilities</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedFunctionalChainAbstractCapabilityInvolvements
 * <em>Owned Functional Chain Abstract Capability Involvements</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedAbstractFunctionAbstractCapabilityInvolvements
 * <em>Owned Abstract Function Abstract Capability Involvements</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getAvailableInStates <em>Available
 * In States</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getOwnedAbstractCapabilityRealizations
 * <em>Owned Abstract Capability Realizations</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getInvolvedAbstractFunctions
 * <em>Involved Abstract Functions</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.AbstractCapabilityImpl#getInvolvedFunctionalChains
 * <em>Involved Functional Chains</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCapabilityImpl extends NamedElementImpl implements AbstractCapability {
  ...
  /**
   * The cached value of the '{@link #getOwnedFunctionalChains() <em>Owned Functional Chains</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getPreCondition() <em>Pre Condition</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getPreCondition()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getPostCondition() <em>Post Condition</em>}' reference. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getExtends() <em>Extends</em>}' containment reference list. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getExtends()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getAbstractCapabilityExtensionPoints() <em>Abstract Capability Extension
   * Points</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getSuperGeneralizations() <em>Super Generalizations</em>}' containment reference
  ...
  /**
   * The cached value of the '{@link #getIncludes() <em>Includes</em>}' containment reference list. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getIncludes()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getOwnedFunctionalChainAbstractCapabilityInvolvements() <em>Owned Functional Chain
   * Abstract Capability Involvements</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getOwnedAbstractFunctionAbstractCapabilityInvolvements() <em>Owned Abstract
   * Function Abstract Capability Involvements</em>}' containment reference list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getOwnedAbstractCapabilityRealizations() <em>Owned Abstract Capability
   * Realizations</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public EList<Trace> getOwnedTraces() {
    ...
    if (ownedTraces == null) {
      ownedTraces = new EObjectContainmentEList<Trace>(Trace.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_TRACES);
    }
    return ownedTraces;
  }
  ...
  public EList<NamingRule> getNamingRules() {
    ...
    if (namingRules == null) {
      namingRules = new EObjectContainmentEList<NamingRule>(NamingRule.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__NAMING_RULES);
    }
    return namingRules;
  }
  ...
  public EList<PropertyValuePkg> getOwnedPropertyValuePkgs() {
    ...
    if (ownedPropertyValuePkgs == null) {
      ownedPropertyValuePkgs = new EObjectContainmentEList.Resolving<PropertyValuePkg>(PropertyValuePkg.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_PROPERTY_VALUE_PKGS);
    }
  ...
  public EList<Involvement> getInvolvedInvolvements() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = CapellacorePackage.Literals.INVOLVER_ELEMENT__INVOLVED_INVOLVEMENTS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<Involvement>(this,
          CapellacorePackage.Literals.INVOLVER_ELEMENT__INVOLVED_INVOLVEMENTS, resultAsList.size(),
  ...
  public EList<FunctionalChain> getOwnedFunctionalChains() {
    ...
    if (ownedFunctionalChains == null) {
      ownedFunctionalChains = new EObjectContainmentEList<FunctionalChain>(FunctionalChain.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAINS);
    }
      ...
      if (preCondition != oldPreCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              InteractionPackage.ABSTRACT_CAPABILITY__PRE_CONDITION, oldPreCondition, preCondition));
      }
    }
    return preCondition;
  }
  ...
  public void setPreCondition(Constraint newPreCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.ABSTRACT_CAPABILITY__PRE_CONDITION,
  ...
  public Constraint getPostCondition() {
    ...
    if (postCondition != null && postCondition.eIsProxy()) {
      ...
      if (postCondition != oldPostCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              InteractionPackage.ABSTRACT_CAPABILITY__POST_CONDITION, oldPostCondition, postCondition));
      }
    }
  ...
  public void setPostCondition(Constraint newPostCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.ABSTRACT_CAPABILITY__POST_CONDITION,
  ...
  public EList<Scenario> getOwnedScenarios() {
    ...
    if (ownedScenarios == null) {
      ownedScenarios = new EObjectContainmentEList<Scenario>(Scenario.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_SCENARIOS);
    }
  ...
  public EList<AbstractCapabilityRealization> getIncomingCapabilityAllocation() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCOMING_CAPABILITY_ALLOCATION
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCOMING_CAPABILITY_ALLOCATION,
        annotation);

    try {
      @SuppressWarnings("unchecked")
      Collection<AbstractCapabilityRealization> resultAsList = (Collection<AbstractCapabilityRealization>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapabilityRealization>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCOMING_CAPABILITY_ALLOCATION, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapabilityRealization> getOutgoingCapabilityAllocation() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__OUTGOING_CAPABILITY_ALLOCATION
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__OUTGOING_CAPABILITY_ALLOCATION,
        annotation);
    ...
    try {
      ...
      Collection<AbstractCapabilityRealization> resultAsList = (Collection<AbstractCapabilityRealization>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapabilityRealization>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__OUTGOING_CAPABILITY_ALLOCATION, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapabilityExtend> getExtends() {
    ...
    if (extends_ == null) {
      extends_ = new EObjectContainmentEList<AbstractCapabilityExtend>(AbstractCapabilityExtend.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__EXTENDS);
    }
    return extends_;
  }
  ...
  public EList<AbstractCapabilityExtend> getExtending() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDING
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractCapabilityExtend>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDING, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<AbstractCapabilityExtensionPoint> getAbstractCapabilityExtensionPoints() {
    ...
    if (abstractCapabilityExtensionPoints == null) {
      abstractCapabilityExtensionPoints = new EObjectContainmentEList<AbstractCapabilityExtensionPoint>(
          AbstractCapabilityExtensionPoint.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__ABSTRACT_CAPABILITY_EXTENSION_POINTS);
    }
  ...
  public EList<AbstractCapabilityGeneralization> getSuperGeneralizations() {
    ...
    if (superGeneralizations == null) {
      superGeneralizations = new EObjectContainmentEList<AbstractCapabilityGeneralization>(
          AbstractCapabilityGeneralization.class, this, InteractionPackage.ABSTRACT_CAPABILITY__SUPER_GENERALIZATIONS);
    }
  ...
  public EList<AbstractCapabilityGeneralization> getSubGeneralizations() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUB_GENERALIZATIONS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractCapabilityGeneralization>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUB_GENERALIZATIONS, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapabilityInclude> getIncludes() {
    ...
    if (includes == null) {
      includes = new EObjectContainmentEList<AbstractCapabilityInclude>(AbstractCapabilityInclude.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__INCLUDES);
    }
    return includes;
  }
  ...
  public EList<AbstractCapabilityInclude> getIncluding() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDING
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractCapabilityInclude>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDING, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<AbstractCapability> getSuper() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUPER
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUPER, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<AbstractCapability> getSub() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUB
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    try {
      ...
      Collection<AbstractCapability> resultAsList = (Collection<AbstractCapability>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__SUB, resultAsList.size(), resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
    }
  ...
  public EList<AbstractCapability> getIncludedAbstractCapabilities() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDED_ABSTRACT_CAPABILITIES
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDED_ABSTRACT_CAPABILITIES,
        annotation);
    ...
    try {
      ...
      Collection<AbstractCapability> resultAsList = (Collection<AbstractCapability>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDED_ABSTRACT_CAPABILITIES, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapability> getIncludingAbstractCapabilities() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDING_ABSTRACT_CAPABILITIES
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDING_ABSTRACT_CAPABILITIES,
        annotation);
    ...
    try {
      ...
      Collection<AbstractCapability> resultAsList = (Collection<AbstractCapability>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INCLUDING_ABSTRACT_CAPABILITIES, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapability> getExtendedAbstractCapabilities() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDED_ABSTRACT_CAPABILITIES
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDED_ABSTRACT_CAPABILITIES,
        annotation);
    ...
    try {
      ...
      Collection<AbstractCapability> resultAsList = (Collection<AbstractCapability>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDED_ABSTRACT_CAPABILITIES, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<AbstractCapability> getExtendingAbstractCapabilities() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDING_ABSTRACT_CAPABILITIES
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDING_ABSTRACT_CAPABILITIES,
        annotation);
    ...
    try {
      ...
      Collection<AbstractCapability> resultAsList = (Collection<AbstractCapability>) result;
      return new EcoreEList.UnmodifiableEList<AbstractCapability>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__EXTENDING_ABSTRACT_CAPABILITIES, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<FunctionalChainAbstractCapabilityInvolvement> getOwnedFunctionalChainAbstractCapabilityInvolvements() {
    ...
    if (ownedFunctionalChainAbstractCapabilityInvolvements == null) {
      ownedFunctionalChainAbstractCapabilityInvolvements = new EObjectContainmentEList.Resolving<FunctionalChainAbstractCapabilityInvolvement>(
          FunctionalChainAbstractCapabilityInvolvement.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENTS);
    }
  ...
  public EList<AbstractFunctionAbstractCapabilityInvolvement> getOwnedAbstractFunctionAbstractCapabilityInvolvements() {
    ...
    if (ownedAbstractFunctionAbstractCapabilityInvolvements == null) {
      ownedAbstractFunctionAbstractCapabilityInvolvements = new EObjectContainmentEList.Resolving<AbstractFunctionAbstractCapabilityInvolvement>(
          AbstractFunctionAbstractCapabilityInvolvement.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_ABSTRACT_FUNCTION_ABSTRACT_CAPABILITY_INVOLVEMENTS);
    }
  ...
  public EList<State> getAvailableInStates() {
    ...
    if (availableInStates == null) {
      availableInStates = new EObjectResolvingEList<State>(State.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__AVAILABLE_IN_STATES);
    }
  ...
  public EList<AbstractCapabilityRealization> getOwnedAbstractCapabilityRealizations() {
    ...
    if (ownedAbstractCapabilityRealizations == null) {
      ownedAbstractCapabilityRealizations = new EObjectContainmentEList.Resolving<AbstractCapabilityRealization>(
          AbstractCapabilityRealization.class, this,
          InteractionPackage.ABSTRACT_CAPABILITY__OWNED_ABSTRACT_CAPABILITY_REALIZATIONS);
    }
  ...
  public EList<AbstractFunction> getInvolvedAbstractFunctions() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_ABSTRACT_FUNCTIONS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_ABSTRACT_FUNCTIONS,
        annotation);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<AbstractFunction>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_ABSTRACT_FUNCTIONS, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public EList<FunctionalChain> getInvolvedFunctionalChains() {
    ...
    // A helper is found, let's use it.
    EAnnotation annotation = InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS
        .getEAnnotation(org.polarsys.capella.common.model.helpers.IModelConstants.HELPER_ANNOTATION_SOURCE);
    result = helper.getValue(this, InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS,
        annotation);
    ...
    try {
      ...
      return new EcoreEList.UnmodifiableEList<FunctionalChain>(this,
          InteractionPackage.Literals.ABSTRACT_CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS, resultAsList.size(),
          resultAsList.toArray());
    } catch (ClassCastException exception) {
      exception.printStackTrace();
      return org.eclipse.emf.common.util.ECollections.emptyEList();
  ...
  public void eSet(int featureID, Object newValue) {
    ...
    case InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENTS:
      ...
      getOwnedFunctionalChainAbstractCapabilityInvolvements()
          .addAll((Collection<? extends FunctionalChainAbstractCapabilityInvolvement>) newValue);
      return;
    case InteractionPackage.ABSTRACT_CAPABILITY__OWNED_ABSTRACT_FUNCTION_ABSTRACT_CAPABILITY_INVOLVEMENTS:
      getOwnedAbstractFunctionAbstractCapabilityInvolvements().clear();
      getOwnedAbstractFunctionAbstractCapabilityInvolvements()
          .addAll((Collection<? extends AbstractFunctionAbstractCapabilityInvolvement>) newValue);
      return;
    case InteractionPackage.ABSTRACT_CAPABILITY__AVAILABLE_IN_STATES:
  ...
  public boolean eIsSet(int featureID) {
    ...
    case InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENTS:
      return ownedFunctionalChainAbstractCapabilityInvolvements != null
          && !ownedFunctionalChainAbstractCapabilityInvolvements.isEmpty();
    case InteractionPackage.ABSTRACT_CAPABILITY__OWNED_ABSTRACT_FUNCTION_ABSTRACT_CAPABILITY_INVOLVEMENTS:
      return ownedAbstractFunctionAbstractCapabilityInvolvements != null
          && !ownedAbstractFunctionAbstractCapabilityInvolvements.isEmpty();
    case InteractionPackage.ABSTRACT_CAPABILITY__AVAILABLE_IN_STATES:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == InvolverElement.class) {
      ...
      case InteractionPackage.ABSTRACT_CAPABILITY__INVOLVED_INVOLVEMENTS:
        return CapellacorePackage.INVOLVER_ELEMENT__INVOLVED_INVOLVEMENTS;
      default:
        return -1;
      }
    }
    if (baseClass == AbstractFunctionalChainContainer.class) {
      switch (derivedFeatureID) {
      case InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAINS:
        return FaPackage.ABSTRACT_FUNCTIONAL_CHAIN_CONTAINER__OWNED_FUNCTIONAL_CHAINS;
      default:
        return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == InvolverElement.class) {
      ...
      case CapellacorePackage.INVOLVER_ELEMENT__INVOLVED_INVOLVEMENTS:
        return InteractionPackage.ABSTRACT_CAPABILITY__INVOLVED_INVOLVEMENTS;
      default:
        return -1;
      }
    }
    if (baseClass == AbstractFunctionalChainContainer.class) {
      ...
      case FaPackage.ABSTRACT_FUNCTIONAL_CHAIN_CONTAINER__OWNED_FUNCTIONAL_CHAINS:
        return InteractionPackage.ABSTRACT_CAPABILITY__OWNED_FUNCTIONAL_CHAINS;
      default:
        return -1;
      }
    }
