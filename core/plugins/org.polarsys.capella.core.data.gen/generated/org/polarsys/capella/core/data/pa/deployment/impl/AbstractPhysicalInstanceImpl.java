...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Abstract Physical Instance</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getIncomingTraces
 * <em>Incoming Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOutgoingTraces
 * <em>Outgoing Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#isVisibleInDoc <em>Visible
 * In Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#isVisibleInLM <em>Visible
 * In LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getSummary
 * <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getReview
 * <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedPropertyValues
 * <em>Owned Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getAppliedPropertyValueGroups
 * <em>Applied Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.pa.deployment.impl.AbstractPhysicalInstanceImpl#getFeatures
 * <em>Features</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class AbstractPhysicalInstanceImpl extends ModelElementImpl implements AbstractPhysicalInstance {
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__VISIBLE_IN_LM,
  ...
  public void setSummary(String newSummary) {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__SUMMARY,
          oldSummary, summary));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__DESCRIPTION,
  ...
  public void setReview(String newReview) {
    ...
    review = newReview;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__REVIEW,
          oldReview, review));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          ...
          DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__APPLIED_PROPERTY_VALUE_GROUPS);
    }
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__STATUS, oldStatus, status));
      }
    }
    return status;
  }
  ...
  public void setStatus(EnumerationPropertyLiteral newStatus) {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__STATUS,
          oldStatus, status));
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__FEATURES);
    }
    return features;
  }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return DeploymentPackage.ABSTRACT_PHYSICAL_INSTANCE__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
