...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Value Part</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getIncomingTraces <em>Incoming
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getOutgoingTraces <em>Outgoing
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#isVisibleInDoc <em>Visible In
 * Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#isVisibleInLM <em>Visible In
 * LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getSummary <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getReview <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getOwnedPropertyValues <em>Owned
 * Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getAppliedPropertyValueGroups
 ...
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getFeatures
 * <em>Features</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getReferencedProperty
 * <em>Referenced Property</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.ValuePartImpl#getOwnedValue <em>Owned
 * Value</em>}</li>
 * </ul>
 *
 * @generated
...
public class ValuePartImpl extends ModelElementImpl implements ValuePart {
  ...
  /**
   * The cached value of the '{@link #getOwnedValue() <em>Owned Value</em>}' containment reference. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getOwnedValue()
   * @generated
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.VALUE_PART__VISIBLE_IN_DOC,
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.VALUE_PART__VISIBLE_IN_LM, oldVisibleInLM,
          visibleInLM));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.VALUE_PART__DESCRIPTION, oldDescription,
          description));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, DatavaluePackage.VALUE_PART__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          EnumerationPropertyType.class, this, DatavaluePackage.VALUE_PART__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          DatavaluePackage.VALUE_PART__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, DatavaluePackage.VALUE_PART__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          DatavaluePackage.VALUE_PART__APPLIED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EnumerationPropertyLiteral getStatus() {
    ...
    if (status != null && status.eIsProxy()) {
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatavaluePackage.VALUE_PART__STATUS, oldStatus,
              status));
      }
    }
    return status;
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          DatavaluePackage.VALUE_PART__FEATURES);
    }
    return features;
  }
  ...
  public Property getReferencedProperty() {
    ...
    if (referencedProperty != null && referencedProperty.eIsProxy()) {
      ...
      if (referencedProperty != oldReferencedProperty) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatavaluePackage.VALUE_PART__REFERENCED_PROPERTY,
              oldReferencedProperty, referencedProperty));
      }
    }
  ...
  public void setReferencedProperty(Property newReferencedProperty) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.VALUE_PART__REFERENCED_PROPERTY,
          oldReferencedProperty, referencedProperty));
  ...
  public DataValue getOwnedValue() {
    ...
    if (ownedValue != null && ownedValue.eIsProxy()) {
      ...
      if (ownedValue != oldOwnedValue) {
        ...
        NotificationChain msgs = oldOwnedValue.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - DatavaluePackage.VALUE_PART__OWNED_VALUE, null, null);
        if (newOwnedValue.eInternalContainer() == null) {
          msgs = newOwnedValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DatavaluePackage.VALUE_PART__OWNED_VALUE,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatavaluePackage.VALUE_PART__OWNED_VALUE,
              oldOwnedValue, ownedValue));
      }
    }
    return ownedValue;
  }
  ...
  public NotificationChain basicSetOwnedValue(DataValue newOwnedValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          DatavaluePackage.VALUE_PART__OWNED_VALUE, oldOwnedValue, newOwnedValue);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newOwnedValue != ownedValue) {
      ...
      if (ownedValue != null)
        msgs = ((InternalEObject) ownedValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - DatavaluePackage.VALUE_PART__OWNED_VALUE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.VALUE_PART__OWNED_VALUE, newOwnedValue,
          newOwnedValue));
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return DatavaluePackage.VALUE_PART__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return DatavaluePackage.VALUE_PART__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
