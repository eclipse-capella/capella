...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Multiplicity Element</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getIncomingTraces <em>Incoming
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOutgoingTraces <em>Outgoing
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#isVisibleInDoc <em>Visible In
 * Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#isVisibleInLM <em>Visible In
 * LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getSummary <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getReview <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedPropertyValues <em>Owned
 * Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getAppliedPropertyValueGroups
 * <em>Applied Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getStatus <em>Status</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getFeatures
 * <em>Features</em>}</li>
 ...
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#isMinInclusive <em>Min
 * Inclusive</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#isMaxInclusive <em>Max
 * Inclusive</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedDefaultValue <em>Owned
 * Default Value</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMinValue <em>Owned Min
 * Value</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMaxValue <em>Owned Max
 * Value</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedNullValue <em>Owned Null
 * Value</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMinCard <em>Owned Min
 * Card</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMinLength <em>Owned Min
 * Length</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMaxCard <em>Owned Max
 * Card</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.impl.MultiplicityElementImpl#getOwnedMaxLength <em>Owned Max
 * Length</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class MultiplicityElementImpl extends ModelElementImpl implements MultiplicityElement {
  ...
  /**
   * The cached value of the '{@link #isOrdered() <em>Ordered</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isOrdered()
   * @generated
  ...
  /**
   * The default value of the '{@link #isMinInclusive() <em>Min Inclusive</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isMinInclusive()
   * @generated
  ...
  /**
   * The cached value of the '{@link #isMinInclusive() <em>Min Inclusive</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isMinInclusive()
   * @generated
  ...
  /**
   * The default value of the '{@link #isMaxInclusive() <em>Max Inclusive</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isMaxInclusive()
   * @generated
  ...
  /**
   * The cached value of the '{@link #isMaxInclusive() <em>Max Inclusive</em>}' attribute. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #isMaxInclusive()
   * @generated
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__VISIBLE_IN_DOC,
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__VISIBLE_IN_LM,
  ...
  public void setSummary(String newSummary) {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__SUMMARY,
          oldSummary, summary));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__DESCRIPTION,
  ...
  public void setReview(String newReview) {
    ...
    review = newReview;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__REVIEW, oldReview,
          review));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          ...
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          InformationPackage.MULTIPLICITY_ELEMENT__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          InformationPackage.MULTIPLICITY_ELEMENT__APPLIED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EnumerationPropertyLiteral getStatus() {
    ...
    if (status != null && status.eIsProxy()) {
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, InformationPackage.MULTIPLICITY_ELEMENT__STATUS,
              oldStatus, status));
      }
    }
    return status;
  ...
  public void setStatus(EnumerationPropertyLiteral newStatus) {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__STATUS, oldStatus,
          status));
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          InformationPackage.MULTIPLICITY_ELEMENT__FEATURES);
    }
    return features;
  }
  ...
  public void setOrdered(boolean newOrdered) {
    ...
    ordered = newOrdered;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__ORDERED,
          oldOrdered, ordered));
  ...
  public void setUnique(boolean newUnique) {
    ...
    unique = newUnique;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__UNIQUE, oldUnique,
          unique));
  ...
  public void setMinInclusive(boolean newMinInclusive) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__MIN_INCLUSIVE,
  ...
  public void setMaxInclusive(boolean newMaxInclusive) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__MAX_INCLUSIVE,
  ...
  public NotificationChain basicSetOwnedDefaultValue(DataValue newOwnedDefaultValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_DEFAULT_VALUE, oldOwnedDefaultValue, newOwnedDefaultValue);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newOwnedDefaultValue != ownedDefaultValue) {
      ...
      if (ownedDefaultValue != null)
        msgs = ((InternalEObject) ownedDefaultValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_DEFAULT_VALUE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_DEFAULT_VALUE, newOwnedDefaultValue, newOwnedDefaultValue));
  ...
  public NotificationChain basicSetOwnedMinValue(DataValue newOwnedMinValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_VALUE, oldOwnedMinValue, newOwnedMinValue);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMinValue != ownedMinValue) {
      ...
      if (ownedMinValue != null)
        msgs = ((InternalEObject) ownedMinValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_VALUE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_VALUE,
  ...
  public NotificationChain basicSetOwnedMaxValue(DataValue newOwnedMaxValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_VALUE, oldOwnedMaxValue, newOwnedMaxValue);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMaxValue != ownedMaxValue) {
      ...
      if (ownedMaxValue != null)
        msgs = ((InternalEObject) ownedMaxValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_VALUE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_VALUE,
  ...
  public NotificationChain basicSetOwnedNullValue(DataValue newOwnedNullValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_NULL_VALUE, oldOwnedNullValue, newOwnedNullValue);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedNullValue != ownedNullValue) {
      ...
      if (ownedNullValue != null)
        msgs = ((InternalEObject) ownedNullValue).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_NULL_VALUE, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_NULL_VALUE,
  ...
  public NotificationChain basicSetOwnedMinCard(NumericValue newOwnedMinCard, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_CARD, oldOwnedMinCard, newOwnedMinCard);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMinCard != ownedMinCard) {
      ...
      if (ownedMinCard != null)
        msgs = ((InternalEObject) ownedMinCard).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_CARD, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_CARD,
  ...
  public NotificationChain basicSetOwnedMinLength(NumericValue newOwnedMinLength, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_LENGTH, oldOwnedMinLength, newOwnedMinLength);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMinLength != ownedMinLength) {
      ...
      if (ownedMinLength != null)
        msgs = ((InternalEObject) ownedMinLength).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_LENGTH, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MIN_LENGTH,
  ...
  public NotificationChain basicSetOwnedMaxCard(NumericValue newOwnedMaxCard, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_CARD, oldOwnedMaxCard, newOwnedMaxCard);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMaxCard != ownedMaxCard) {
      ...
      if (ownedMaxCard != null)
        msgs = ((InternalEObject) ownedMaxCard).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_CARD, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_CARD,
  ...
  public NotificationChain basicSetOwnedMaxLength(NumericValue newOwnedMaxLength, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_LENGTH, oldOwnedMaxLength, newOwnedMaxLength);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newOwnedMaxLength != ownedMaxLength) {
      ...
      if (ownedMaxLength != null)
        msgs = ((InternalEObject) ownedMaxLength).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_LENGTH, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, InformationPackage.MULTIPLICITY_ELEMENT__OWNED_MAX_LENGTH,
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return InformationPackage.MULTIPLICITY_ELEMENT__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return InformationPackage.MULTIPLICITY_ELEMENT__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
