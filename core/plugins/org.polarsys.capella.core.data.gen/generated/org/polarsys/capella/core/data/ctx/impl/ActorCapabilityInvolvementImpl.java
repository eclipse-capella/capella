...
public class ActorCapabilityInvolvementImpl extends RelationshipImpl implements ActorCapabilityInvolvement {
    ...
    EAnnotation annotation = CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__ACTOR.getEAnnotation(org.polarsys.capella.common.tig.model.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    // A helper is found, let's use it. 
    EAnnotation annotation = CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__CAPABILITY.getEAnnotation(org.polarsys.capella.common.tig.model.IModelConstants.HELPER_ANNOTATION_SOURCE);
