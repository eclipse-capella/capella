...
public class SystemMissionInvolvementImpl extends RelationshipImpl implements SystemMissionInvolvement {
    ...
    EAnnotation annotation = CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__MISSION.getEAnnotation(org.polarsys.capella.common.tig.model.IModelConstants.HELPER_ANNOTATION_SOURCE);
    ...
    // A helper is found, let's use it. 
    EAnnotation annotation = CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__SYSTEM.getEAnnotation(org.polarsys.capella.common.tig.model.IModelConstants.HELPER_ANNOTATION_SOURCE);
