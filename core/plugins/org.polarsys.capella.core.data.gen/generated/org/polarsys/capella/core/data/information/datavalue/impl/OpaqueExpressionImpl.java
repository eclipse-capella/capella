...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Opaque Expression</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getIncomingTraces
 * <em>Incoming Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getOutgoingTraces
 * <em>Outgoing Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#isVisibleInDoc <em>Visible
 * In Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#isVisibleInLM <em>Visible
 * In LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getSummary
 * <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getReview
 * <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getOwnedPropertyValues
 * <em>Owned Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getAppliedPropertyValueGroups
 * <em>Applied Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getFeatures
 * <em>Features</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getName <em>Name</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getAbstractType
 * <em>Abstract Type</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getBodies
 * <em>Bodies</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.datavalue.impl.OpaqueExpressionImpl#getLanguages
 * <em>Languages</em>}</li>
 * </ul>
 *
 * @generated
...
public class OpaqueExpressionImpl extends ModelElementImpl implements OpaqueExpression {
  ...
  /**
   * The cached value of the '{@link #getAbstractType() <em>Abstract Type</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getAbstractType()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getBodies() <em>Bodies</em>}' attribute list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getBodies()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getLanguages() <em>Languages</em>}' attribute list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getLanguages()
   * @generated
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__VISIBLE_IN_DOC,
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__VISIBLE_IN_LM,
  ...
  public void setSummary(String newSummary) {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__SUMMARY, oldSummary,
          summary));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__DESCRIPTION,
  ...
  public void setReview(String newReview) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__REVIEW, oldReview, review));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, DatavaluePackage.OPAQUE_EXPRESSION__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          EnumerationPropertyType.class, this, DatavaluePackage.OPAQUE_EXPRESSION__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          DatavaluePackage.OPAQUE_EXPRESSION__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, DatavaluePackage.OPAQUE_EXPRESSION__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          DatavaluePackage.OPAQUE_EXPRESSION__APPLIED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EnumerationPropertyLiteral getStatus() {
    ...
    if (status != null && status.eIsProxy()) {
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatavaluePackage.OPAQUE_EXPRESSION__STATUS,
              oldStatus, status));
      }
    }
    return status;
  ...
  public void setStatus(EnumerationPropertyLiteral newStatus) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__STATUS, oldStatus, status));
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          DatavaluePackage.OPAQUE_EXPRESSION__FEATURES);
    }
    return features;
  }
  ...
  public AbstractType getAbstractType() {
    ...
    if (abstractType != null && abstractType.eIsProxy()) {
      ...
      if (abstractType != oldAbstractType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatavaluePackage.OPAQUE_EXPRESSION__ABSTRACT_TYPE,
  ...
  public void setAbstractType(AbstractType newAbstractType) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatavaluePackage.OPAQUE_EXPRESSION__ABSTRACT_TYPE,
          oldAbstractType, abstractType));
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return DatavaluePackage.OPAQUE_EXPRESSION__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return DatavaluePackage.OPAQUE_EXPRESSION__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
    if (baseClass == AbstractNamedElement.class) {
      ...
      case ModellingcorePackage.ABSTRACT_NAMED_ELEMENT__NAME:
        return DatavaluePackage.OPAQUE_EXPRESSION__NAME;
      default:
        return -1;
      }
    }
    if (baseClass == AbstractTypedElement.class) {
      ...
      case ModellingcorePackage.ABSTRACT_TYPED_ELEMENT__ABSTRACT_TYPE:
        return DatavaluePackage.OPAQUE_EXPRESSION__ABSTRACT_TYPE;
      default:
        return -1;
      }
    }
