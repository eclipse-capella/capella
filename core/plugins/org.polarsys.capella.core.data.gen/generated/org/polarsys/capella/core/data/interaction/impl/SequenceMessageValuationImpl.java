...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sequence Message Valuation</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getIncomingTraces
 * <em>Incoming Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getOutgoingTraces
 * <em>Outgoing Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#isVisibleInDoc <em>Visible In
 * Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#isVisibleInLM <em>Visible In
 * LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getSummary
 * <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getReview
 * <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getOwnedPropertyValues
 * <em>Owned Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getAppliedPropertyValueGroups
 * <em>Applied Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getFeatures
 * <em>Features</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.interaction.impl.SequenceMessageValuationImpl#getExchangeItemElement
 * <em>Exchange Item Element</em>}</li>
...
public class SequenceMessageValuationImpl extends ModelElementImpl implements SequenceMessageValuation {
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VISIBLE_IN_LM, oldVisibleInLM, visibleInLM));
  ...
  public void setSummary(String newSummary) {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__SUMMARY,
          oldSummary, summary));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__DESCRIPTION,
  ...
  public void setReview(String newReview) {
    ...
    review = newReview;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__REVIEW,
          oldReview, review));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          ...
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__APPLIED_PROPERTY_VALUE_GROUPS);
    }
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              InteractionPackage.SEQUENCE_MESSAGE_VALUATION__STATUS, oldStatus, status));
      }
    }
    return status;
  }
  ...
  public void setStatus(EnumerationPropertyLiteral newStatus) {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__STATUS,
          oldStatus, status));
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          InteractionPackage.SEQUENCE_MESSAGE_VALUATION__FEATURES);
    }
    return features;
  }
  ...
  public ExchangeItemElement getExchangeItemElement() {
    ...
    if (exchangeItemElement != null && exchangeItemElement.eIsProxy()) {
      ...
      if (exchangeItemElement != oldExchangeItemElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              InteractionPackage.SEQUENCE_MESSAGE_VALUATION__EXCHANGE_ITEM_ELEMENT, oldExchangeItemElement,
              exchangeItemElement));
      }
    }
  ...
  public ValueSpecification getValue() {
    ...
    if (value != null && value.eIsProxy()) {
      ...
      if (value != oldValue) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VALUE, oldValue, value));
      }
    }
    return value;
  }
  ...
  public void setValue(ValueSpecification newValue) {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VALUE,
          oldValue, value));
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return InteractionPackage.SEQUENCE_MESSAGE_VALUATION__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
