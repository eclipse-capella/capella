...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Shared Pkg</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getOwnedTraces <em>Owned Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getContainedGenericTraces <em>Contained
 ...
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getOwnedPropertyValuePkgs <em>Owned Property
 * Value Pkgs</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getReuseLinks <em>Reuse Links</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getOwnedDataPkg <em>Owned Data
 * Pkg</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.sharedmodel.impl.SharedPkgImpl#getOwnedGenericPkg <em>Owned Generic
 * Pkg</em>}</li>
 * </ul>
 *
 * @generated
...
public class SharedPkgImpl extends NamedElementImpl implements SharedPkg {
  ...
  /**
   * The cached value of the '{@link #getReuseLinks() <em>Reuse Links</em>}' reference list. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getReuseLinks()
   * @generated
  ...
  public EList<NamingRule> getNamingRules() {
    ...
    if (namingRules == null) {
      namingRules = new EObjectContainmentEList<NamingRule>(NamingRule.class, this,
          SharedmodelPackage.SHARED_PKG__NAMING_RULES);
    }
    return namingRules;
  }
  ...
  public EList<PropertyValuePkg> getOwnedPropertyValuePkgs() {
    ...
    if (ownedPropertyValuePkgs == null) {
      ownedPropertyValuePkgs = new EObjectContainmentEList.Resolving<PropertyValuePkg>(PropertyValuePkg.class, this,
          SharedmodelPackage.SHARED_PKG__OWNED_PROPERTY_VALUE_PKGS);
    }
  ...
  public EList<ReuseLink> getReuseLinks() {
    ...
    if (reuseLinks == null) {
      reuseLinks = new EObjectResolvingEList<ReuseLink>(ReuseLink.class, this,
          SharedmodelPackage.SHARED_PKG__REUSE_LINKS);
    }
    return reuseLinks;
  }
  ...
  public NotificationChain basicSetOwnedDataPkg(DataPkg newOwnedDataPkg, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SharedmodelPackage.SHARED_PKG__OWNED_DATA_PKG, oldOwnedDataPkg, newOwnedDataPkg);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newOwnedDataPkg != ownedDataPkg) {
      ...
      if (ownedDataPkg != null)
        msgs = ((InternalEObject) ownedDataPkg).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SharedmodelPackage.SHARED_PKG__OWNED_DATA_PKG, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, SharedmodelPackage.SHARED_PKG__OWNED_DATA_PKG,
  ...
  public NotificationChain basicSetOwnedGenericPkg(GenericPkg newOwnedGenericPkg, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG, oldOwnedGenericPkg, newOwnedGenericPkg);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setOwnedGenericPkg(GenericPkg newOwnedGenericPkg) {
    ...
    if (newOwnedGenericPkg != ownedGenericPkg) {
      ...
      if (ownedGenericPkg != null)
        msgs = ((InternalEObject) ownedGenericPkg).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG, null, msgs);
      if (newOwnedGenericPkg != null)
        msgs = ((InternalEObject) newOwnedGenericPkg).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG, null, msgs);
      msgs = basicSetOwnedGenericPkg(newOwnedGenericPkg, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG,
          newOwnedGenericPkg, newOwnedGenericPkg));
