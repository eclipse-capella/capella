...
public class InformationFactoryImpl extends EFactoryImpl implements InformationFactory {
	...
	public static InformationFactory init() {
		try {
			InformationFactory theInformationFactory = (InformationFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.polarsys.org/capella/core/information/1.0.0"); //$NON-NLS-1$ 
