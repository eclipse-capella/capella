 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getIncomingTraces
 * <em>Incoming Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getOutgoingTraces
 * <em>Outgoing Traces</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#isVisibleInDoc
 * <em>Visible In Doc</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#isVisibleInLM
 * <em>Visible In LM</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getSummary
 * <em>Summary</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getReview
 * <em>Review</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getOwnedPropertyValues
 * <em>Owned Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getOwnedEnumerationPropertyTypes
 * <em>Owned Enumeration Property Types</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getAppliedPropertyValues
 * <em>Applied Property Values</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getOwnedPropertyValueGroups
 * <em>Owned Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getAppliedPropertyValueGroups
 * <em>Applied Property Value Groups</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getFeatures
 * <em>Features</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getKind
 * <em>Kind</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getProtocol
 * <em>Protocol</em>}</li>
 * <li>{@link org.polarsys.capella.core.data.information.communication.impl.CommunicationLinkImpl#getExchangeItem
 * <em>Exchange Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationLinkImpl extends ModelElementImpl implements CommunicationLink {
  ...
  /**
   * The cached value of the '{@link #getExchangeItem() <em>Exchange Item</em>}' reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @see #getExchangeItem()
   * @generated
  ...
  public void setVisibleInDoc(boolean newVisibleInDoc) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__VISIBLE_IN_DOC,
  ...
  public void setVisibleInLM(boolean newVisibleInLM) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__VISIBLE_IN_LM,
  ...
  public void setSummary(String newSummary) {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__SUMMARY,
          oldSummary, summary));
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__DESCRIPTION,
  ...
  public void setReview(String newReview) {
    ...
    review = newReview;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__REVIEW, oldReview,
          review));
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues() {
    ...
    if (ownedPropertyValues == null) {
      ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class,
          this, CommunicationPackage.COMMUNICATION_LINK__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
    ...
    if (ownedEnumerationPropertyTypes == null) {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(
          ...
          CommunicationPackage.COMMUNICATION_LINK__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<AbstractPropertyValue> getAppliedPropertyValues() {
    ...
    if (appliedPropertyValues == null) {
      appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this,
          CommunicationPackage.COMMUNICATION_LINK__APPLIED_PROPERTY_VALUES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
    ...
    if (ownedPropertyValueGroups == null) {
      ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class,
          this, CommunicationPackage.COMMUNICATION_LINK__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
    ...
    if (appliedPropertyValueGroups == null) {
      appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this,
          CommunicationPackage.COMMUNICATION_LINK__APPLIED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EnumerationPropertyLiteral getStatus() {
    ...
    if (status != null && status.eIsProxy()) {
      ...
      if (status != oldStatus) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommunicationPackage.COMMUNICATION_LINK__STATUS,
              oldStatus, status));
      }
    }
    return status;
  ...
  public void setStatus(EnumerationPropertyLiteral newStatus) {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__STATUS, oldStatus,
          status));
  ...
  public EList<EnumerationPropertyLiteral> getFeatures() {
    ...
    if (features == null) {
      features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this,
          CommunicationPackage.COMMUNICATION_LINK__FEATURES);
    }
    return features;
  }
  ...
  public void setKind(CommunicationLinkKind newKind) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__KIND, oldKind, kind));
  ...
  public void setProtocol(CommunicationLinkProtocol newProtocol) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__PROTOCOL,
      ...
      if (exchangeItem != oldExchangeItem) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              CommunicationPackage.COMMUNICATION_LINK__EXCHANGE_ITEM, oldExchangeItem, exchangeItem));
      }
    }
    return exchangeItem;
  }
  ...
  public void setExchangeItem(ExchangeItem newExchangeItem) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.COMMUNICATION_LINK__EXCHANGE_ITEM,
          oldExchangeItem, exchangeItem));
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == PublishableElement.class) {
      ...
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
        return CommunicationPackage.COMMUNICATION_LINK__VISIBLE_IN_DOC;
      case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
        return CommunicationPackage.COMMUNICATION_LINK__VISIBLE_IN_LM;
      default:
        return -1;
      }
    }
