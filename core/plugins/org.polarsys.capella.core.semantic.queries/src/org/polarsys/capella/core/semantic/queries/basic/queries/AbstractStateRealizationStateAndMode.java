 ...
 *
 */
public abstract class AbstractStateRealizationStateAndMode implements IQuery {

  public AbstractStateRealizationStateAndMode() {
    // does nothing
  }
  ...
  public List<Object> compute(Object object) {
    ...
    if (object instanceof AbstractState) {
      ...
      EList<AbstractStateRealization> realizations = state.getOwnedAbstractStateRealizations();
      for (AbstractStateRealization abstractStateRealization : realizations) {
        TraceableElement targetElement = getTargetOrSourceElement(abstractStateRealization);
