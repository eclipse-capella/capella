...
public abstract class AbstractCIRealizedPhysicalArtifacts implements IQuery {
	...
	public List<Object> compute(Object object_p) {
		...
		if (object_p instanceof ConfigurationItem) {
		  ConfigurationItem c = (ConfigurationItem) object_p;
   ...
   * @return
   */
  public abstract boolean isValidElement(TraceableElement element_p);
