 ...
 *
 */
public  class AbstractStateRealizedState extends AbstractStateRealizationStateAndMode{

  public AbstractStateRealizedState() {
    // does nothing
  }
  ...
  public TraceableElement getTargetOrSourceElement(AbstractStateRealization realization_p) {
    return realization_p.getTargetElement();
  }
