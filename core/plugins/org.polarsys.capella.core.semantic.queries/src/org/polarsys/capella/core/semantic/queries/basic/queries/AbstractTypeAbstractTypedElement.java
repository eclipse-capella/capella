...
public class AbstractTypeAbstractTypedElement implements IQuery {
	...
	public List<Object> compute(Object object_p) {
	  ...
	  if(!TriStateBoolean.True.equals(CapellaProjectHelper.isReusableComponentsDriven((ModelElement) object_p)))
	    return result;
	  if (object_p instanceof AbstractType) {
	    AbstractType abstractType = (AbstractType) object_p;
