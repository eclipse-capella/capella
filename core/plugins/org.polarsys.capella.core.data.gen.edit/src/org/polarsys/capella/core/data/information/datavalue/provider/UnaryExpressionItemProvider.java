...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datavalue.UnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExpressionItemProvider extends AbstractExpressionValueItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
  ...
  /**
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnaryExpression_operator_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_UnaryExpression_operator_feature", "_UI_UnaryExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatavaluePackage.Literals.UNARY_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatavaluePackage.Literals.UNARY_EXPRESSION__OWNED_OPERAND);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnaryExpression")); //$NON-NLS-1$
	}
  ...
  public String getTextGen(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_UnaryExpression_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
  ...
  public String getText(Object object) {
    ...
    // begin-capella-code
    String valuePrefix = DataValueNaminghelper.getReferencePrefix((UnaryExpression) object);
    String valueSuffix = DataValueNaminghelper.getSuffix((UnaryExpression) object);
    String prefix = ((UnaryExpression) object).getName();
    if (null == prefix) prefix = ""; //$NON-NLS-1$
    else if ("" != prefix) prefix += " = "; //$NON-NLS-1$ //$NON-NLS-2$
    String label = valuePrefix + prefix + ((UnaryExpression) object).getExpression();
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatavaluePackage.Literals.UNARY_EXPRESSION__OWNED_OPERAND,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DatavaluePackage.Literals.UNARY_EXPRESSION__OWNED_OPERAND ||
