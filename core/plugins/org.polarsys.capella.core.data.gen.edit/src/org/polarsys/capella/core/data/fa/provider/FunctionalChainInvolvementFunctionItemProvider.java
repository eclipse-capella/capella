...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.FunctionalChainInvolvementFunction}
...
public class FunctionalChainInvolvementFunctionItemProvider extends FunctionalChainInvolvementItemProvider
  ...
  /**
   * This adds a property descriptor for the Outgoing Involvement Links feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  protected void addOutgoingInvolvementLinksPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
            "_UI_FunctionalChainInvolvementFunction_outgoingInvolvementLinks_feature", //$NON-NLS-1$
            "_UI_FunctionalChainInvolvementFunction_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_FUNCTION__OUTGOING_INVOLVEMENT_LINKS, false, false, false, null,
        null,
        // begin-extension-code
        null));
    // end-extension-code
  ...
  /**
   * This adds a property descriptor for the Incoming Involvement Links feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  protected void addIncomingInvolvementLinksPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
            "_UI_FunctionalChainInvolvementFunction_incomingInvolvementLinks_feature", //$NON-NLS-1$
            "_UI_FunctionalChainInvolvementFunction_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_FUNCTION__INCOMING_INVOLVEMENT_LINKS, false, false, false, null,
        null,
        // begin-extension-code
        null));
    // end-extension-code
  ...
  /**
   * This returns FunctionalChainInvolvementFunction.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
