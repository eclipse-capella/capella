...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.MissionInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionInvolvementItemProvider
   ...
   * @generated
   */
	public MissionInvolvementItemProvider(AdapterFactory adapterFactory) {
   ...
   */
    ...
    if (object instanceof EObject) {
      ...
      // Process CtxPackage.Literals.MISSION_INVOLVEMENT__SYSTEM_COMPONENT
      if (systemComponentPropertyDescriptor != null) {
        Object systemComponentValue = eObject.eGet(CtxPackage.Literals.MISSION_INVOLVEMENT__SYSTEM_COMPONENT, true);
        ...
        } else if (systemComponentValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.MISSION_INVOLVEMENT__SYSTEM_COMPONENT) != null) {
          itemPropertyDescriptors.remove(systemComponentPropertyDescriptor);				  					
      ...
      // Process CtxPackage.Literals.MISSION_INVOLVEMENT__MISSION
      if (missionPropertyDescriptor != null) {
        Object missionValue = eObject.eGet(CtxPackage.Literals.MISSION_INVOLVEMENT__MISSION, true);
        ...
        } else if (missionValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.MISSION_INVOLVEMENT__MISSION) != null) {
          itemPropertyDescriptors.remove(missionPropertyDescriptor);				  					
   ...
   */
    ...
    // end-extension-code		
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MissionInvolvement_systemComponent_feature"), //$NON-NLS-1$
         getString("_UI_PropertyDescriptor_description", "_UI_MissionInvolvement_systemComponent_feature", "_UI_MissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   */
    ...
    // end-extension-code		
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_MissionInvolvement_mission_feature"), //$NON-NLS-1$
         getString("_UI_PropertyDescriptor_description", "_UI_MissionInvolvement_mission_feature", "_UI_MissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
         CtxPackage.Literals.MISSION_INVOLVEMENT__MISSION,
         false,
         false,
         false,
         null,
	...
	/**
   * This returns MissionInvolvement.gif.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   */
    ...
    return overlayImage(object, getResourceLocator().getImage("full/obj16/MissionInvolvement")); //$NON-NLS-1$
  }
   ...
   */
   ...
   String[] result = new String[] { null };
      ...
      if (null == targetName || "" == targetName) { //$NON-NLS-1$
   	...
   	label = "[" + getString("_UI_MissionInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    //end-capella-code
      ...
      //begin-capella-code
      "[" + getString("_UI_MissionInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      //end-capella-code
