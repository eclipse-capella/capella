...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellacore.ModellingArchitecturePkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModellingArchitecturePkgItemProvider
	 ...
	 * @generated
	 */
	public ModellingArchitecturePkgItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((ModellingArchitecturePkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_ModellingArchitecturePkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModellingArchitecturePkg.class)) {
