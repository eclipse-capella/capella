...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.ControlNode} object. <!--
 * begin-user-doc -->
 * 
 * @superClass ExtensionItemProviderAdapter <!-- end-user-doc -->
 * @generated
 */
public class ControlNodeItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider,
  ...
  protected void addKindPropertyDescriptor(Object object) {
    ...
    // end-extension-code
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_ControlNode_kind_feature"), //$NON-NLS-1$
        getString("_UI_PropertyDescriptor_description", "_UI_ControlNode_kind_feature", "_UI_ControlNode_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        FaPackage.Literals.CONTROL_NODE__KIND, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
        // begin-extension-code
        null));
    // end-extension-code
  }
  ...
  /**
   * This returns ControlNode.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ControlNode")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    ...
    label = "[" + getString("_UI_ControlNode_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

    // end-capella-code

    result[0] = label == null || label.length() == 0 ?
    // begin-capella-code
        "[" + getString("_UI_ControlNode_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    // end-capella-code
