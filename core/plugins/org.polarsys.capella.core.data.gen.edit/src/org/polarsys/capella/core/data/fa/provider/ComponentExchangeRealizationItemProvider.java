...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.ComponentExchangeRealization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentExchangeRealizationItemProvider
	extends ExchangeSpecificationRealizationItemProvider
	implements
   ...
   * @generated
   */
	protected IItemPropertyDescriptor allocatedComponentExchangePropertyDescriptor;
   ...
   * @generated
   */
	public ComponentExchangeRealizationItemProvider(AdapterFactory adapterFactory) {
    ...
    if (object instanceof EObject) {
      ...
      if (allocatedComponentExchangePropertyDescriptor != null) {
        ...
        if (allocatedComponentExchangeValue != null && allocatedComponentExchangeValue instanceof EObject && ModelExtensionHelper.getInstance(eObject).isExtensionModelDisabled((EObject) allocatedComponentExchangeValue)) {
          ...
          itemPropertyDescriptors.remove(allocatedComponentExchangePropertyDescriptor);				  					
        } else if (itemPropertyDescriptors.contains(allocatedComponentExchangePropertyDescriptor) == false) {
          itemPropertyDescriptors.add(allocatedComponentExchangePropertyDescriptor);
        }
      }
   ...
   */
    ...
    if (itemPropertyDescriptors == null) {
      ...
      addAllocatedComponentExchangePropertyDescriptor(object);
	...
	/**
   * This adds a property descriptor for the Allocated Component Exchange feature.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   */
	protected void addAllocatedComponentExchangePropertyDescriptor(Object object) {
    // begin-extension-code
    allocatedComponentExchangePropertyDescriptor = createItemPropertyDescriptor
    // end-extension-code		
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ComponentExchangeRealization_allocatedComponentExchange_feature"), //$NON-NLS-1$
         getString("_UI_PropertyDescriptor_description", "_UI_ComponentExchangeRealization_allocatedComponentExchange_feature", "_UI_ComponentExchangeRealization_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
         FaPackage.Literals.COMPONENT_EXCHANGE_REALIZATION__ALLOCATED_COMPONENT_EXCHANGE,
         false,
         false,
         false,
         null,
   ...
   */
    ...
    // end-extension-code		
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ComponentExchangeRealization_allocatingComponentExchange_feature"), //$NON-NLS-1$
         getString("_UI_PropertyDescriptor_description", "_UI_ComponentExchangeRealization_allocatingComponentExchange_feature", "_UI_ComponentExchangeRealization_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
         FaPackage.Literals.COMPONENT_EXCHANGE_REALIZATION__ALLOCATING_COMPONENT_EXCHANGE,
         false,
         false,
         false,
         null,
	...
	/**
   * This returns ComponentExchangeRealization.gif.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   */
    ...
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentExchangeRealization")); //$NON-NLS-1$
  }
   ...
   */
   ...
   String[] result = new String[] { null };
      ...
      if (null == targetName || "" == targetName) { //$NON-NLS-1$
   	...
   	label = "[" + getString("_UI_ComponentExchangeRealization_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    //end-capella-code
      ...
      //begin-capella-code
      "[" + getString("_UI_ComponentExchangeRealization_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      //end-capella-code
