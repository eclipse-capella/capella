...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.cs.BlockArchitecturePkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockArchitecturePkgItemProvider
   ...
   * @generated
   */
	public BlockArchitecturePkgItemProvider(AdapterFactory adapterFactory) {
   ...
   */
   ...
   String[] result = new String[] { null };
    	...
    	//begin-capella-code
    String label = ((BlockArchitecturePkg)object).getName();
    //end-capella-code
    
  
      result[0] = label == null || label.length() == 0 ?
      //begin-capella-code
      "[" + getString("_UI_BlockArchitecturePkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      //end-capella-code
   ...
   */
    ...
    switch (notification.getFeatureID(BlockArchitecturePkg.class)) {
