...
public class ConstraintItemProvider
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process CapellacorePackage.Literals.CONSTRAINT__EXPRESSION
			if (expressionPropertyDescriptor != null) {
				Object expressionValue = eObject.eGet(CapellacorePackage.Literals.CONSTRAINT__EXPRESSION, true);
				...
				} else if (expressionValue == null && ExtensionModelManager.getAnyType(eObject, CapellacorePackage.Literals.CONSTRAINT__EXPRESSION) != null) {
					itemPropertyDescriptors.remove(expressionPropertyDescriptor);				  					
	...
	protected void addExpressionPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CapellacorePackage.Literals.CONSTRAINT__EXPRESSION,
				 true,
				 false,
				 true,
				 null,
