...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.FunctionalChainInvolvementLink}
...
public class FunctionalChainInvolvementLinkItemProvider extends FunctionalChainInvolvementItemProvider
  ...
  public void checkChildCreationExtender(Object object) {
    ...
    if (object instanceof EObject) {
      ...
      if (exchangeContextPropertyDescriptor != null) {
        Object exchangeContextValue = eObject
            .eGet(FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__EXCHANGE_CONTEXT, true);
        if (exchangeContextValue != null && exchangeContextValue instanceof EObject
            && ModelExtensionHelper.getInstance(eObject).isExtensionModelDisabled((EObject) exchangeContextValue)) {
          itemPropertyDescriptors.remove(exchangeContextPropertyDescriptor);
        } else if (exchangeContextValue == null && ExtensionModelManager.getAnyType(eObject,
            FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__EXCHANGE_CONTEXT) != null) {
          itemPropertyDescriptors.remove(exchangeContextPropertyDescriptor);
      ...
      if (sourcePropertyDescriptor != null) {
        ...
        if (sourceValue != null && sourceValue instanceof EObject
          ...
          itemPropertyDescriptors.remove(sourcePropertyDescriptor);
            ...
            FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__SOURCE) != null) {
          itemPropertyDescriptors.remove(sourcePropertyDescriptor);
      ...
      if (targetPropertyDescriptor != null) {
        ...
        if (targetValue != null && targetValue instanceof EObject
          ...
          itemPropertyDescriptors.remove(targetPropertyDescriptor);
            ...
            FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__TARGET) != null) {
          itemPropertyDescriptors.remove(targetPropertyDescriptor);
  ...
  /**
   * This adds a property descriptor for the Source Reference Hierarchy feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  protected void addSourceReferenceHierarchyPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
            "_UI_ReferenceHierarchyContext_sourceReferenceHierarchy_feature", "_UI_ReferenceHierarchyContext_type"), //$NON-NLS-1$ //$NON-NLS-2$
        FaPackage.Literals.REFERENCE_HIERARCHY_CONTEXT__SOURCE_REFERENCE_HIERARCHY, true, false, true, null, null,
        // begin-extension-code
        null));
    // end-extension-code
  }
  ...
  /**
   * This adds a property descriptor for the Target Reference Hierarchy feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  protected void addTargetReferenceHierarchyPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
            "_UI_ReferenceHierarchyContext_targetReferenceHierarchy_feature", "_UI_ReferenceHierarchyContext_type"), //$NON-NLS-1$ //$NON-NLS-2$
        FaPackage.Literals.REFERENCE_HIERARCHY_CONTEXT__TARGET_REFERENCE_HIERARCHY, true, false, true, null, null,
        // begin-extension-code
        null));
    // end-extension-code
  }
  ...
  /**
   * This adds a property descriptor for the Exchange Context feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  protected void addExchangeContextPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainInvolvementLink_exchangeContext_feature", //$NON-NLS-1$ //$NON-NLS-2$
            "_UI_FunctionalChainInvolvementLink_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__EXCHANGE_CONTEXT, true, false, true, null, null,
        // begin-extension-code
        null);
    itemPropertyDescriptors.add(exchangeContextPropertyDescriptor);
    // end-extension-code
  ...
  protected void addExchangedItemsPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainInvolvementLink_exchangedItems_feature", //$NON-NLS-1$ //$NON-NLS-2$
            "_UI_FunctionalChainInvolvementLink_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__EXCHANGED_ITEMS, true, false, true, null, null,
        // begin-extension-code
        null));
    // end-extension-code
  }
  ...
  protected void addSourcePropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainInvolvementLink_source_feature", //$NON-NLS-1$ //$NON-NLS-2$
            "_UI_FunctionalChainInvolvementLink_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__SOURCE, true, false, true, null, null,
        // begin-extension-code
        null);
    itemPropertyDescriptors.add(sourcePropertyDescriptor);
    // end-extension-code
  ...
  protected void addTargetPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainInvolvementLink_target_feature", //$NON-NLS-1$ //$NON-NLS-2$
            "_UI_FunctionalChainInvolvementLink_type"), //$NON-NLS-1$
        FaPackage.Literals.FUNCTIONAL_CHAIN_INVOLVEMENT_LINK__TARGET, true, false, true, null, null,
        // begin-extension-code
        null);
    itemPropertyDescriptors.add(targetPropertyDescriptor);
    // end-extension-code
  ...
  /**
   * This returns FunctionalChainInvolvementLink.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
