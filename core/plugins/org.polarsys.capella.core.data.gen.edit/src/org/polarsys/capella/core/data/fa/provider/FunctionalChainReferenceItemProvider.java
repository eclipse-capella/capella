...
public class FunctionalChainReferenceItemProvider extends FunctionalChainInvolvementItemProvider
  ...
  public void checkChildCreationExtender(Object object) {
    ...
    if (object instanceof EObject) {
      ...
      if (referencedFunctionalChainPropertyDescriptor != null) {
        Object referencedFunctionalChainValue = eObject
            .eGet(FaPackage.Literals.FUNCTIONAL_CHAIN_REFERENCE__REFERENCED_FUNCTIONAL_CHAIN, true);
        if (referencedFunctionalChainValue != null && referencedFunctionalChainValue instanceof EObject
            && ModelExtensionHelper.getInstance(eObject)
                .isExtensionModelDisabled((EObject) referencedFunctionalChainValue)) {
          itemPropertyDescriptors.remove(referencedFunctionalChainPropertyDescriptor);
        } else if (referencedFunctionalChainValue == null && ExtensionModelManager.getAnyType(eObject,
            FaPackage.Literals.FUNCTIONAL_CHAIN_REFERENCE__REFERENCED_FUNCTIONAL_CHAIN) != null) {
          itemPropertyDescriptors.remove(referencedFunctionalChainPropertyDescriptor);
  ...
  /**
   * This adds a property descriptor for the Referenced Functional Chain feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  protected void addReferencedFunctionalChainPropertyDescriptor(Object object) {
    ...
    (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        ...
        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
            "_UI_FunctionalChainReference_referencedFunctionalChain_feature", "_UI_FunctionalChainReference_type"), //$NON-NLS-1$ //$NON-NLS-2$
        FaPackage.Literals.FUNCTIONAL_CHAIN_REFERENCE__REFERENCED_FUNCTIONAL_CHAIN, false, false, false, null, null,
        // begin-extension-code
        null);
    itemPropertyDescriptors.add(referencedFunctionalChainPropertyDescriptor);
    // end-extension-code
  ...
  /**
   * This returns FunctionalChainReference.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
