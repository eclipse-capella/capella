 ...
 */
public class SystemCapabilityInvolvementSection extends CapellaElementSection {
  /**
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CtxPackage.eINSTANCE.getSystemCapabilityInvolvement()));
  }
}
