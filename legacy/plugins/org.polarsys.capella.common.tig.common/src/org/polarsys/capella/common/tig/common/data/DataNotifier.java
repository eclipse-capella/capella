 ...
 *******************************************************************************/
package org.polarsys.capella.common.tig.common.data;
 ...
 * <li> Blind registration rule : A registered adapter for new object of type A does not have to know the container class of A. If a new object A is created,
 * and added to the model, then this adapter will be automatically notified. Container object is then accessible through {@link Notification#getNotifier()}
 * method.
 * </ul>
 * </p>
 * <p>
 ...
 * </p>
 */
public class DataNotifier extends AdapterImpl {
  /**
   ...
   * @param object_p The model object being dealt within the notification.<br>Empty result is returned if this is not indeed a model element.
   ...
   * @param objects_p Model objects being dealt within the notification.<br>Empty result is returned if these are not indeed model elements.
   * @param removeExistingAdapters_p Should existing adapters be removed ? <code>true</code> if so, <code>false</code> otherwise.
   * @return A not <code>null</code> collection of {@link Adapter}. May be empty.
   */
