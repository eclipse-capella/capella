...
public abstract class AbstractReadOnlyCommand extends RunnableWithResult.Impl implements ICommand {
  ...
  /**
   * @see org.polarsys.capella.common.tig.ef.command.ICommand#commandInterrupted()
   */
  ...
  /**
   * @see org.polarsys.capella.common.tig.ef.command.ICommand#commandRolledBack()
   */
  ...
  /**
   * @see org.polarsys.capella.common.tig.ef.command.ICommand#getExecutionOptions()
   */
  ...
  /**
   * @see org.polarsys.capella.common.tig.ef.command.ICommand#getName()
   */
