...
public class rmaplocaladdorgpolarsyscapella extends org.eclipse.egf.portfolio.eclipse.build.buckminster.additions.buildrmaplocal {
	...
	protected final String TEXT_8 = "\">" + NL + "\t\t\t\t<bc:replace>" + NL + "\t\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL
			+ "\t\t\t\t\t<bc:match pattern=\"^org\\.polarsys\\.capella\\.(.*)$\" replacement=\"$1\" />" + NL + "\t\t\t\t</bc:replace>" + NL + "\t\t\t</uri>" + NL
