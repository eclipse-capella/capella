...
public class ClassimplementedGenOperationTODOoverride
	...
	protected final String TEXT_1 = "\t\t// TODO: implement this method"
			+ NL
	...
	protected final String TEXT_7 = ".Helper helper = OCL_ENV.createOCLHelper();"
			+ NL + "\t\t\thelper.setOperationContext(";
	protected final String TEXT_8 = ", eOperation);" + NL + "\t\t\t";
	protected final String TEXT_9 = " ocl = eOperation.getEAnnotation(OCL_ANNOTATION_SOURCE);"
			+ NL + "\t\t\tString body = ocl.getDetails().get(\"body\");";
	protected final String TEXT_10 = NL + "\t\t\t" + NL + "\t\t\ttry {" + NL
			+ "\t\t\t\t";
	protected final String TEXT_11 = " = helper.createQuery(body);" + NL
			+ "\t\t\t} catch (";
	protected final String TEXT_12 = " e) {"
			+ NL
	...
	protected final String TEXT_17 = "<?, ?, ?, ?, ?> evalEnv = query.getEvaluationEnvironment();"
			+ NL + "\t\t";
	...
	protected final String TEXT_26 = ">) query.evaluate(this);" + NL
			+ "\t\treturn new ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (body == null) {
			...
			stringBuffer.append(genOperation.getGenClass().getGenOperations()
					.indexOf(genOperation));
			...
			if (!genOperation.getEcoreOperation().getEParameters().isEmpty()) {
				...
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.ocl.EvaluationEnvironment"));
				stringBuffer.append(TEXT_17);
				for (EParameter param : genOperation.getEcoreOperation()
						.getEParameters()) {
