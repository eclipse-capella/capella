...
public class capellaManifestMFForCDO extends
		org.eclipse.egf.emf.pattern.model.cdo.ManifestMFForCDO {
	protected static String nl;

	public static synchronized capellaManifestMFForCDO create(
			String lineSeparator) {
		nl = lineSeparator;
		capellaManifestMFForCDO result = new capellaManifestMFForCDO();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_18 = NL
			+ "Require-Bundle: org.polarsys.capella.common.tig.model, org.polarsys.capella.common.model, ";
	...
	public capellaManifestMFForCDO() {
