...
public class Plugin extends org.eclipse.egf.emf.pattern.editor.Plugin {
    ...
    protected final String TEXT_29 = NL + "\t/**" + NL + "\t * Returns the singleton instance of the Eclipse plugin." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
            ...
            + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class Implementation extends ";
    ...
    protected final String TEXT_36 = ");" + NL + "\t" + NL + "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL + "\t\t\tplugin = this;" + NL + "\t\t}" + NL + "" + NL
            + "\t\t//begin-capella-code" + NL + "\t\t/**" + NL + "\t\t * Returns the object's graphical representation." + NL
    ...
    protected final String TEXT_38 = "(\"icons/\" + key + \".gif\"), null);" + NL + "\t\t}" + NL + "\t\t//end-capella-code" + NL + "\t}" + NL;
