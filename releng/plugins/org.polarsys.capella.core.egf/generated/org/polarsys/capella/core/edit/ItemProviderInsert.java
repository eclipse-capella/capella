...
public class ItemProviderInsert extends org.eclipse.egf.emf.pattern.edit.call.ItemProvider.ItemProviderinsert {
    ...
    protected final String TEXT_1 = "\t// begin-capella-code" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
    ...
    protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
        ...
        stringBuffer.append(genModel.getImportedName("org.polarsys.capella.common.model.copypaste.SharedInitializeCopyCommand"));
