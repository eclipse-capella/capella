...
public class ResourceClass extends org.polarsys.kitalpha.emde.egf.model.ResourceClass {
	...
	protected final String TEXT_24 = ") {" + NL + "\t      setID(eObject_p, ((ModelElement) eObject_p).getId());" + NL
			+ "\t    }" + NL + "\t    super.attachedHelper(eObject_p);" + NL + "\t  }" + NL + "      //end-capella-code"
	...
	protected final String TEXT_61 = NL + "\t\t// Save Options" + NL
	...
	protected final String TEXT_72 = " setLoaded(boolean isLoaded) {" + NL + "\t\treturn super.setLoaded(isLoaded);"
	...
	protected final String TEXT_92 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tSAXParser saxParser = null;" + NL
			+ "\t\ttry" + NL + "\t\t{" + NL
