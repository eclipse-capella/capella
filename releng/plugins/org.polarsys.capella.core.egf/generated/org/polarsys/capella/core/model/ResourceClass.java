...
public class ResourceClass extends org.polarsys.kitalpha.emde.egf.model.ResourceClass {
  ...
  protected final String TEXT_22 = NL + NL + "      //begin-capella-code" + NL + "\t  /**" + NL
      + "\t   * {@inheritDoc}" + NL + "\t   * @generated" + NL + "\t   */" + NL + "\t  @Override" + NL
      + "\t  protected void attachedHelper(";
  protected final String TEXT_23 = " eObject_p) {" + NL + "\t    // Make sure specified object has its id generated."
      + NL + "\t    if (eObject_p instanceof ";
  protected final String TEXT_24 = ") {" + NL + "\t      setID(eObject_p, ((ModelElement) eObject_p).getId());" + NL
      + "\t    }" + NL + "\t    super.attachedHelper(eObject_p);" + NL + "\t  }" + NL + "      //end-capella-code" + NL
  ...
  protected final String TEXT_32 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_33 = NL + "\t@Override";
  protected final String TEXT_34 = NL + "\tprotected ";
  protected final String TEXT_35 = " createXMLHelper() {";
  ...
  protected final String TEXT_43 = " createXMLLoad() {";
  ...
  protected final String TEXT_53 = NL + "\tprotected boolean useIDAttributes() {" + NL + "\t\treturn false;" + NL
      + "\t}";
  protected final String TEXT_54 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_55 = NL + "\t@Override";
  protected final String TEXT_56 = NL + "\tprotected boolean useUUIDs() {" + NL + "\t\treturn true;" + NL + "\t}";
  protected final String TEXT_57 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_58 = NL + "\t@Override";
  protected final String TEXT_59 = NL + "\tprotected void init() {" + NL + "\t\tsuper.init();" + NL;
  protected final String TEXT_60 = NL + "\t\tsetTrackingModification(true);";
  ...
  protected final String TEXT_64 = " getEObjectByID(String id) {" + NL + "\t\tif (idToEObjectMap == null)" + NL
  ...
  protected final String TEXT_66 = NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\tpublic ";
  protected final String TEXT_67 = " getIntrinsicIDToEObjectMap() {" + NL + "\t\treturn getIDToEObjectMap();" + NL
  ...
  protected final String TEXT_69 = NL + "\tprotected void doUnload() {" + NL + "\t\tsuper.doUnload();" + NL
  ...
  protected final String TEXT_72 = " setLoaded(boolean isLoaded) {" + NL + "\t\treturn super.setLoaded(isLoaded);" + NL
  ...
  protected final String TEXT_74 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_75 = NL + "\t@Override";
  protected final String TEXT_76 = NL + "\tpublic void doLoad(InputStream inputStream, ";
  protected final String TEXT_77 = " options) throws IOException" + NL + "\t{" + NL
      ...
      + "\t\t\t\t  (";
  protected final String TEXT_78 = ")options.get(XMLResource.OPTION_PARSER_FEATURES), " + NL + "\t\t\t\t  (";
  protected final String TEXT_79 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL
  ...
  protected final String TEXT_83 = ")options.get(XMLResource.OPTION_PARSER_FEATURES), " + NL + "\t\t\t\t  (";
  protected final String TEXT_84 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL
      + "\t\t\t\t  Boolean.TRUE.equals(options.get(XMLResource.OPTION_USE_LEXICAL_HANDLER))).eContainer());" + NL
      ...
      + NL + "\t * @throws ParserConfigurationException" + NL + "\t * @throws SAXException" + NL + "\t * @generated"
      + NL + "\t */" + NL + "\tpublic static EObject load(InputSource inputSource, ";
  protected final String TEXT_85 = " features, ";
  protected final String TEXT_86 = " properties, boolean useLexicalHandler) throws IOException" + NL + "\t{" + NL
      + "\t\t";
  ...
  protected final String TEXT_89 = " " + NL + "\t\tif (features != null)" + NL + "\t\t{" + NL
  ...
  protected final String TEXT_95 = NL + "\t\t}" + NL + "\t\tcatch (Exception exception)" + NL + "\t\t{" + NL
  ...
  protected final String TEXT_106 = " previous, Attributes attributes)" + NL + "\t\t{" + NL + "\t\t\t ";
  ...
  protected final String TEXT_113 = ".pushOnto(previous);" + NL + "\t\t\t result";
  protected final String TEXT_114 = ".handleAttributes(attributes);" + NL + "\t\t\t return result";
  ...
  protected final String TEXT_126 = "Value;" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL
      + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
      + "\t\t */" + NL + "\t\tpublic static class ";
  protected final String TEXT_127 = "StackFrame extends ";
  protected final String TEXT_128 = NL + "\t\t{" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
      + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL + "\t\t\tprotected ";
  protected final String TEXT_129 = " the";
  protected final String TEXT_130 = ";" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL
      + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL + "\t\t\tprotected ";
  ...
  protected final String TEXT_140 = NL + "\t\t\tpublic void handleAttributes(Attributes attributes)" + NL + "\t\t\t{";
  protected final String TEXT_141 = NL + "\t\t\t\tString theValue = attributes.getValue(";
  protected final String TEXT_142 = ", \"";
  protected final String TEXT_143 = "\");";
  protected final String TEXT_144 = NL + "\t\t\t\ttheValue = attributes.getValue(";
  ...
  protected final String TEXT_160 = NL + "\t\t\t\t// There are attributes to handle.";
  protected final String TEXT_161 = NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\t/**" + NL
      + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL
      + "\t\t\t */";
  ...
  protected final String TEXT_169 = ".equals(namespace))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\treturn ";
  protected final String TEXT_170 = " = ";
  protected final String TEXT_171 = ".FrameFactory.INSTANCE.push";
  protected final String TEXT_172 = "(this, attributes);" + NL + "\t\t\t\t}";
  protected final String TEXT_173 = NL + "\t\t\t\treturn super.startElement(namespace, localName, qName, attributes);";
  protected final String TEXT_174 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL
  ...
  protected final String TEXT_198 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tsuper.endElement(child);"
      + NL + "\t\t\t\t}";
  protected final String TEXT_199 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t/**" + NL
      + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL
      + "\t\t\t */";
  protected final String TEXT_200 = NL + "\t\t\t@Override";
  protected final String TEXT_201 = NL + "\t\t\tpublic void create()" + NL + "\t\t\t{" + NL + "\t\t\t\tthe";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ".create";
  protected final String TEXT_204 = "();" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\t/**" + NL
      + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL
      + "\t\t\t */" + NL + "\t\t\tprotected ";
  protected final String TEXT_205 = " pop";
  protected final String TEXT_206 = "()" + NL + "\t\t\t{" + NL + "\t\t\t\tpop();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_211 = "Value;" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t}" + NL;
  protected final String TEXT_212 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
      + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic ";
  protected final String TEXT_213 = " push";
  protected final String TEXT_214 = "(";
  protected final String TEXT_215 = " previous, Attributes attributes)" + NL + "\t\t{" + NL + "\t\t\t ";
  ...
  protected final String TEXT_222 = ".pushOnto(previous);" + NL + "\t\t\t result";
  protected final String TEXT_223 = ".handleAttributes(attributes);" + NL + "\t\t\t return result";
  protected final String TEXT_224 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL
      + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
      + "\t\t */" + NL + "\t\tpublic ";
  ...
  protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
    ...
    if (genPackage.isDataTypeConverters()
        && (genPackage.hasDocumentRoot() || org.eclipse.emf.ecore.xml.type.XMLTypePackage.eNS_URI.equals(genPackage
            .getNSURI()))) {
