...
public class ResourceClass extends
		org.polarsys.kitalpha.emde.egf.model.ResourceClass {
	...
	protected final String TEXT_4 = NL + NL
			+ "import org.eclipse.emf.ecore.xmi.XMLResource;" + NL
			+ "import org.eclipse.emf.ecore.xmi.impl.URIHandlerImpl;" + NL + ""
	...
	protected final String TEXT_14 = "<Object>();" + NL + "  " + NL + "\t/**"
	...
	protected final String TEXT_20 = "(URI uri)" + NL + "\t{" + NL
			+ "\t\tsuper(uri);";
	protected final String TEXT_21 = NL + "\t}\t";
	protected final String TEXT_22 = NL + NL + "      //begin-capella-code"
			+ NL + "\t  /**" + NL + "\t   * {@inheritDoc}" + NL
			+ "\t   * @generated" + NL + "\t   */" + NL + "\t  @Override" + NL
			+ "\t  protected void attachedHelper(";
	protected final String TEXT_23 = " eObject_p) {" + NL
			+ "\t    // Make sure specified object has its id generated." + NL
			+ "\t    if (eObject_p instanceof ";
	protected final String TEXT_24 = ") {" + NL
			+ "\t      setID(eObject_p, ((ModelElement) eObject_p).getId());"
			+ NL + "\t    }" + NL + "\t    super.attachedHelper(eObject_p);"
	...
	protected final String TEXT_53 = NL
			+ "\tprotected boolean useIDAttributes() {" + NL
			+ "\t\treturn false;" + NL + "\t}";
	...
	protected final String TEXT_56 = NL + "\tprotected boolean useUUIDs() {"
			+ NL + "\t\treturn true;" + NL + "\t}";
	...
	protected final String TEXT_59 = NL + "\tprotected void init() {" + NL
			+ "\t\tsuper.init();" + NL;
	...
	protected final String TEXT_64 = " getEObjectByID(String id) {"
			+ NL
	...
	protected final String TEXT_66 = NL + "\t@SuppressWarnings(\"unchecked\")"
			+ NL + "\tpublic ";
	protected final String TEXT_67 = " getIntrinsicIDToEObjectMap() {"
			+ NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genPackage.getResource() == GenResourceKind.XML_LITERAL
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.xmi.XMLParserPool"));
			stringBuffer.append(TEXT_15);
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.ecore.xmi.impl.XMLParserPoolImpl"));
		...
		if (genPackage.getResource() == GenResourceKind.XML_LITERAL
			...
			if (genPackage.isExtensibleProviderFactory()
				...
				stringBuffer
						.append(genModel
								.getImportedName("org.polarsys.capella.common.data.modellingcore.ModelElement"));
				...
				stringBuffer.append(genModel
						.getImportedName("org.eclipse.emf.ecore.xmi.XMLSave"));
				...
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.emf.ecore.xmi.XMLHelper"));
				stringBuffer.append(TEXT_35);
				if (genPackage.getResource() == GenResourceKind.XML_LITERAL) {
					stringBuffer.append(TEXT_36);
					stringBuffer
							.append(genModel
									.getImportedName("org.polarsys.kitalpha.emde.xmi.XMLExtensionHelperImpl"));
					stringBuffer.append(TEXT_37);
				} else {
					stringBuffer.append(TEXT_38);
					stringBuffer
							.append(genModel
									.getImportedName("org.polarsys.kitalpha.emde.xmi.XMIExtensionHelperImpl"));
				...
				stringBuffer.append(genModel
						.getImportedName("org.eclipse.emf.ecore.xmi.XMLLoad"));
				stringBuffer.append(TEXT_43);
				if (genPackage.getResource() == GenResourceKind.XML_LITERAL) {
					stringBuffer.append(TEXT_44);
					stringBuffer
							.append(genModel
									.getImportedName("org.polarsys.kitalpha.emde.xmi.XMLExtensionLoadImpl"));
					...
					stringBuffer
							.append(genModel
									.getImportedName("org.polarsys.kitalpha.emde.xmi.XMIExtensionLoadImpl"));
