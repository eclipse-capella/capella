...
public class ItemProviderGetText extends org.polarsys.kitalpha.emde.egf.edit.call.ItemProvider.ItemProvidergetTextoverride {
    ...
    protected final String TEXT_18 = ")object;" + NL + "\t\t//begin-capella-code" + NL + "\t\tresult[0] = \"[\" + etString(\"_UI_";
    ...
    protected final String TEXT_43 = ") target).getName();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tif (null == targetName || \"\" == targetName) {";
    ...
    protected final String TEXT_55 = NL + "\t\t\tresult[0] = label == null || label.length() == 0 ?" + NL + "\t\t\t//begin-capella-code" + NL + "\t\t\t\"[\" + getString(\"_UI_";
