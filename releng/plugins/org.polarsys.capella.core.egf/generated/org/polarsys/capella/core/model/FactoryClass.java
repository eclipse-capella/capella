...
public class FactoryClass extends
	...
	protected final String TEXT_88 = NL + "    //end-capella-code" + NL
			+ "\t\treturn ";
	...
	protected final String TEXT_165 = ", null, null))" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_168 = "exception == null) return result;" + NL
			+ "    " + NL + "\t\tthrow exception;";
	...
	protected final String TEXT_193 = ".get(initialValue);"
			+ NL
	...
	protected final String TEXT_233 = NL
			+ "\t\tif (initialValue == null) return null;" + NL + "\t\t";
	protected final String TEXT_234 = " result = null;" + NL
			+ "\t\tRuntimeException exception = null;";
	...
	protected final String TEXT_248 = ".INSTANCE.validate(eDataType, result, null, null))"
			+ NL
			+ "\t\t\t{"
			+ NL
			+ "\t\t\t\treturn result;"
	...
	protected final String TEXT_303 = NL + "\t\t\tresult.append(' ');" + NL
			+ "\t\t}" + NL
			+ "\t\treturn result.substring(0, result.length() - 1);";
	protected final String TEXT_304 = NL
			+ "\t\tif (instanceValue == null) return null;";
	protected final String TEXT_305 = NL + "\t\tif (";
	protected final String TEXT_306 = ".isInstance(instanceValue))" + NL
			+ "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{";
	...
	protected final String TEXT_376 = ")instanceValue;" + NL
	...
	protected final String TEXT_392 = NL + "\t\t\tresult.append(' ');" + NL
			+ "\t\t}" + NL
			+ "\t\treturn result.substring(0, result.length() - 1);";
	...
	protected final String TEXT_403 = ".isInstance(instanceValue))" + NL
			+ "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{";
	...
	protected final String TEXT_419 = "</em>'." + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t";
	...
	protected final String TEXT_423 = "</em>' corresponding the given literal."
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_425 = "(String literal);"
			+ NL
			+ ""
			+ NL
			+ "\t/**"
	...
	protected final String TEXT_426 = "</em>'." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_435 = ")getEPackage();" + NL + "\t}" + NL + ""
	...
	protected final String TEXT_438 = " getPackage()" + NL + "\t{" + NL
			+ "\t\treturn ";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		for (GenClass genClass : genPackage.getGenClasses()) {
			if (!genClass.isAbstract()) {
				GenFeature namingAttribute = BusinessGenHelper
