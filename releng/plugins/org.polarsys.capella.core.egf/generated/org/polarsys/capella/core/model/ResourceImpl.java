...
public class ResourceImpl extends org.polarsys.kitalpha.emde.egf.model.ResourceClass {
    ...
    protected final String TEXT_4 = NL + NL + "import org.eclipse.emf.ecore.xmi.XMLResource;" + NL + "import org.eclipse.emf.ecore.xmi.impl.URIHandlerImpl;" + NL + "" + NL + "/**" + NL
            + " * <!-- begin-user-doc -->" + NL + " * The <b>Resource </b> associated with the package." + NL + " * <!-- end-user-doc -->" + NL + " * @see ";
    ...
    protected final String TEXT_18 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */  " + NL + "\tprivate ";

    protected final String TEXT_19 = "<Object> lookupTable = new ";

    protected final String TEXT_20 = "<Object>();" + NL + "  " + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */  " + NL
            + "\tprivate ";

    protected final String TEXT_21 = " parserPool = new ";

    protected final String TEXT_22 = "();  " + NL + "  " + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */  " + NL
            + "\tprivate ";
    ...
    protected final String TEXT_26 = NL + NL + "      //begin-capella-code" + NL + "\t  /**" + NL + "\t   * {@inheritDoc}" + NL + "\t   * @generated" + NL + "\t   */" + NL + "\t  @Override" + NL
            + "\t  protected void attachedHelper(";

    protected final String TEXT_27 = " eObject) {" + NL + "\t    // Make sure specified object has its id generated." + NL + "\t    if (eObject instanceof ";

    protected final String TEXT_28 = ") {" + NL + "\t      setID(eObject, ((ModelElement) eObject).getId());" + NL + "\t    } else if (null != eObject && null != eObject.eClass()) {" + NL
            + "\t      ";

    protected final String TEXT_29 = " attribute = eObject.eClass().getEIDAttribute();" + NL + "\t      if (attribute != null) {" + NL + "\t        Object id = eObject.eGet(attribute);" + NL
            + "\t        if (id instanceof ";

    protected final String TEXT_30 = ") {" + NL + "\t          setID(eObject, (";

    protected final String TEXT_31 = ")id);" + NL + "\t        }" + NL + "\t      }" + NL + "\t    }" + NL + "\t    super.attachedHelper(eObject);" + NL + "\t  }" + NL + "      //end-capella-code"
    ...
    protected final String TEXT_40 = "\t" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
    ...
    protected final String TEXT_45 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
    ...
    protected final String TEXT_50 = NL + "\t\t// Save Options" + NL + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_ENCODING, \"UTF-8\");  //$NON-NLS-1$" + NL
            ...
            + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_SAVE_TYPE_INFORMATION, Boolean.TRUE);    " + NL + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_LINE_WIDTH, new Integer(80));"
            + NL + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_URI_HANDLER, new URIHandlerImpl.PlatformSchemeAware());\t\t        " + NL
            + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_FLUSH_THRESHOLD, Integer.valueOf(0x01000000));" + NL
            + "\t\tgetDefaultSaveOptions().put(XMLResource.OPTION_USE_FILE_BUFFER, Boolean.TRUE);" + NL + "" + NL + "\t\t// Load Options" + NL
            + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_DEFER_ATTACHMENT, Boolean.TRUE);" + NL + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_DEFER_IDREF_RESOLUTION, Boolean.TRUE);"
            + NL + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_USE_DEPRECATED_METHODS, Boolean.TRUE);" + NL + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_USE_PARSER_POOL, parserPool);"
            + NL + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_USE_XML_NAME_TO_FEATURE_MAP, nameToFeatureMap);" + NL
            + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_USE_ENCODED_ATTRIBUTE_STYLE, Boolean.TRUE);" + NL
            + "\t\tgetDefaultLoadOptions().put(XMLResource.OPTION_RECORD_UNKNOWN_FEATURE, Boolean.TRUE);" + NL + "\t}" + NL + "" + NL + "\t//begin-capella-code" + NL + "\t/**" + NL
            + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * " + NL + "\t * @see org.eclipse.emf.ecore.xmi.impl.XMLResourceImpl#getEObjectByID(java.lang.String)" + NL
            + "\t * @generated" + NL + "\t */";

    protected final String TEXT_51 = " getEObjectByID(String id) {" + NL + "\t\tif (idToEObjectMap == null)" + NL + "\t\t\treturn super.getEObjectByID(id);" + NL
            + "\t\treturn getIDToEObjectMap().get(id);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * " + NL
            + "\t * @see org.eclipse.emf.ecore.resource.impl.ResourceImpl#getIntrinsicIDToEObjectMap()" + NL + "\t * @generated" + NL + "\t */";

    protected final String TEXT_52 = NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\tpublic ";

    protected final String TEXT_53 = " getIntrinsicIDToEObjectMap() {" + NL + "\t\treturn getIDToEObjectMap();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
            + "\t * <!-- end-user-doc -->" + NL + "\t * " + NL + "\t * @see org.eclipse.emf.ecore.xmi.impl.XMLResourceImpl#doUnload()" + NL + "\t * @generated" + NL + "\t */";

    protected final String TEXT_54 = NL + "\tprotected void doUnload() {" + NL + "\t\tsuper.doUnload();" + NL + "\t\tthis.idToEObjectMap = null;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
            + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * " + NL + "\t * @see org.eclipse.emf.ecore.resource.impl.ResourceImpl#setLoaded()" + NL + "\t * @generated"
            + NL + "\t */";

    protected final String TEXT_55 = " setLoaded(boolean isLoaded) {" + NL + "\t\treturn super.setLoaded(isLoaded);" + NL + "\t}" + NL + "\t//end-capella-code";

    protected final String TEXT_56 = NL + "\t/**" + NL + "\t * A load option that turns of the use of the generate data converters." + NL + "\t * <!-- begin-user-doc -->" + NL
    ...
    protected final String TEXT_58 = " options) throws IOException" + NL + "\t{" + NL + "\t\tif (options != null && Boolean.TRUE.equals(options.get(OPTION_USE_DATA_CONVERTER)))" + NL + "\t\t{" + NL
    ...
    protected final String TEXT_60 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL + "\t\t\t\t  Boolean.TRUE.equals(options.get(XMLResource.OPTION_USE_LEXICAL_HANDLER))).eContainer());"
    ...
    protected final String TEXT_62 = " options) throws IOException" + NL + "\t{" + NL + "\t\tif (options != null && Boolean.TRUE.equals(options.get(OPTION_USE_DATA_CONVERTER)))" + NL + "\t\t{" + NL
            + "\t\t  getContents().add" + NL + "\t\t\t (load" + NL + "\t\t\t\t (inputSource," + NL + "\t\t\t\t  (";

    protected final String TEXT_63 = ")options.get(XMLResource.OPTION_PARSER_PROPERTIES), " + NL + "\t\t\t\t  Boolean.TRUE.equals(options.get(XMLResource.OPTION_USE_LEXICAL_HANDLER))).eContainer());"
    ...
    protected final String TEXT_67 = "();" + NL + "\t\trequiredFeatures.put(\"http://xml.org/sax/features/namespaces\", Boolean.TRUE); " + NL + "\t\tif (features != null)" + NL + "\t\t{" + NL
    ...
    protected final String TEXT_70 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tSAXParser saxParser = null;" + NL + "\t\ttry" + NL + "\t\t{" + NL
    ...
    protected final String TEXT_71 = NL + "\t\t\treturn (EObject)((EObject)FrameFactory.INSTANCE.popDocumentRoot(documentRoot)).eContents().get(0);";

    protected final String TEXT_72 = NL + "\t\t\treturn FrameFactory.INSTANCE.popDocumentRoot(documentRoot).eContents().get(0);";

    protected final String TEXT_73 = NL + "\t\t}" + NL + "\t\tcatch (Exception exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new IOWrappedException(exception);" + NL + "\t\t}" + NL + "\t\tfinally"
            + NL + "\t\t{" + NL + "\t\t\tparserPool.release(saxParser, requiredFeatures, properties, useLexicalHandler);" + NL + "\t\t}" + NL + "\t}" + NL;

    protected final String TEXT_74 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
    ...
    protected final String TEXT_90 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
            + "\t\t */" + NL + "\t\tpublic ";
    ...
    protected final String TEXT_98 = "Value;" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
            + "\t\t */" + NL + "\t\tpublic static class ";

    protected final String TEXT_99 = "StackFrame extends ";

    protected final String TEXT_100 = NL + "\t\t{" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */"
            + NL + "\t\t\tprotected ";
    ...
    protected final String TEXT_103 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL
            + "\t\t\tprotected ";
    ...
    protected final String TEXT_122 = NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
            + NL + "\t\t\t */";

    protected final String TEXT_123 = NL + "\t\t\tpublic ";

    protected final String TEXT_124 = " startElement(String namespace, String localName, String qName, Attributes attributes) throws SAXException" + NL + "\t\t\t{";
    ...
    protected final String TEXT_133 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\treturn super.startElement(namespace, localName, qName, attributes);" + NL + "\t\t\t\t}";

    protected final String TEXT_134 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL
            + "\t\t\t */";
    ...
    protected final String TEXT_146 = NL + "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tsuper.endElement(child);" + NL + "\t\t\t\t}";

    protected final String TEXT_147 = NL + "\t\t\tpublic void create()" + NL + "\t\t\t{" + NL + "\t\t\t\tthe";

    protected final String TEXT_148 = "();" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL
        ...
        if (genPackage.getResource() == GenResourceKind.XML_LITERAL || genPackage.getResource() == GenResourceKind.XMI_LITERAL) {
            if (genPackage.isExtensibleProviderFactory() || genPackage.isChildCreationExtenders()) {
                ...
                if (genPackage.getResource() == GenResourceKind.XML_LITERAL) {
                    ...
                    stringBuffer.append(genModel.getImportedName("org.polarsys.capella.common.data.core.gen.xmi.impl.CapellaXMLSaveImpl"));
