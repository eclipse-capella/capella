...
public class Editor extends org.polarsys.kitalpha.emde.egf.editor.Editor {
	...
	protected final String TEXT_138 = NL
			...
			+ "\t\t//" + NL + "\t\t// begin-capella-code" + NL
			+ "\t\teditingDomain = new AdapterFactoryEditingDomain(adapterFactory, commandStack, new ";
	protected final String TEXT_139 = "());" + NL + "\t\t//String efName = TigEfProvider.getExecutionManagerName();"
			+ NL + "\t\t//ExecutionManager em = ExecutionManagerRegistry.getInstance().getExecutionManager(efName);"
			+ NL + "\t\t//editingDomain = (AdapterFactoryEditingDomain) em.getEditingDomain(); " + NL
			+ "   \t\t// end-capella-code" + NL;
	...
	protected final String TEXT_178 = NL + NL + "\t\tint dndOperations = DND.DROP_COPY | DND.DROP_MOVE | DND.DROP_LINK;"
	...
	protected final String TEXT_206 = "));" + NL + "\t\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
	...
	protected final String TEXT_290 = "));" + NL + "\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
			+ "\t\t\tselectionViewer.setSelection(new StructuredSelection(editingDomain.getResourceSet().getResources().get(0)), true);"
	...
	protected final String TEXT_310 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			...
			+ "\t\t\t\t\t}  ";
	protected final String TEXT_311 = "\t\t\t\t\t\t\t\t\t\t" + NL + "" + NL + "\t\t\t\t\t// Set up the tree viewer."
			+ NL + "\t\t\t\t\t//" + NL
	...
	protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcatch (Exception exception)" + NL
			...
			+ NL + "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_368 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL
	...
	protected final String TEXT_388 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());"
	...
	protected final String TEXT_404 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_411 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tcase 1:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tString text = new AdapterFactoryItemDelegator(adapterFactory).getText(collection.iterator().next());"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_SingleObjectSelected\", text));";
	protected final String TEXT_412 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tdefault:" + NL
			+ "\t\t\t\t\t{" + NL
	...
	protected final String TEXT_416 = ".INSTANCE.getString(key, new Object [] { s1 });" + NL + "\t}" + NL + "" + NL
			+ "\t/**" + NL
