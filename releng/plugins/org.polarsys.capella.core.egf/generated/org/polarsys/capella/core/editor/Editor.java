...
public class Editor extends org.polarsys.kitalpha.emde.egf.editor.Editor {
	...
	protected final String TEXT_41 = " " + NL + " * <!-- end-user-doc -->" + NL
			...
			+ " * @implements ITabbedPropertySheetPageContributor" + NL
			+ " * <!-- end-capella-code -->" + NL + " *" + NL + " * @generated"
			+ NL + " */" + NL + "public class ";
	...
	protected final String TEXT_325 = NL
			...
			+ NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tpublic String getContributorId() {" + NL
			+ "\t\treturn PROPERTIES_CONTRIBUTOR;" + NL + "\t}" + NL
