...
public class Editor extends org.polarsys.kitalpha.emde.egf.editor.Editor {
  ...
  protected final String TEXT_69 = NL + "\t/**" + NL
      ...
      + "\t * @generated" + NL + "\t */" + NL + "\tprotected IStatusLineManager contentOutlineStatusLineManager;" + NL
      + "" + NL + "\t/**" + NL + "\t * This is the content outline page's viewer." + NL
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
  ...
  protected final String TEXT_83 = ".this);" + NL + "" + NL + "\t\t\t\t\t\tsetCurrentViewer(contentOutlineViewer);"
      ...
      + NL + "\t\t\t\t\tif (((PropertySheet)p).getCurrentPage() == propertySheetPage)" + NL + "\t\t\t\t\t{" + NL
      + "\t\t\t\t\t\tgetActionBarContributor().setActiveEditor(";
  ...
  protected final String TEXT_136 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t\tinitializeEditingDomain();"
      + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This sets up the editing domain for the model editor." + NL
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
  ...
  protected final String TEXT_144 = NL + "\tprotected void firePropertyChange(int action)" + NL + "\t{" + NL
  ...
  protected final String TEXT_146 = " theSelection = collection;" + NL + "\t\t// Make sure it's okay." + NL + "\t\t//"
  ...
  protected final String TEXT_148 = NL + "\t\tpublic Object [] getElements(Object object)" + NL + "\t\t{" + NL
  ...
  protected final String TEXT_150 = NL + "\t\tpublic Object [] getChildren(Object object)" + NL + "\t\t{" + NL
      + "\t\t\tObject parent = super.getParent(object);" + NL
      + "\t\t\treturn (parent == null ? Collections.EMPTY_SET : Collections.singleton(parent)).toArray();" + NL
      + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
      + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_151 = NL + "\t\t@Override";
  protected final String TEXT_152 = NL + "\t\tpublic boolean hasChildren(Object object)" + NL + "\t\t{" + NL
      + "\t\t\tObject parent = super.getParent(object);" + NL + "\t\t\treturn parent != null;" + NL + "\t\t}" + NL + ""
      + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
      + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_153 = NL + "\t\t@Override";
  protected final String TEXT_154 = NL + "\t\tpublic Object getParent(Object object)" + NL + "\t\t{" + NL
      + "\t\t\treturn null;" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_155 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
  ...
  protected final String TEXT_156 = NL
      ...
      + "\t\t\t\t// Create the listener on demand." + NL + "\t\t\t\t//" + NL + "\t\t\t\tselectionChangedListener ="
  ...
  protected final String TEXT_157 = NL + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL
  ...
  protected final String TEXT_159 = " resource_p) {" + NL
  ...
  protected final String TEXT_162 = "<EmdeViewerFilterAction>();\t\t" + NL
  ...
  protected final String TEXT_165 = " extensibleModel = helper.getExtensibleModel(extensibleModelURI);" + NL
  ...
  protected final String TEXT_168 = ") {" + NL + "\t\t\t\t\t\t\tif (selection.isEmpty() == false) {" + NL
      + "\t\t\t\t\t\t\t\tsetSelectionToViewer(((";
  protected final String TEXT_169 = ") getSelection()).toList());" + NL + "\t\t\t\t\t\t\t} else {        " + NL
      + "\t\t\t\t\t\t\t\tif (getResource() != null) {" + NL
      + "\t\t\t\t\t\t\t\t\tif (getResource().getContents().isEmpty()) {" + NL
      + "\t\t\t\t\t\t\t\t\t\tsetSelectionToViewer((new ";
  protected final String TEXT_170 = "(getResource())).toList());" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL
      + "\t\t\t\t\t\t\t\t\t\tsetSelectionToViewer((new ";
  protected final String TEXT_171 = "(getResource().getContents().get(0))).toList());" + NL + "\t\t\t\t\t\t\t\t\t}"
      + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL
      + "\t\t\t\t};\t\t\t" + NL
  ...
  protected final String TEXT_172 = ") getActionBarContributor());\t\t\t\t" + NL
  ...
  protected final String TEXT_175 = NL + "\t\tcontextMenu.setRemoveAllWhenShown(true);" + NL
  ...
  protected final String TEXT_181 = NL + "\t\t// Assumes that the input is a file object." + NL + "\t\t//" + NL
      + "\t\tIFileEditorInput modelFile = (IFileEditorInput)getEditorInput();" + NL
      + "\t\tURI resourceURI = URI.createPlatformResourceURI(modelFile.getFile().getFullPath().toString(), true);";
  protected final String TEXT_182 = NL + "\t\tException exception = null;" + NL + "\t\tResource resource = null;" + NL
      ...
      + "\t\tif (diagnostic.getSeverity() != Diagnostic.OK)" + NL + "\t\t{" + NL
      + "\t\t\tresourceToDiagnosticMap.put(resource,  analyzeResourceProblems(resource, exception));" + NL + "\t\t}"
      + NL + "\t\teditingDomain.getResourceSet().eAdapters().add(problemIndicationAdapter);" + NL + "\t}" + NL + ""
      + NL + "\t/**" + NL + "\t * Returns a diagnostic describing the errors and warnings listed in the resource" + NL
  ...
  protected final String TEXT_190 = NL + "\tpublic void createPages()" + NL + "\t{" + NL
      ...
      + "\t\t// begin-capella-code" + NL + "\t\tif (!getEditingDomain().getResourceSet().getResources().isEmpty())"
      + NL + "\t\t//if (!getEditingDomain().getResourceSet().getResources().isEmpty() &&" + NL + "\t\t//\t!(";
  ...
  protected final String TEXT_192 = "getEditingDomain().getResourceSet().getResources().get(0)).getContents().isEmpty())"
      ...
      + NL
      + "\t\t\t//";
  protected final String TEXT_193 = NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
      + "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
  protected final String TEXT_194 = ".this)" + NL + "\t\t\t\t\t{";
  protected final String TEXT_195 = NL + "\t\t\t\t\t\t@Override";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
  ...
  protected final String TEXT_197 = NL
      ...
      + "                            // end-extension-code";
  protected final String TEXT_198 = NL + "                            return new TreeViewer(tree);";
  ...
  protected final String TEXT_202 = NL + "                // begin-extension-code" + NL
  ...
  protected final String TEXT_207 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// Create a page for the parent tree view."
  ...
  protected final String TEXT_211 = NL
      ...
      + "                            };" + NL + "                            return newTreeViewer;" + NL
      + "                            // end-extension-code";
  protected final String TEXT_212 = NL + "                            return new TreeViewer(tree);";
  ...
  protected final String TEXT_217 = NL + "\t\t\t\tparentViewer.setAutoExpandLevel(30);" + NL
  ...
  protected final String TEXT_225 = NL
      ...
      + "                            // end-extension-code";
  protected final String TEXT_226 = NL + "                            return new ListViewer(composite);";
  ...
  protected final String TEXT_230 = NL + "                // begin-extension-code" + NL
  ...
  protected final String TEXT_239 = NL
      ...
      + "                            };" + NL + "                            return newTreeViewer;" + NL
      + "                            // end-extension-code";
  protected final String TEXT_240 = NL + "                            return new TreeViewer(composite);";
  ...
  protected final String TEXT_244 = NL + "                // begin-extension-code" + NL
  ...
  protected final String TEXT_249 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the table viewer."
      + NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
      + "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
  protected final String TEXT_250 = ".this)" + NL + "\t\t\t\t\t{";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\t@Override";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
      + "\t\t\t\t\t\t{";
  protected final String TEXT_253 = NL
      ...
      + "                            // end-extension-code";
  protected final String TEXT_254 = NL + "                            return new TableViewer(composite);";
  protected final String TEXT_255 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_256 = NL + "\t\t\t\t\t\t@Override";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
      + "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
      + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL
      + "\t\t\t\ttableViewer = (TableViewer)viewerPane.getViewer();";
  protected final String TEXT_258 = NL + "                // begin-extension-code" + NL
      + "                viewers.add(tableViewer);" + NL + "                // end-extension-code";
  protected final String TEXT_259 = NL + NL + "\t\t\t\tTable table = tableViewer.getTable();" + NL
  ...
  protected final String TEXT_260 = NL + "\t\t\t\tobjectColumn.setResizable(true);" + NL + "" + NL
      + "\t\t\t\tTableColumn selfColumn = new TableColumn(table, SWT.NONE);" + NL
      + "\t\t\t\tlayout.addColumnData(new ColumnWeightData(2, 100, true));" + NL
      + "\t\t\t\tselfColumn.setText(getString(\"_UI_SelfColumn_label\"));";
  protected final String TEXT_261 = NL + "\t\t\t\tselfColumn.setResizable(true);" + NL + "" + NL
  ...
  protected final String TEXT_265 = "));" + NL + "" + NL + "\t\t\t\tcreateContextMenuFor(tableViewer);" + NL
      + "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
  ...
  protected final String TEXT_276 = NL + NL + "\t\t\t\tTree tree = treeViewerWithColumns.getTree();" + NL
      ...
      + "\t\t\t\tobjectColumn.setText(getString(\"_UI_ObjectColumn_label\"));";
  protected final String TEXT_277 = NL + "\t\t\t\tobjectColumn.setResizable(true);" + NL
      + "\t\t\t\tobjectColumn.setWidth(250);" + NL + "" + NL
      + "\t\t\t\tTreeColumn selfColumn = new TreeColumn(tree, SWT.NONE);" + NL
      + "\t\t\t\tselfColumn.setText(getString(\"_UI_SelfColumn_label\"));";
  protected final String TEXT_278 = NL + "\t\t\t\tselfColumn.setResizable(true);" + NL
  ...
  protected final String TEXT_282 = "));" + NL + "" + NL + "\t\t\t\tcreateContextMenuFor(treeViewerWithColumns);" + NL
      + "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
      + "\t\t\t\tsetPageText(pageIndex, getString(\"_UI_TreeWithColumnsPage_label\"));";
  protected final String TEXT_283 = NL + "\t\t\t}";
  protected final String TEXT_284 = NL + "\t\t\tTree tree = new Tree(getContainer(), SWT.MULTI);";
  protected final String TEXT_285 = NL + "            // begin-extension-code" + NL
      ...
      + "            // end-extension-code";
  protected final String TEXT_286 = NL + "            selectionViewer = new TreeViewer(tree);";
  protected final String TEXT_287 = "\t\t" + NL + "\t\t\tsetCurrentViewer(selectionViewer);" + NL + "" + NL
  ...
  protected final String TEXT_290 = "));"
      ...
      + "\t\t\tsetPageText(pageIndex, getString(\"_UI_SelectionPage_label\"));";
  protected final String TEXT_291 = NL + NL + "\t\t\tgetSite().getShell().getDisplay().asyncExec" + NL
  ...
  protected final String TEXT_293 = NL + "\t\t\t\tpublic void controlResized(ControlEvent event)" + NL + "\t\t\t\t{"
  ...
  protected final String TEXT_294 = NL + "\t\t\tif (getContainer() instanceof CTabFolder)" + NL + "\t\t\t{" + NL
  ...
  protected final String TEXT_295 = NL + "\t\t\tif (getContainer() instanceof CTabFolder)" + NL + "\t\t\t{" + NL
      + "\t\t\t\t((CTabFolder)getContainer()).setTabHeight(SWT.DEFAULT);" + NL
      + "\t\t\t\tPoint point = getContainer().getSize();" + NL
      + "\t\t\t\tgetContainer().setSize(point.x, point.y - 6);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + ""
      + NL + "\t/**" + NL + "\t * This is used to track the active viewer." + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_296 = NL + "\t@Override";
  protected final String TEXT_297 = NL + "\tprotected void pageChange(int pageIndex)" + NL + "\t{" + NL
  ...
  protected final String TEXT_303 = NL + "\tpublic Object getAdapter(Class key)" + NL + "\t{" + NL
  ...
  protected final String TEXT_304 = NL + "\t\telse if (key.equals(IGotoMarker.class))" + NL + "\t\t{" + NL
      + "\t\t\treturn this;" + NL + "\t\t}";
  protected final String TEXT_305 = NL + "\t\telse" + NL + "\t\t{" + NL + "\t\t\treturn super.getAdapter(key);" + NL
      + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
      ...
      + "\t\tif (contentOutlinePage == null)" + NL + "\t\t{" + NL + "\t\t\t// The content outline is just a tree." + NL
      + "\t\t\t//" + NL + "\t\t\tclass MyContentOutlinePage extends ContentOutlinePage" + NL + "\t\t\t{";
  protected final String TEXT_306 = NL + "\t\t\t\t@Override";
  protected final String TEXT_307 = NL + "\t\t\t\tpublic void createControl(Composite parent)" + NL + "\t\t\t\t{" + NL
      + "\t\t\t\t\tsuper.createControl(parent);" + NL + "\t\t\t\t\tcontentOutlineViewer = getTreeViewer();" + NL
      + "\t\t\t\t\tcontentOutlineViewer.addSelectionChangedListener(this);\t\t\t\t\t";
  protected final String TEXT_308 = NL + "                    // begin-extension-code" + NL
      + "                    viewers.add(contentOutlineViewer);" + NL + "                    // end-extension-code"
      + NL + "\t\t\t\t\tfor (";
  protected final String TEXT_309 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\t\t\t\tfor (";
  protected final String TEXT_310 = " filterAction : viewerFilterActions.get(resource)) {" + NL
      + "\t\t\t\t\t\t\tfilterAction.addViewer(contentOutlineViewer);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}  ";
  protected final String TEXT_311 = "\t\t\t\t\t\t\t\t\t\t" + NL + "" + NL + "\t\t\t\t\t// Set up the tree viewer." + NL
      + "\t\t\t\t\t//" + NL
  ...
  protected final String TEXT_318 = NL + "\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL + "\t\t\t\t{"
  ...
  protected final String TEXT_321 = NL + "                    // begin-extension-code             " + NL
      + "                    viewers.remove(contentOutlineViewer);                   " + NL
      + "                    // end-extension-code\t\t\t\t\t" + NL + "\t\t\t\t\tfor (";
  protected final String TEXT_322 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\t\t\t\tfor (";
  protected final String TEXT_323 = " filterAction : viewerFilterActions.get(resource)) {" + NL
      + "\t\t\t\t\t\t\tfilterAction.removeViewer(contentOutlineViewer);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}";
  protected final String TEXT_324 = "\t\t\t\t\t" + NL + "\t\t\t\t\tsuper.dispose();" + NL + "\t\t\t\t}\t\t\t\t" + NL
  ...
  protected final String TEXT_329 = NL + "\t\t\t\t\tpublic void setSelectionToViewer(";
  protected final String TEXT_330 = " selection)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_331 = ".this.setSelectionToViewer(selection);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_332 = ".this.setFocus();" + NL + "\t\t\t\t\t}" + NL;
  protected final String TEXT_333 = NL + "\t\t\t\t\t@Override";
  protected final String TEXT_334 = NL + "\t\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL
      + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tsuper.setActionBars(actionBars);" + NL
      + "\t\t\t\t\t\tgetActionBarContributor().shareGlobalActions(this, actionBars);" + NL + "\t\t\t\t\t}" + NL
      + "\t\t\t\t};" + NL
  ...
  protected final String TEXT_339 = " selectedElements = ((IStructuredSelection)selection).iterator();" + NL
  ...
  protected final String TEXT_342 = "();" + NL + "\t\t\t\t\tselectionList.add(selectedElement);" + NL
  ...
  protected final String TEXT_345 = "();" + NL + "\t\t\t\tselectionList.add(selectedElement);" + NL
      + "\t\t\t\twhile (selectedElements.hasNext())" + NL + "\t\t\t\t{" + NL
      + "\t\t\t\t\tselectionList.add(selectedElements.next());" + NL + "\t\t\t\t}" + NL + "" + NL
      + "\t\t\t\t// Set the selection to the widget." + NL + "\t\t\t\t//" + NL
      + "\t\t\t\tselectionViewer.setSelection(new StructuredSelection(selectionList));";
  protected final String TEXT_346 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
  ...
  protected final String TEXT_348 = NL + "\tpublic boolean isDirty()" + NL + "\t{" + NL
  ...
  protected final String TEXT_350 = NL + "\tpublic void doSave(IProgressMonitor progressMonitor)" + NL + "\t{" + NL
  ...
  protected final String TEXT_359 = "(IProgressMonitor monitor)" + NL + "\t\t\t\t{" + NL
  ...
  protected final String TEXT_363 = NL + "\t\t\t\t\t\tResource resource = (Resource)i.next();";
  protected final String TEXT_364 = NL
      + "\t\t\t\t\t\tif ((first || !resource.getContents().isEmpty() || isPersisted(resource)) && !editingDomain.isReadOnly(resource))"
      + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\ttry" + NL + "\t\t\t\t\t\t\t{";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\tlong timeStamp = resource.getTimeStamp();" + NL
      + "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
      + "\t\t\t\t\t\t\t\tif (resource.getTimeStamp() != timeStamp)" + NL + "\t\t\t\t\t\t\t\t{" + NL
      + "\t\t\t\t\t\t\t\t\tsavedResources.add(resource);" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_366 = NL + "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
      + "\t\t\t\t\t\t\t\tsavedResources.add(resource);";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcatch (Exception exception)" + NL
      + "\t\t\t\t\t\t\t{" + NL
      + "\t\t\t\t\t\t\t\tresourceToDiagnosticMap.put(resource, analyzeResourceProblems(resource, exception));" + NL
      ...
      + "\t\t\tfirePropertyChange(IEditorPart.PROP_DIRTY);" + NL + "\t\t}" + NL + "\t\tcatch (Exception exception)"
      + NL + "\t\t{" + NL + "\t\t\t// Something went wrong that shouldn't." + NL + "\t\t\t//" + NL + "\t\t\t";
  protected final String TEXT_368 = ".INSTANCE.log(exception);"
      ...
      + NL + "\t\t\t// Ignore" + NL + "\t\t}" + NL + "\t\treturn result;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
  ...
  protected final String TEXT_370 = NL + "\tpublic boolean isSaveAsAllowed()" + NL + "\t{" + NL + "\t\treturn true;"
  ...
  protected final String TEXT_374 = "(getSite().getShell(), null, SWT.NONE)" + NL + "\t\t\t{";
  protected final String TEXT_375 = NL + "\t\t\t\t@Override";
  protected final String TEXT_376 = NL + "\t\t\t\tprotected boolean isSave()" + NL + "\t\t\t\t{" + NL
      + "\t\t\t\t\treturn true;" + NL + "\t\t\t\t}" + NL;
  protected final String TEXT_377 = NL + "\t\t\t\t@Override";
  protected final String TEXT_378 = NL + "\t\t\t\tprotected boolean processResources()" + NL + "\t\t\t\t{" + NL
      + "\t\t\t\t\t";
  protected final String TEXT_379 = " uris = getURIs();" + NL + "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{"
      + NL + "\t\t\t\t\t\tURI uri = ";
  protected final String TEXT_380 = "uris.get(0);" + NL + "\t\t\t\t\t\tdoSaveAs(uri, new ";
  protected final String TEXT_381 = "(uri));" + NL + "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
      + "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
      + "\t\t\t\t}" + NL + "\t\t\t}.open();";
  protected final String TEXT_382 = NL + "\t\tString[] filters = ";
  protected final String TEXT_383 = "(String[])";
  protected final String TEXT_384 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);" + NL
      + "\t\tString[] files = ";
  protected final String TEXT_385 = ".openFilePathDialog(getSite().getShell(), ";
  protected final String TEXT_386 = ".SAVE, filters);" + NL + "\t\tif (files.length > 0)" + NL + "\t\t{" + NL
  ...
  protected final String TEXT_388 = NL
      ...
      + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_389 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
      + "\tprotected void doSaveAs(URI uri, IEditorInput editorInput)" + NL + "\t{" + NL + "\t\t(";
  protected final String TEXT_390 = "(Resource)";
  protected final String TEXT_391 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);" + NL
  ...
  protected final String TEXT_392 = "();" + NL + "\t\tdoSave(progressMonitor);" + NL + "\t}";
  protected final String TEXT_393 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
      ...
      + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_394 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_395 = NL + NL + "\t/**" + NL + "\t * This is called during startup." + NL
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_396 = NL + "\t@Override";
  protected final String TEXT_397 = NL + "\tpublic void init(IEditorSite site, IEditorInput editorInput)" + NL + "\t{"
  ...
  protected final String TEXT_399 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_400 = NL + "\t@Override";
  protected final String TEXT_401 = NL + "\tpublic void setFocus()" + NL + "\t{";
  protected final String TEXT_402 = NL + "\t\tif (currentViewerPane != null)" + NL + "\t\t{" + NL
      + "\t\t\tcurrentViewerPane.setFocus();" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{" + NL
      + "\t\t\tgetControl(getActivePage()).setFocus();" + NL + "\t\t}";
  protected final String TEXT_403 = NL + "\t\tgetControl(getActivePage()).setFocus();";
  ...
  protected final String TEXT_405 = NL + "\t\tfor (ISelectionChangedListener listener : selectionChangedListeners)";
  protected final String TEXT_406 = NL
      + "\t\tfor (Iterator listeners = selectionChangedListeners.iterator(); listeners.hasNext(); )";
  protected final String TEXT_407 = NL + "\t\t{";
  protected final String TEXT_408 = NL
      + "\t\t\tISelectionChangedListener listener = (ISelectionChangedListener)listeners.next();";
  protected final String TEXT_409 = NL + "\t\t\tlistener.selectionChanged(new SelectionChangedEvent(this, selection));"
  ...
  protected final String TEXT_410 = " collection = ((IStructuredSelection)selection).toList();" + NL
  ...
  protected final String TEXT_413 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
      + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tstatusLineManager.setMessage(\"\");";
  protected final String TEXT_414 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
      + "\t * This looks up a string in the plugin's plugin.properties file." + NL + "\t * <!-- begin-user-doc -->"
      + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
      + "\tprivate static String getString(String key)" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_415 = ".INSTANCE.getString(key);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
  ...
  protected final String TEXT_416 = ".INSTANCE.getString(key, new Object [] { s1 });"
      ...
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
      + "\tpublic AdapterFactory getAdapterFactory()" + NL + "\t{" + NL + "\t\treturn adapterFactory;" + NL + "\t}"
      + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL
      + "\t * @generated" + NL + "\t */";
  protected final String TEXT_417 = NL + "\t@Override";
  protected final String TEXT_418 = NL + "\tpublic void dispose()" + NL + "\t{" + NL
  ...
  protected final String TEXT_420 = NL + "\t\tgetSite().getPage().removePartListener(partListener);" + NL + "" + NL
      + "\t\tadapterFactory.dispose();\t\t";
  protected final String TEXT_421 = NL + NL + "\t\t// Clean and dispose viewerFilterActions" + NL + "\t\tfor (";
  protected final String TEXT_422 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\tfor (";
  protected final String TEXT_423 = " filterAction : viewerFilterActions.get(resource)) {" + NL
      + "\t\t\t\tfilterAction.removePropertyChangeListener((";
  protected final String TEXT_424 = ") getActionBarContributor());" + NL + "\t\t\t\tfilterAction.dispose();" + NL
  ...
  protected final String TEXT_426 = "\t\t" + NL + "" + NL
      ...
      + "\t\t\tcontentOutlinePage.dispose();" + NL + "\t\t}" + NL + "" + NL + "\t\tsuper.dispose();" + NL + "\t}" + NL
      + "" + NL + "\t/**" + NL + "\t * Returns whether the outline view should be presented to the user." + NL
      + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
