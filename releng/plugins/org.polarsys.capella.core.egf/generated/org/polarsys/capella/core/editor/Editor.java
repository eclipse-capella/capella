...
public class Editor extends org.polarsys.kitalpha.emde.egf.editor.Editor {
	...
	protected final String TEXT_43 = NL + " *" + NL + " * <!-- begin-capella-code -->" + NL
			+ " * @implements ITabbedPropertySheetPageContributor" + NL + " * <!-- end-capella-code -->" + NL + " *"
			+ NL + " * @generated" + NL + " */";
	...
	protected final String TEXT_428 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());"
