...
public class Plugin extends org.eclipse.egf.emf.pattern.edit.Plugin {
	...
	protected final String TEXT_31 = ");"
			...
			+ NL + "\t\t *" + NL
			+ "\t\t * @param key the identifier of the object." + NL
			+ "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t@Override" + NL
			+ "\t\tpublic Object getImage(String key) {" + NL + "\t\t\treturn ";
	protected final String TEXT_32 = ".find(this.getBundle(), new ";
	protected final String TEXT_33 = "(\"icons/\" + key + \".gif\"), null);"
			+ NL + "\t\t}" + NL + "\t\t//end-capella-code" + NL + "\t}" + NL;
	...
	protected final String TEXT_37 = ".class);" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Override" + NL
	...
	protected final String TEXT_45 = " if (\"_UI_Unknown_type\".equals(key)) return PROPERTIES.unknownType();"
			+ NL
	...
	protected final String TEXT_74 = ".class);" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\t@Override" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if (genModel.getRuntimePlatform() != GenRuntimePlatform.GWT) {
			...
			stringBuffer.append(genModel
					.getImportedName("org.eclipse.core.runtime.FileLocator"));
