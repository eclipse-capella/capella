...
public class Plugin extends org.eclipse.egf.emf.pattern.edit.Plugin {
  ...
  protected final String TEXT_15 = NL + "\t/**" + NL + "\t * Create the instance." + NL + "\t * <!-- begin-user-doc -->"
  ...
  protected final String TEXT_25 = NL + "\t/**" + NL + "\t * Returns the singleton instance of the Eclipse plugin." + NL
  ...
  protected final String TEXT_31 = ");" + NL + "" + NL + "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL
      + "\t\t\tplugin = this;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t//begin-capella-code" + NL + "\t\t/**" + NL
  ...
  protected final String TEXT_32 = ".find(this.getBundle(), new ";
  protected final String TEXT_33 = "(\"icons/\" + key + \".gif\"), null);" + NL + "\t\t}" + NL
  ...
  protected final String TEXT_37 = ".class);" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
  ...
  protected final String TEXT_45 = " if (\"_UI_Unknown_type\".equals(key)) return PROPERTIES.unknownType();" + NL
  ...
  protected final String TEXT_71 = "if (\"_UI_PropertyDescriptor_description\".equals(key)) return PROPERTIES.propertyDescriptorDescription(substitutions[0], substitutions[1]);"
  ...
  protected final String TEXT_74 = ".class);" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
      + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t@Override" + NL
