...
public class FactoryImplCreateAndSetName {
    ...
    protected final String TEXT_2 = "\t" + NL + "\t/**" + NL + "\t * Creates class and sets its name" + NL + "\t * (This method comes from a customization of the standard EMF generator)" + NL + "\t *"
            + NL + "\t * @param name_p : default name of created element" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
