...
public class PluginProperties extends org.polarsys.kitalpha.emde.egf.editor.PluginProperties {
  ...
  protected final String TEXT_3 = " Editor (Incubation)" + NL + "providerName = Eclipse.org" + NL;
  ...
  protected final String TEXT_11 = NL + NL + "_UI_NoObjectSelected = Selected Nothing" + NL
      ...
      + "" + NL + "_UI_OpenEditorError_label = Open Editor" + NL + "" + NL + "_UI_MDEToolkit_Wizard_category = Capella"
  ...
  protected final String TEXT_19 = " Model Editor" + NL + "_UI_";
  protected final String TEXT_20 = "ModelSearchEngine_Label=";
  protected final String TEXT_21 = " Search Engine" + NL + "" + NL + "_UI_";
  protected final String TEXT_22 = "FilenameDefaultBase = My" + NL + "_UI_";
  protected final String TEXT_23 = "FilenameExtensions = ";
  protected final String TEXT_24 = NL;
  protected final String TEXT_25 = NL + "_UI_Wizard_label = New" + NL + "" + NL
  ...
  protected final String TEXT_32 = NL + NL + "_UI_Browse_label = &Browse..." + NL + "_UI_File_label = &File" + NL
  ...
  protected final String TEXT_33 = " Application" + NL + "_UI_Menu_File_label = &File" + NL
      ...
      + "_UI_Menu_OpenURI_description = Opens a model object loading it from a URI" + NL
      + "_UI_Menu_Edit_label = &Edit" + NL + "_UI_Menu_Window_label = &Window" + NL + "_UI_Menu_Help_label = &Help"
      + NL + "_UI_Menu_About_label = ";
  ...
  protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
    ...
    for (GenPackage genPackage : genModel.getAllGenPackagesWithClassifiers()) {
      ...
      stringBuffer.append(genPackage.isMultipleFileExtensions() ? genPackage.getFileExtensions() : genPackage
          .getFileExtension());
