...
public class TestClass extends org.eclipse.egf.emf.pattern.base.GenClassJava {
	...
	protected final String TEXT_1 = "/**" + NL
			+ " * Copyright (c) THALES 2007, 2009. All rights reserved." + NL
			+ " */" + NL + "package ";
	...
	protected final String TEXT_4 = NL
			+ "import org.polarsys.capella.core.data.ctx.CtxFactory;" + NL
	...
	protected final String TEXT_6 = NL
			+ "import org.polarsys.capella.core.data.fa.FaFactory;" + NL
	...
	protected final String TEXT_13 = ";"
			...
			+ ""
			+ NL
			+ "import org.polarsys.capella.core.model.tests.ju.CapellaModelAbstractTest;"
			+ NL
			+ "import org.polarsys.capella.core.model.tests.ju.CapellaModelAbstractTestSuite;"
			+ NL;
	protected final String TEXT_14 = "/**" + NL
			+ " * Class generated by SolFa." + NL
			+ " * This code shall not be modified manually." + NL + " *" + NL
			+ " * @generated" + NL + " */" + NL + "public class Test_";
	protected final String TEXT_15 = " extends CapellaModelAbstractTest {" + NL
			+ "" + NL + "  /**" + NL + "   * Constructor" + NL
			+ "   * @param testSuite_p" + NL + "   * @generated" + NL + "   */"
			+ NL + "  public Test_";
	protected final String TEXT_16 = "(CapellaModelAbstractTestSuite testSuite_p) {"
			+ NL
			+ "    super(testSuite_p);"
			+ NL
			+ "  }"
			...
			+ NL
			+ "  public void test_";
	protected final String TEXT_17 = "() {" + NL + "    testCreateElement();"
			+ NL + "  }" + NL + "" + NL + "  /**" + NL
			+ "   * @param container_p" + NL + "   * @generated" + NL + "   */"
			+ NL + "  @Override" + NL
	...
	protected final String TEXT_69 = NL
			...
			+ "  /**"
			+ NL
			+ "   * @see org.polarsys.capella.test.common.ju.AbstractCapellaTest#getTestName()"
			+ NL + "   * @generated" + NL + "   */" + NL + "  @Override" + NL
			+ "  protected String getTestName() {" + NL + "    return \"test_";
	protected final String TEXT_70 = "\"; //$NON-NLS-1$" + NL + "  }" + NL
			+ "}" + NL;
	...
	protected void method_setReporterVariables(final StringBuffer stringBuffer,
		...
		generatedSourceFolderPath = (String) ctx
				.getValue("generatedSourceFolderPath");
	...
	protected void method_generatePackage(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "generatePackage",
				stringBuffer.toString());
	}

	protected void method_generateImports(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {

		if (eclassCondition.equals("TraceableElement")) {
			stringBuffer.append(TEXT_3);
		} else if (eclassCondition.equals("InvolverElement")
				|| eclassCondition.equals("InvolvedElement")) {
			...
			stringBuffer.append(TEXT_6);
				...
				|| eclassCondition.equals("InformationsReceiver")) {
		} else if (eclassCondition.equals("ActivityNode")) {
			stringBuffer.append(TEXT_7);
		} else if (eclassCondition.equals("InvolverElement")
				|| eclassCondition.equals("GeneralizableElement")) {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "generateImports",
				stringBuffer.toString());
	}

	protected void method_generateContents(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "generateContents",
				stringBuffer.toString());
	}
