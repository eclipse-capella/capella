//Generated on Wed Jun 25 16:57:24 CEST 2014 with EGF 1.2.0.v20140623-0645
...
public class TestSuiteClass extends
	...
	protected final String TEXT_3 = "import java.util.ArrayList;"
			...
			+ ""
			+ NL
			+ "import org.polarsys.capella.test.common.IExtendedTest;"
			+ NL
			+ "import org.polarsys.capella.core.model.tests.ju.CapellaModelAbstractTestSuite;"
			+ NL + "" + NL + "import junit.framework.Test;" + NL + NL;
	protected final String TEXT_4 = "/**" + NL + " * ";
	protected final String TEXT_5 = " Cross Referencing test suite." + NL
			+ " * " + NL + " * Class generated by SolFa." + NL
			+ " * This code shall not be modified manually." + NL + " *" + NL
			+ " * @generated" + NL + " */" + NL + "public class ";
	protected final String TEXT_6 = "_CrossReferencingTestSuite extends CapellaModelAbstractTestSuite {"
			+ NL
			+ "  /**"
			+ NL
			+ "   * @see org.polarsys.capella.test.common.ju.AbstractCapellaTestSuite#getTests()"
			+ NL
			+ "   * @generated"
			+ NL
			+ "   */"
			...
			+ "  @Override"
			+ NL
			+ "  protected List<IExtendedTest> getTests() {"
			+ NL
			+ "    ArrayList<IExtendedTest> tests = new ArrayList<IExtendedTest>(1);"
			+ NL + NL;
	protected final String TEXT_7 = NL
			...
			+ NL + "   * @generated" + NL + "   */" + NL
			+ "  public static Test suite() {" + NL + "    return new ";
	protected final String TEXT_8 = "_CrossReferencingTestSuite();" + NL
			+ "  }" + NL + "}" + NL;
	...
	protected void method_beginClass(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "beginClass",
				stringBuffer.toString());
	}

	protected void method_endClass(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "endClass",
				stringBuffer.toString());
	}
}