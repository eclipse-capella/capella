...
/**
 * A pattern-specific query specification that can instantiate CatalogElement__referencedElementsMatcher in a type-safe way.
 * 
 * @see CatalogElement__referencedElementsMatcher
 * @see CatalogElement__referencedElementsMatch
 * 
 */
@SuppressWarnings("all")
public final class CatalogElement__referencedElementsQuerySpecification extends BaseGeneratedEMFQuerySpecification<CatalogElement__referencedElementsMatcher> {
  private CatalogElement__referencedElementsQuerySpecification() {
   ...
   * 
   */
  public static CatalogElement__referencedElementsQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected CatalogElement__referencedElementsMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return CatalogElement__referencedElementsMatcher.on(engine);
  }
  
  @Override
  public CatalogElement__referencedElementsMatcher instantiate() throws ViatraQueryException {
    return CatalogElement__referencedElementsMatcher.create();
  }
  
  @Override
  public CatalogElement__referencedElementsMatch newEmptyMatch() {
    return CatalogElement__referencedElementsMatch.newEmptyMatch();
  }
  
  @Override
  public CatalogElement__referencedElementsMatch newMatch(final Object... parameters) {
    return CatalogElement__referencedElementsMatch.newMatch((org.polarsys.capella.common.re.CatalogElement) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CatalogElement__referencedElementsQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CatalogElement__referencedElementsQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static CatalogElement__referencedElementsQuerySpecification INSTANCE = new CatalogElement__referencedElementsQuerySpecification();
