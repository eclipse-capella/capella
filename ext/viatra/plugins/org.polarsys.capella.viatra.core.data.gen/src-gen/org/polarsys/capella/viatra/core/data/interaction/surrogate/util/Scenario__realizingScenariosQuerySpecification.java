...
/**
 * A pattern-specific query specification that can instantiate Scenario__realizingScenariosMatcher in a type-safe way.
 * 
 * @see Scenario__realizingScenariosMatcher
 * @see Scenario__realizingScenariosMatch
 * 
 */
@SuppressWarnings("all")
public final class Scenario__realizingScenariosQuerySpecification extends BaseGeneratedEMFQuerySpecification<Scenario__realizingScenariosMatcher> {
  private Scenario__realizingScenariosQuerySpecification() {
   ...
   * 
   */
  public static Scenario__realizingScenariosQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected Scenario__realizingScenariosMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return Scenario__realizingScenariosMatcher.on(engine);
  }
  
  @Override
  public Scenario__realizingScenariosMatcher instantiate() throws ViatraQueryException {
    return Scenario__realizingScenariosMatcher.create();
  }
  
  @Override
  public Scenario__realizingScenariosMatch newEmptyMatch() {
    return Scenario__realizingScenariosMatch.newEmptyMatch();
  }
  
  @Override
  public Scenario__realizingScenariosMatch newMatch(final Object... parameters) {
    return Scenario__realizingScenariosMatch.newMatch((org.polarsys.capella.core.data.interaction.Scenario) parameters[0], (org.polarsys.capella.core.data.interaction.Scenario) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Scenario__realizingScenariosQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Scenario__realizingScenariosQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Scenario__realizingScenariosQuerySpecification INSTANCE = new Scenario__realizingScenariosQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static Scenario__realizingScenariosQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_sr, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/interaction/1.3.0", "ScenarioRealization", "realizingScenario")));
