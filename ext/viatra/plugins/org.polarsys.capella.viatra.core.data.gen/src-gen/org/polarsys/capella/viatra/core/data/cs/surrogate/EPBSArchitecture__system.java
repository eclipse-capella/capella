...
public final class EPBSArchitecture__system extends BaseGeneratedEMFQuerySpecification<EPBSArchitecture__system.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link EPBSArchitecture__system} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EPBSArchitecture__system#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "EPBSArchitecture", "ownedConfigurationItemPkg")));
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_0_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItemPkg")));
          new Equality(body, var__virtual_0_, var_pckg);
          // 	ConfigurationItemPkg.ownedConfigurationItems(pckg, target)
          new TypeConstraint(body, Tuples.flatTupleOf(var_pckg), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItemPkg")));
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new TypeConstraint(body, Tuples.flatTupleOf(var_pckg, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItemPkg", "ownedConfigurationItems")));
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_1_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItem")));
