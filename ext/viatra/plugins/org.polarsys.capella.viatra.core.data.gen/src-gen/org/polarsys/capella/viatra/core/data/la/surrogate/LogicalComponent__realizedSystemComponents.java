...
public final class LogicalComponent__realizedSystemComponents extends BaseGeneratedEMFQuerySpecification<LogicalComponent__realizedSystemComponents.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link LogicalComponent__realizedSystemComponents} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalComponent__realizedSystemComponents#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/cs/7.0.0", "Component", "realizedComponents")));
