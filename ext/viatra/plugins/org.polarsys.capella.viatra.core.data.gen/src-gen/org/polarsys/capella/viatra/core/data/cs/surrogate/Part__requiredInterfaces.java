...
public final class Part__requiredInterfaces extends BaseGeneratedEMFQuerySpecification<Part__requiredInterfaces.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link Part__requiredInterfaces} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Part__requiredInterfaces#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_component, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/cs/7.0.0", "Component", "requiredInterfaces")));
