      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/1.4.0", "InformationsExchanger", "outgoingInformationFlows")));
              ...
              new TypeConstraint(body, new FlatTuple(var_ce, var__virtual_3_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/fa/1.4.0", "ComponentExchange", "targetPort")));
