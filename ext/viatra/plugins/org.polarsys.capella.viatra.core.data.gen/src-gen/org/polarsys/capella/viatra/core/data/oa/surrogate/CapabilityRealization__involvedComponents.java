...
public final class CapabilityRealization__involvedComponents extends BaseGeneratedEMFQuerySpecification<CapabilityRealization__involvedComponents.Matcher> {
  /**
   * Pattern-specific match representation of the org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents";
    }
  ...
  /**
   * Generated pattern matcher API of the org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents (visibility: PUBLIC, simpleName: CapabilityRealization__involvedComponents, identifier: org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.oa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents (visibility: PUBLIC, simpleName: CapabilityRealization__involvedComponents, identifier: org.polarsys.capella.viatra.core.data.oa.surrogate.CapabilityRealization__involvedComponents, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.oa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/common/5.0.0", "CapabilityRealizationInvolvedElement")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_involvements, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/common/5.0.0", "CapabilityRealizationInvolvement", "involvedCapabilityRealizationInvolvedElement")));
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_1_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/common/5.0.0", "CapabilityRealizationInvolvedElement")));
