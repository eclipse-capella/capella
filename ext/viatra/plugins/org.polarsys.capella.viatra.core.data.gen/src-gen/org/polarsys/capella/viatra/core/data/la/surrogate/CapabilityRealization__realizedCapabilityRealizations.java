...
public final class CapabilityRealization__realizedCapabilityRealizations extends BaseGeneratedEMFQuerySpecification<CapabilityRealization__realizedCapabilityRealizations.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link CapabilityRealization__realizedCapabilityRealizations} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityRealization__realizedCapabilityRealizations#instance()}.
   * 
