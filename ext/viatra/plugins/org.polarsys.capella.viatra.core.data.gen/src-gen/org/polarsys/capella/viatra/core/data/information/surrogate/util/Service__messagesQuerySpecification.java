...
/**
 * A pattern-specific query specification that can instantiate Service__messagesMatcher in a type-safe way.
 * 
 * @see Service__messagesMatcher
 * @see Service__messagesMatch
 * 
 */
@SuppressWarnings("all")
public final class Service__messagesQuerySpecification extends BaseGeneratedEMFQuerySpecification<Service__messagesMatcher> {
  private Service__messagesQuerySpecification() {
   ...
   * 
   */
  public static Service__messagesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected Service__messagesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return Service__messagesMatcher.on(engine);
  }
  
  @Override
  public Service__messagesMatcher instantiate() throws ViatraQueryException {
    return Service__messagesMatcher.create();
  }
  
  @Override
  public Service__messagesMatch newEmptyMatch() {
    return Service__messagesMatch.newEmptyMatch();
  }
  
  @Override
  public Service__messagesMatch newMatch(final Object... parameters) {
    return Service__messagesMatch.newMatch((org.polarsys.capella.core.data.information.Service) parameters[0], (org.polarsys.capella.core.data.information.communication.Message) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service__messagesQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service__messagesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Service__messagesQuerySpecification INSTANCE = new Service__messagesQuerySpecification();
