...
/**
 * A pattern-specific query specification that can instantiate DataType__nullValueMatcher in a type-safe way.
 * 
 * @see DataType__nullValueMatcher
 * @see DataType__nullValueMatch
 * 
 */
@SuppressWarnings("all")
public final class DataType__nullValueQuerySpecification extends BaseGeneratedEMFQuerySpecification<DataType__nullValueMatcher> {
  private DataType__nullValueQuerySpecification() {
   ...
   * 
   */
  public static DataType__nullValueQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DataType__nullValueMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DataType__nullValueMatcher.on(engine);
  }
  
  @Override
  public DataType__nullValueMatcher instantiate() throws ViatraQueryException {
    return DataType__nullValueMatcher.create();
  }
  
  @Override
  public DataType__nullValueMatch newEmptyMatch() {
    return DataType__nullValueMatch.newEmptyMatch();
  }
  
  @Override
  public DataType__nullValueMatch newMatch(final Object... parameters) {
    return DataType__nullValueMatch.newMatch((org.polarsys.capella.core.data.information.datatype.DataType) parameters[0], (org.polarsys.capella.core.data.information.datavalue.DataValue) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataType__nullValueQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataType__nullValueQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DataType__nullValueQuerySpecification INSTANCE = new DataType__nullValueQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static DataType__nullValueQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
