...
/**
 * A pattern-specific query specification that can instantiate Scenario__realizedScenariosMatcher in a type-safe way.
 * 
 * @see Scenario__realizedScenariosMatcher
 * @see Scenario__realizedScenariosMatch
 * 
 */
@SuppressWarnings("all")
public final class Scenario__realizedScenariosQuerySpecification extends BaseGeneratedEMFQuerySpecification<Scenario__realizedScenariosMatcher> {
  private Scenario__realizedScenariosQuerySpecification() {
   ...
   * 
   */
  public static Scenario__realizedScenariosQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected Scenario__realizedScenariosMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return Scenario__realizedScenariosMatcher.on(engine);
  }
  
  @Override
  public Scenario__realizedScenariosMatcher instantiate() throws ViatraQueryException {
    return Scenario__realizedScenariosMatcher.create();
  }
  
  @Override
  public Scenario__realizedScenariosMatch newEmptyMatch() {
    return Scenario__realizedScenariosMatch.newEmptyMatch();
  }
  
  @Override
  public Scenario__realizedScenariosMatch newMatch(final Object... parameters) {
    return Scenario__realizedScenariosMatch.newMatch((org.polarsys.capella.core.data.interaction.Scenario) parameters[0], (org.polarsys.capella.core.data.interaction.Scenario) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Scenario__realizedScenariosQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Scenario__realizedScenariosQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static Scenario__realizedScenariosQuerySpecification INSTANCE = new Scenario__realizedScenariosQuerySpecification();
