...
public final class InterfaceUse extends BaseGeneratedPatternGroup {
   ...
   * 
   */
  public static InterfaceUse instance() throws ViatraQueryException {
    if (INSTANCE == null) {
  ...
  private InterfaceUse() throws ViatraQueryException {
    querySpecifications.add(InterfaceUse__interfaceUserQuerySpecification.instance());
  }
  
  public InterfaceUse__interfaceUserQuerySpecification getInterfaceUse__interfaceUser() throws ViatraQueryException {
    return InterfaceUse__interfaceUserQuerySpecification.instance();
  }
  
  public InterfaceUse__interfaceUserMatcher getInterfaceUse__interfaceUser(final ViatraQueryEngine engine) throws ViatraQueryException {
