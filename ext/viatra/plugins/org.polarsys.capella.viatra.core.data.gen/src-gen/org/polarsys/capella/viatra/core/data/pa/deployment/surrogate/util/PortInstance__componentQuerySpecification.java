...
public final class PortInstance__componentQuerySpecification extends BaseGeneratedEMFQuerySpecification<PortInstance__componentMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pSelf = new PParameter("self", "org.polarsys.capella.core.data.pa.deployment.PortInstance", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "PortInstance")), PParameterDirection.INOUT);
    
    private final PParameter parameter_pTarget = new PParameter("target", "org.polarsys.capella.core.data.pa.deployment.ComponentInstance", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "ComponentInstance")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "PortInstance")));
              new TypeConstraint(body, new FlatTuple(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "ComponentInstance")));
              ...
              new TypeConstraint(body, new FlatTuple(var_target, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "ComponentInstance", "portInstances")));
              new TypeConstraint(body, new FlatTuple(var__virtual_0_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/deployment/1.4.0", "PortInstance")));
