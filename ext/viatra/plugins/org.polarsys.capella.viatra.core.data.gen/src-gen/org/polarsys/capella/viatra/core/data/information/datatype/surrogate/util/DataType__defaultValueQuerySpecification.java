...
/**
 * A pattern-specific query specification that can instantiate DataType__defaultValueMatcher in a type-safe way.
 * 
 * @see DataType__defaultValueMatcher
 * @see DataType__defaultValueMatch
 * 
 */
@SuppressWarnings("all")
public final class DataType__defaultValueQuerySpecification extends BaseGeneratedEMFQuerySpecification<DataType__defaultValueMatcher> {
  private DataType__defaultValueQuerySpecification() {
   ...
   * 
   */
  public static DataType__defaultValueQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected DataType__defaultValueMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return DataType__defaultValueMatcher.on(engine);
  }
  
  @Override
  public DataType__defaultValueMatcher instantiate() throws ViatraQueryException {
    return DataType__defaultValueMatcher.create();
  }
  
  @Override
  public DataType__defaultValueMatch newEmptyMatch() {
    return DataType__defaultValueMatch.newEmptyMatch();
  }
  
  @Override
  public DataType__defaultValueMatch newMatch(final Object... parameters) {
    return DataType__defaultValueMatch.newMatch((org.polarsys.capella.core.data.information.datatype.DataType) parameters[0], (org.polarsys.capella.core.data.information.datavalue.DataValue) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataType__defaultValueQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataType__defaultValueQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DataType__defaultValueQuerySpecification INSTANCE = new DataType__defaultValueQuerySpecification();
