...
public final class SystemAnalysis__containedCapabilityPkgQuerySpecification extends BaseGeneratedEMFQuerySpecification<SystemAnalysis__containedCapabilityPkgMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pTarget = new PParameter("target", "org.polarsys.capella.core.data.ctx.CapabilityPkg", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/ctx/1.4.0", "CapabilityPkg")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/ctx/1.4.0", "CapabilityPkg")));
