      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_asr, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/common/1.4.0", "AbstractStateRealization", "realizedAbstractState")));
              ...
              new TypeConstraint(body, new FlatTuple(var_asr, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/common/1.4.0", "AbstractStateRealization", "realizingAbstractState")));
