...
public final class PhysicalPathReference__referencedPhysicalPath extends BaseGeneratedEMFQuerySpecification<PhysicalPathReference__referencedPhysicalPath.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.polarsys.capella.viatra.core.data.cs.surrogate.PhysicalPathReference__referencedPhysicalPath (visibility: PUBLIC, simpleName: PhysicalPathReference__referencedPhysicalPath, identifier: org.polarsys.capella.viatra.core.data.cs.surrogate.PhysicalPathReference__referencedPhysicalPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.cs.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.polarsys.capella.viatra.core.data.cs.surrogate.PhysicalPathReference__referencedPhysicalPath (visibility: PUBLIC, simpleName: PhysicalPathReference__referencedPhysicalPath, identifier: org.polarsys.capella.viatra.core.data.cs.surrogate.PhysicalPathReference__referencedPhysicalPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.cs.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_self = new PParameter("self", "org.polarsys.capella.core.data.cs.PhysicalPathReference", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/cs/1.4.0", "PhysicalPathReference")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/cs/1.4.0", "PhysicalPathReference")));
