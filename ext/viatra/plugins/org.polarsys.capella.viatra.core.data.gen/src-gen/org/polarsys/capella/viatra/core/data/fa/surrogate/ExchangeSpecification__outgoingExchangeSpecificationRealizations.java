...
public final class ExchangeSpecification__outgoingExchangeSpecificationRealizations extends BaseGeneratedEMFQuerySpecification<ExchangeSpecification__outgoingExchangeSpecificationRealizations.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.fa.ExchangeSpecificationRealization", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/fa/6.0.0", "ExchangeSpecificationRealization")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/fa/6.0.0", "ExchangeSpecificationRealization")));
