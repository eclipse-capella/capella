...
public final class ConfigurationItem__allocatedPhysicalArtifacts extends BaseGeneratedEMFQuerySpecification<ConfigurationItem__allocatedPhysicalArtifacts.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_self = new PParameter("self", "org.polarsys.capella.core.data.epbs.ConfigurationItem", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItem")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "ConfigurationItem")));
          ...
          // 	PhysicalArtifactRealization.sourceElement(par, self)
          new TypeConstraint(body, Tuples.flatTupleOf(var_par), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/7.0.0", "PhysicalArtifactRealization")));
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new TypeConstraint(body, Tuples.flatTupleOf(var_par, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/7.0.0", "AbstractTrace", "sourceElement")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_par, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/7.0.0", "AbstractTrace", "targetElement")));
