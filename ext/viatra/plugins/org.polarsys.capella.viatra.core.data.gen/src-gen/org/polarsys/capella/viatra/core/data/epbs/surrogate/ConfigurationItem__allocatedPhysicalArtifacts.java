...
public final class ConfigurationItem__allocatedPhysicalArtifacts extends BaseGeneratedEMFQuerySpecification<ConfigurationItem__allocatedPhysicalArtifacts.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_self = new PParameter("self", "org.polarsys.capella.core.data.epbs.ConfigurationItem", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/epbs/1.4.0", "ConfigurationItem")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/epbs/1.4.0", "ConfigurationItem")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_par, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/1.4.0", "AbstractTrace", "sourceElement")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_par, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/1.4.0", "AbstractTrace", "targetElement")));
