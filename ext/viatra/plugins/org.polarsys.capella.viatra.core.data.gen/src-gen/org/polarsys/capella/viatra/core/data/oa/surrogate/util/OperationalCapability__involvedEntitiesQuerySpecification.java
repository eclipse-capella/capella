      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_eoci, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/oa/1.4.0", "EntityOperationalCapabilityInvolvement", "entity")));
