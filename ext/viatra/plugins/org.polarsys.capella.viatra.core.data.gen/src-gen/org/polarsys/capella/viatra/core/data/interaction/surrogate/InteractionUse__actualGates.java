...
public final class InteractionUse__actualGates extends BaseGeneratedEMFQuerySpecification<InteractionUse__actualGates.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.polarsys.capella.viatra.core.data.interaction.surrogate.InteractionUse__actualGates (visibility: PUBLIC, simpleName: InteractionUse__actualGates, identifier: org.polarsys.capella.viatra.core.data.interaction.surrogate.InteractionUse__actualGates, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.interaction.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.polarsys.capella.viatra.core.data.interaction.surrogate.InteractionUse__actualGates (visibility: PUBLIC, simpleName: InteractionUse__actualGates, identifier: org.polarsys.capella.viatra.core.data.interaction.surrogate.InteractionUse__actualGates, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.interaction.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_self = new PParameter("self", "org.polarsys.capella.core.data.interaction.InteractionUse", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/interaction/5.0.0", "InteractionUse")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/interaction/5.0.0", "InteractionUse")));
