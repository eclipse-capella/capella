...
public final class Namespace__containedRequirementsTraces extends BaseGeneratedEMFQuerySpecification<Namespace__containedRequirementsTraces.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link Namespace__containedRequirementsTraces} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Namespace__containedRequirementsTraces#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.requirement.RequirementsTrace", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/requirement/7.0.0", "RequirementsTrace")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/requirement/7.0.0", "RequirementsTrace")));
