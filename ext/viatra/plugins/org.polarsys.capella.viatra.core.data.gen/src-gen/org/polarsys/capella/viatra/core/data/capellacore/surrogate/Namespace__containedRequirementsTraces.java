...
public final class Namespace__containedRequirementsTraces extends BaseGeneratedEMFQuerySpecification<Namespace__containedRequirementsTraces.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.requirement.RequirementsTrace", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/requirement/6.0.0", "RequirementsTrace")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/requirement/6.0.0", "RequirementsTrace")));
