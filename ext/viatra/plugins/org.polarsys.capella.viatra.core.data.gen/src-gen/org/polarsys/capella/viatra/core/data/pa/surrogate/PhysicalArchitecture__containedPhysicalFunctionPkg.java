...
public final class PhysicalArchitecture__containedPhysicalFunctionPkg extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture__containedPhysicalFunctionPkg.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture__containedPhysicalFunctionPkg} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture__containedPhysicalFunctionPkg#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.pa.PhysicalFunctionPkg", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/pa/5.0.0", "PhysicalFunctionPkg")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/5.0.0", "PhysicalFunctionPkg")));
