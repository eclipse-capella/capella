...
public final class PhysicalArchitecture__containedPhysicalFunctionPkg extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture__containedPhysicalFunctionPkg.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.pa.PhysicalFunctionPkg", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/pa/6.0.0", "PhysicalFunctionPkg")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/6.0.0", "PhysicalFunctionPkg")));
