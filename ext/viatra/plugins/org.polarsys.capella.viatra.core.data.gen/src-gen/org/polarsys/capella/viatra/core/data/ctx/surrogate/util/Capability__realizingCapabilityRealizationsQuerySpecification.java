      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_acr, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/1.4.0", "AbstractTrace", "targetElement")));
