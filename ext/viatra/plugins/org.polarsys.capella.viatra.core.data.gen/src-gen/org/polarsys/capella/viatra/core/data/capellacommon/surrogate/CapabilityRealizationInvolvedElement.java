...
public final class CapabilityRealizationInvolvedElement extends BaseGeneratedPatternGroup {
   ...
   * 
   */
  public static CapabilityRealizationInvolvedElement instance() throws ViatraQueryException {
    if (INSTANCE == null) {
  ...
  private CapabilityRealizationInvolvedElement() throws ViatraQueryException {
    querySpecifications.add(CapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvementsQuerySpecification.instance());
  }
  
  public CapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvementsQuerySpecification getCapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvements() throws ViatraQueryException {
    return CapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvementsQuerySpecification.instance();
  }
  
  public CapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvementsMatcher getCapabilityRealizationInvolvedElement__involvingCapabilityRealizationInvolvements(final ViatraQueryEngine engine) throws ViatraQueryException {
