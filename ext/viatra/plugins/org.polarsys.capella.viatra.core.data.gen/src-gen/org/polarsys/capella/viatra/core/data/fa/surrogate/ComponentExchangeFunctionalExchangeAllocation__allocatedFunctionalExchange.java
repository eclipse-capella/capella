...
public final class ComponentExchangeFunctionalExchangeAllocation__allocatedFunctionalExchange extends BaseGeneratedEMFQuerySpecification<ComponentExchangeFunctionalExchangeAllocation__allocatedFunctionalExchange.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link ComponentExchangeFunctionalExchangeAllocation__allocatedFunctionalExchange} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ComponentExchangeFunctionalExchangeAllocation__allocatedFunctionalExchange#instance()}.
   * 
