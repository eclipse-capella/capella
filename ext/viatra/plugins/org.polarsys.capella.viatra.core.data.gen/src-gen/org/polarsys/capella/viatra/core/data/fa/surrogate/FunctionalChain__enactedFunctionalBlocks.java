...
public final class FunctionalChain__enactedFunctionalBlocks extends BaseGeneratedEMFQuerySpecification<FunctionalChain__enactedFunctionalBlocks.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link FunctionalChain__enactedFunctionalBlocks} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalChain__enactedFunctionalBlocks#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/fa/5.0.0", "FunctionalChain", "enactedFunctions")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_0_, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/fa/5.0.0", "AbstractFunction", "allocationBlocks")));
