...
/**
 * A pattern-specific query specification that can instantiate PhysicalComponent__deployingPhysicalComponentsMatcher in a type-safe way.
 * 
 * @see PhysicalComponent__deployingPhysicalComponentsMatcher
 * @see PhysicalComponent__deployingPhysicalComponentsMatch
 * 
 */
@SuppressWarnings("all")
public final class PhysicalComponent__deployingPhysicalComponentsQuerySpecification extends BaseGeneratedEMFQuerySpecification<PhysicalComponent__deployingPhysicalComponentsMatcher> {
  private PhysicalComponent__deployingPhysicalComponentsQuerySpecification() {
   ...
   * 
   */
  public static PhysicalComponent__deployingPhysicalComponentsQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected PhysicalComponent__deployingPhysicalComponentsMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return PhysicalComponent__deployingPhysicalComponentsMatcher.on(engine);
  }
  
  @Override
  public PhysicalComponent__deployingPhysicalComponentsMatcher instantiate() throws ViatraQueryException {
    return PhysicalComponent__deployingPhysicalComponentsMatcher.create();
  }
  
  @Override
  public PhysicalComponent__deployingPhysicalComponentsMatch newEmptyMatch() {
    return PhysicalComponent__deployingPhysicalComponentsMatch.newEmptyMatch();
  }
  
  @Override
  public PhysicalComponent__deployingPhysicalComponentsMatch newMatch(final Object... parameters) {
    return PhysicalComponent__deployingPhysicalComponentsMatch.newMatch((org.polarsys.capella.core.data.pa.PhysicalComponent) parameters[0], (org.polarsys.capella.core.data.pa.PhysicalComponent) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalComponent__deployingPhysicalComponentsQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalComponent__deployingPhysicalComponentsQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static PhysicalComponent__deployingPhysicalComponentsQuerySpecification INSTANCE = new PhysicalComponent__deployingPhysicalComponentsQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static PhysicalComponent__deployingPhysicalComponentsQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_part, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/cs/1.4.0", "DeployableElement", "deployingLinks")));
              ...
              new TypeConstraint(body, new FlatTuple(var__virtual_1_, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/cs/1.4.0", "AbstractDeploymentLink", "location")));
              new TypeConstraint(body, new FlatTuple(var__virtual_2_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/cs/1.4.0", "DeploymentTarget")));
