...
public final class PhysicalArchitecture__allocatedLogicalArchitectureRealizations extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture__allocatedLogicalArchitectureRealizations.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_target = new PParameter("target", "org.polarsys.capella.core.data.pa.LogicalArchitectureRealization", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/pa/6.0.0", "LogicalArchitectureRealization")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/pa/6.0.0", "LogicalArchitectureRealization")));
