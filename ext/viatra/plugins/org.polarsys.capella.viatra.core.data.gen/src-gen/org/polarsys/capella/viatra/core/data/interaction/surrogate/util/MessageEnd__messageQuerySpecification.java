...
public final class MessageEnd__messageQuerySpecification extends BaseGeneratedEMFQuerySpecification<MessageEnd__messageMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pSelf = new PParameter("self", "org.polarsys.capella.core.data.interaction.MessageEnd", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/interaction/1.3.0", "MessageEnd")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/interaction/1.3.0", "MessageEnd")));
