...
public final class CapabilityRealization__participatingActorsQuerySpecification extends BaseGeneratedEMFQuerySpecification<CapabilityRealization__participatingActorsMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pTarget = new PParameter("target", "org.polarsys.capella.core.data.cs.AbstractActor", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/cs/1.4.0", "AbstractActor")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/cs/1.4.0", "AbstractActor")));
              ...
              new TypeConstraint(body, new FlatTuple(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/la/1.4.0", "CapabilityRealization", "involvedActors")));
