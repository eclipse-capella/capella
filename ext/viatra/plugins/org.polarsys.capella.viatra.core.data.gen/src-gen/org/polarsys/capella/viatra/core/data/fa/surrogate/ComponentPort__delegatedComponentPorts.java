...
public final class ComponentPort__delegatedComponentPorts extends BaseGeneratedEMFQuerySpecification<ComponentPort__delegatedComponentPorts.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.polarsys.capella.viatra.core.data.fa.surrogate.ComponentPort__delegatedComponentPorts (visibility: PUBLIC, simpleName: ComponentPort__delegatedComponentPorts, identifier: org.polarsys.capella.viatra.core.data.fa.surrogate.ComponentPort__delegatedComponentPorts, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.fa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.polarsys.capella.viatra.core.data.fa.surrogate.ComponentPort__delegatedComponentPorts (visibility: PUBLIC, simpleName: ComponentPort__delegatedComponentPorts, identifier: org.polarsys.capella.viatra.core.data.fa.surrogate.ComponentPort__delegatedComponentPorts, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.fa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/core/1.4.0", "InformationsExchanger", "outgoingInformationFlows")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_ce, var__virtual_3_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/fa/1.4.0", "ComponentExchange", "targetPort")));
