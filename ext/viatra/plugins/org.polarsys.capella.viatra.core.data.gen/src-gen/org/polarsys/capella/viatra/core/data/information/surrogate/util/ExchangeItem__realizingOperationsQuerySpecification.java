      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_eir, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/information/1.4.0", "ExchangeItemRealization", "realizingOperation")));
