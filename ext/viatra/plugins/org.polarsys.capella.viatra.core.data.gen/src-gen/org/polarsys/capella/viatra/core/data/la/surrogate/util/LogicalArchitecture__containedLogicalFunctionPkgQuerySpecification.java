...
public final class LogicalArchitecture__containedLogicalFunctionPkgQuerySpecification extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture__containedLogicalFunctionPkgMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pTarget = new PParameter("target", "org.polarsys.capella.core.data.la.LogicalFunctionPkg", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/la/1.4.0", "LogicalFunctionPkg")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/la/1.4.0", "LogicalFunctionPkg")));
