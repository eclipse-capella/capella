 ...
 * prepare a VIATRA Query engine for matching all patterns originally defined in file CapellaElement.vql, in order to
 * achieve better performance than one-by-one on-demand matcher initialization.
 * 
 * <p>
