...
public final class PhysicalArchitecture__containedCapabilityRealizationPkg extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture__containedCapabilityRealizationPkg.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.polarsys.capella.viatra.core.data.pa.surrogate.PhysicalArchitecture__containedCapabilityRealizationPkg (visibility: PUBLIC, simpleName: PhysicalArchitecture__containedCapabilityRealizationPkg, identifier: org.polarsys.capella.viatra.core.data.pa.surrogate.PhysicalArchitecture__containedCapabilityRealizationPkg, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.pa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.polarsys.capella.viatra.core.data.pa.surrogate.PhysicalArchitecture__containedCapabilityRealizationPkg (visibility: PUBLIC, simpleName: PhysicalArchitecture__containedCapabilityRealizationPkg, identifier: org.polarsys.capella.viatra.core.data.pa.surrogate.PhysicalArchitecture__containedCapabilityRealizationPkg, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.polarsys.capella.viatra.core.data.pa.surrogate) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
