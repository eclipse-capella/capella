...
public final class AbstractInstance__representingInstanceRolesQuerySpecification extends BaseGeneratedEMFQuerySpecification<AbstractInstance__representingInstanceRolesMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pSelf = new PParameter("self", "org.polarsys.capella.core.data.information.AbstractInstance", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/core/information/1.4.0", "AbstractInstance")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/information/1.4.0", "AbstractInstance")));
              ...
              new TypeConstraint(body, new FlatTuple(var_target, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/core/interaction/1.4.0", "InstanceRole", "representedInstance")));
              new TypeConstraint(body, new FlatTuple(var__virtual_0_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/core/information/1.4.0", "AbstractInstance")));
