...
public final class AbstractActivity__ownedStructuredNodesQuerySpecification extends BaseGeneratedEMFQuerySpecification<AbstractActivity__ownedStructuredNodesMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_pSelf = new PParameter("self", "org.polarsys.capella.common.data.activity.AbstractActivity", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.polarsys.org/capella/common/activity/1.4.0", "AbstractActivity")), PParameterDirection.INOUT);
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_self), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.polarsys.org/capella/common/activity/1.4.0", "AbstractActivity")));
              ...
              new TypeConstraint(body, new FlatTuple(var_self, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.polarsys.org/capella/common/activity/1.4.0", "AbstractActivity", "ownedGroups")));
