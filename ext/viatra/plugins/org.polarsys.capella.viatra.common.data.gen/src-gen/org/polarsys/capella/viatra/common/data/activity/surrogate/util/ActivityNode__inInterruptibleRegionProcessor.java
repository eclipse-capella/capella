...
/**
 * A match processor tailored for the org.polarsys.capella.viatra.common.data.activity.surrogate.ActivityNode__inInterruptibleRegion pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ActivityNode__inInterruptibleRegionProcessor implements IMatchProcessor<ActivityNode__inInterruptibleRegionMatch> {
  /**
  ...
  @Override
  public void process(final ActivityNode__inInterruptibleRegionMatch match) {
