...
public class UniqueIDInPluginsTest extends BasicTestCase {
  ...
  public void test() throws Exception {
    ...
    IConfigurationElement[] categories = ExtensionPointHelper
            .getConfigurationElements(FrameworkUtil.getBundle(org.polarsys.capella.common.ui.toolkit.browser.category.Messages.class).getSymbolicName(), CONTENT_PROVIDER_CATEGORY);
