...
public class CreateImplements extends EmptyProject {
  ...
  public void test() throws Exception {
    ...
    new CreateDEdgeTool(diagramContext, IToolNameConstants.TOOL_IDB_CREATE_IMPLEMENTS,
        GenericModel.INTERFACE_IMPLEMENTS_1, GenericModel.LC_1, GenericModel.INTERFACE_1).run();

    mustBeInstanceOf(diagramContext, GenericModel.INTERFACE_IMPLEMENTS_1, CsPackage.Literals.INTERFACE_IMPLEMENTATION);

    mustBeLinkedTo(diagramContext, GenericModel.INTERFACE_IMPLEMENTS_1, GenericModel.LC_1,
        CsPackage.Literals.INTERFACE_IMPLEMENTATION__INTERFACE_IMPLEMENTOR);

    mustBeLinkedTo(diagramContext, GenericModel.INTERFACE_IMPLEMENTS_1, GenericModel.INTERFACE_1,
        CsPackage.Literals.INTERFACE_IMPLEMENTATION__IMPLEMENTED_INTERFACE);

    new CreateDEdgeTool(diagramContext, IToolNameConstants.TOOL_IDB_CREATE_IMPLEMENTS,
        GenericModel.INTERFACE_IMPLEMENTS_1, GenericModel.LC_1, GenericModel.INTERFACE_1).cannotRun();
  }
}
