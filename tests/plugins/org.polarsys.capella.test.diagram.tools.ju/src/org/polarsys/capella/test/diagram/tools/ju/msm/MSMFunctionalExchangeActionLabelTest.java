...
public class MSMFunctionalExchangeActionLabelTest extends EmptyProject {
    ...
    xdfb.createFunction(GenericModel.FUNCTION_2);
		...
		sabDiagram.createFunctionalExchange(GenericModel.FUNCTION_1, GenericModel.FUNCTION_2, GenericModel.FUNCTIONAL_EXCHANGE_1);
		final FunctionalExchange fe1 = (FunctionalExchange) sabDiagram.getSemanticElement(GenericModel.FUNCTIONAL_EXCHANGE_1);
		
		MSMDiagram msmDiagram = MSMDiagram.createDiagram(context, EmptyProject.SA__SYSTEM__SYSTEM_STATE_MACHINE__DEFAULT_REGION);
    ...
    Iterator<DDiagramElement> doIt = getDiagramElements(diagram, IMappingNameConstants.MSM_DOACTIVITY_MAPPING_NAME, fe1).iterator();
    Iterator<DDiagramElement> entryIt = getDiagramElements(diagram, IMappingNameConstants.MSM_ENTRY_MAPPING_NAME, fe1).iterator();
    Iterator<DDiagramElement> exitIt = getDiagramElements(diagram, IMappingNameConstants.MSM_EXIT_MAPPING_NAME, fe1).iterator();
