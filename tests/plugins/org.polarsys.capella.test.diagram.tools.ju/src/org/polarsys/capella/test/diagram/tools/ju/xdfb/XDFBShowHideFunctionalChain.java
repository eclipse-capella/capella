...
public class XDFBShowHideFunctionalChain extends XDFBToolsTestingModel {
  ...
  private void testOnXDFBDiagram(SessionContext context, String diagramName, Type diagramType) {
    ...
    xdfb.hideElements(diagramId, XDFBInsertRemoveTools.INSERT_REMOVE_FUNCTIONAL_CHAINS, GenericModel.PATH_1);
    xdfb.showElements(diagramId, XDFBInsertRemoveTools.INSERT_REMOVE_FUNCTIONAL_CHAINS, GenericModel.PATH_1);
  }
}
