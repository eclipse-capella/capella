...
public class ManageRoleAllocation extends XABDiagramsProject {
  ...
  public void testOnXAB(SessionContext context, String diagramName, String roleId, String containerId) {
    ...
    diagram.manageAllocatedRolesRemove(roleId, containerId);
    diagram.manageAllocatedRolesInsert(roleId, containerId);
  }
