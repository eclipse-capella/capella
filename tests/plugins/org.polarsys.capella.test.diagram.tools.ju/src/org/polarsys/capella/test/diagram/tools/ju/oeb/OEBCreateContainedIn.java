...
public class OEBCreateContainedIn extends AbstractDiagramTestCase {
  ...
  public void test() throws Exception {
    ...
    String sourceId = diagram.createOperationalEntity(containerId);
    String targetId = diagram.createOperationalEntity(containerId);

    diagram.createContainedIn(containerId, sourceId, targetId);
  }
