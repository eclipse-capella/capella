...
public class XDFBShowHideConstraint extends XDFBToolsTestingModel {
  ...
  private void testOnXDFBDiagram(SessionContext context, String diagramName, final Type diagramType) {
    ...
    xdfb.hideElements(diagramId, XDFBInsertRemoveTools.INSERT_REMOVE_CONSTRAINTS, constraintId);
    xdfb.showElements(diagramId, XDFBInsertRemoveTools.INSERT_REMOVE_CONSTRAINTS, constraintId);
  }
}
