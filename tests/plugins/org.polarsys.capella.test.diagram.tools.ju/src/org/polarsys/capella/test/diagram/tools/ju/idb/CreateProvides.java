...
public class CreateProvides extends EmptyProject {
  ...
  public void test() throws Exception {
    ...
    new CreateDEdgeTool(diagramContext, IToolNameConstants.TOOL_IDB_CREATE_PROVIDES, GenericModel.INTERFACE_PROVIDES_1,
    ...
    new CreateDEdgeTool(diagramContext, IToolNameConstants.TOOL_IDB_CREATE_PROVIDES, GenericModel.COMPONENT_PORT_1,
        GenericModel.COMPONENT_PORT_1, GenericModel.INTERFACE_PROVIDES_1, GenericModel.COMPONENT_PORT_1,
