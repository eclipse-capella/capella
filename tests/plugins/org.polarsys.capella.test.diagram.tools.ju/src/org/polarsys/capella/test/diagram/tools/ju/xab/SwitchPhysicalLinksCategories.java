...
public class SwitchPhysicalLinksCategories extends XABDiagramsProject {
  ...
  public void test() throws Exception {
    ...
    testOnXAB(context, SA__SAB_DIAGRAM, BlockArchitectureExt.Type.SA,
        SA__SAB_PHYSICAL_LINK_CATEGORY1, SA__SAB_PHYSICAL_LINK_PL1,
        SA__SAB_PHYSICAL_PATH1, SA__SAB_PHYSICAL_PORT_A2_PP1,
        SA__SAB_PHYSICAL_PORT_A2_PP3);
    testOnXAB(context, LA__LAB_DIAGRAM, BlockArchitectureExt.Type.LA,
        LA__LAB_PHYSICAL_LINK_CATEGORY1, LA__LAB_PHYSICAL_LINK_PL1,
        LA__LAB_PHYSICAL_PATH1, LA__LAB_PHYSICAL_PORT_A2_PP1,
        LA__LAB_PHYSICAL_PORT_A2_PP3);
    testOnXAB(context, PA__PAB_DIAGRAM, BlockArchitectureExt.Type.PA,
        PA__PAB_PHYSICAL_LINK_CATEGORY1, PA__PAB_PHYSICAL_LINK_PL1,
        PA__PAB_PHYSICAL_PATH1, PA__PAB_PHYSICAL_PORT_PC2_PP1,
  ...
  public void testOnXAB(SessionContext context, String diagramName, BlockArchitectureExt.Type type,
      String categoryId, String linkId, String pathId, String source, String target) {
    ...
    EObject sElement = diagram.getSemanticElement(source);
    EObject tElement = diagram.getSemanticElement(target);
