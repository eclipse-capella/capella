...
public class MSMDragAndDropStates extends EmptyProject {
  ...
  public void test() throws Exception {
    ...
    new CreateContainerTool(diagramContext, IToolNameConstants.TOOL_MSM_CREATE_STATE, diagramContext.getDiagramId(), GenericModel.STATE_1).run();
    new CreateContainerTool(diagramContext, IToolNameConstants.TOOL_MSM_CREATE_STATE, diagramContext.getDiagramId(), GenericModel.STATE_2).run();
