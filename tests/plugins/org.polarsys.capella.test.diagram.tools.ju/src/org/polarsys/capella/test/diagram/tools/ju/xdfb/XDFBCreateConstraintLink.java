...
public class XDFBCreateConstraintLink extends XDFBToolsTestingModel {
  ...
  private void testOnXDFBDiagram(SessionContext context, String diagramName, final Type diagramType) {
    ...
    String functionId = xdfb.createContainer(diagramId, XDFBCreateContainerTools.CREATE_FUNCTION);

    xdfb.createEdge(constraintId, functionId, XDFBCreateEdgeTools.CREATE_CONSTRAINT_LINK);
  }
}
