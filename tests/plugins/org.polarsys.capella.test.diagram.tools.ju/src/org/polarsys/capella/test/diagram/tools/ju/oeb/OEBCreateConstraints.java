...
public class OEBCreateConstraints extends AbstractDiagramTestCase {
  ...
  public void test() throws Exception {
    ...
    String id = diagram.createConstraint("OEBConstraints");

    diagram.removeConstraint("OEBConstraints", containerId);
  }
