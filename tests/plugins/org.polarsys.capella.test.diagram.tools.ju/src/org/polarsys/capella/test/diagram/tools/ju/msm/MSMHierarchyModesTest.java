...
/**
 */
public class MSMHierarchyModesTest extends EmptyProject {
  ...
  public void test() throws Exception {
    ...
    diagram.cannotCreateState(diagram.getDiagramId(), GenericModel.STATE_1);
    diagram.cannotCreateState(GenericModel.REGION_2, GenericModel.STATE_2);
    diagram.createMode(GenericModel.REGION_1, GenericModel.MODE_3);
