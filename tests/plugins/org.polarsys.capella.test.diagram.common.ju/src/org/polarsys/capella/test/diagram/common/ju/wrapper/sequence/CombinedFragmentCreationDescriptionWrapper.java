...
public class CombinedFragmentCreationDescriptionWrapper extends NodeCreationDescriptionWrapper {

  public CombinedFragmentCreationDescriptionWrapper(AbstractToolDescription tool, IDiagramCommandFactory commandFactory) {
  ...
  public Command createCommand() {
    ...
    if (isContextOk()) {
      CombinedFragmentCreationTool tool = (CombinedFragmentCreationTool) _tool;
      ...
      cmd =
          ToolCommandBuilder.buildCreateCombinedFragmentCommandFromTool((DDiagram) container, tool, startingEndPredecessor, finishingEndPredecessor, coverage);
    }
