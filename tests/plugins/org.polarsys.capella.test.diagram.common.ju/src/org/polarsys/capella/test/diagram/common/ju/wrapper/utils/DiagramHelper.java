...
public class DiagramHelper {
  ...
  public static void checkDiagramInSession(DRepresentation representation, String filepath) {
    ...
    // Assert.assertTrue(MessageFormat.format(HelperMessages.diagramNotContainedInSession, representation_p.getName(),
  ...
  public static void removeView(DDiagramElement element) {
    ...
    } else if (element instanceof DContainer) {
  ...
  public static ShapeStyle getNote(DDiagram diagram_input, String description) {
    EList<AnnotationEntry> ownedAnnotationEntries = diagram_input.getOwnedAnnotationEntries();
  ...
  @SuppressWarnings("nls")
  public static List<ShapeStyle> getDiagramNotes(DDiagram diagram_input) {
  ...
  public static List<Edge> getDiagramNoteAttachments(DDiagram diagram_input) {
