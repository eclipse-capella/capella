...
/**
 */
public abstract class AbstractInterfaceDecompositionRefinementTest extends RefinementTest {
  ...
  public List<String> getRequiredTestModels() {
    return Arrays.asList("InterfaceDecompositionRefinement_TCs");
  }
}
