...
/**
 */
public abstract class AbstractSimpleRefinementTest extends RefinementTest {
  ...
  public List<String> getRequiredTestModels() {
    return Arrays.asList("SimpleRefinement_TCs");
  }
}
