...
public class ShowAllocatedInteractionsOnCommunicationMeansForOAB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_OAB_SHOW_ALLOCATED_INTERACTIONS_ON_COMMUNICATION_MEANS_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(new String[] { ";Interaction 4;" });
  }
