...
public class ShowInteractionE1E2ForOAB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_OAB_SHOW_FUNCTIONAL_EXCHANGES_EXCHANGEITEMS_ON_INTERACTIONS_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(new String[] { ";Interaction 2 [];", ";Interaction 4 [ExchangeItem 3];", ";Interaction 5 [];",
        ";Interaction 6 [ExchangeItem 1];", ";Interaction 7 [];" });
  }
