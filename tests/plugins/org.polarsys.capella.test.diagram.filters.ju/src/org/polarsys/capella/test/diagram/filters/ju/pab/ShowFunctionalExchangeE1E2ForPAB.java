...
public class ShowFunctionalExchangeE1E2ForPAB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_PAB_SHOW_FUNCTIONAL_EXCHANGES_EXCHANGEITEMS_ON_FUNCTIONAL_EXCHANGES_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(
        new String[] { ";FunctionalExchange 6 [ExchangeItem 1, ExchangeItem 2];", ";FunctionalExchange 7 [];" });
  }
