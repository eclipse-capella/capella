...
public class ShowFunctionalExchangeWithTypesForSAB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_SAB_SHOW_FUNCTIONAL_EXCHANGES_PARAMETERS_ON_FUNCTIONAL_EXCHANGES_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(new String[] { ";FunctionalExchange 5();", ";FunctionalExchange 6();" });
  }
