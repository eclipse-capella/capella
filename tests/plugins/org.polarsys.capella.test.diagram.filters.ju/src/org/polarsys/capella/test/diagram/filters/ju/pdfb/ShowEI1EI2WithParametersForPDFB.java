...
public class ShowEI1EI2WithParametersForPDFB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_PDFB_SHOW_EXCHANGEITEMS_PARAMETERS_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(new String[] { ";DEdge;", ";DEdge;" });
  }
