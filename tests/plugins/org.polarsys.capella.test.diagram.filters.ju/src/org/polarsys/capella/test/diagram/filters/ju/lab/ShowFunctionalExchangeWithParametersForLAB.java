...
public class ShowFunctionalExchangeWithParametersForLAB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_LAB_SHOW_FUNCTIONAL_EXCHANGES_EXCHANGEITEMS_PARAMETERS_ON_FUNCTIONAL_EXCHANGES_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(
        new String[] {
            ";FunctionalExchange 6 [ExchangeItem 1(ExchangeItemElement 1 : Boolean), ExchangeItem 2()];",
