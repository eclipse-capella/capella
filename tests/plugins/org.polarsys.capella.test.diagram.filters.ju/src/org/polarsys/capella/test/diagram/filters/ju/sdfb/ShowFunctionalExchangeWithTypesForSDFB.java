...
public class ShowFunctionalExchangeWithTypesForSDFB extends LabelFilterTestCase {
  ...
  protected String getFilterName() {
    return IFilterNameConstants.FILTER_SDFB_SHOW_FUNCTIONAL_EXCHANGES_PARAMETERS_ID;
  }
  ...
  protected List<String> getExpectedElementLabels() {
    return Arrays.asList(new String[] { ";FunctionalExchange 2();", ";FunctionalExchange 3();" });
  }
