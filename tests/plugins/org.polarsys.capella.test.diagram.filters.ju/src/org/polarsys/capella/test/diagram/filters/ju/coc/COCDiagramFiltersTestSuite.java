...
public class COCDiagramFiltersTestSuite extends BasicTestSuite {
  ...
  protected List<BasicTestArtefact> getTests() {
    ...
    tests.add(new HideOperationalCapabilityIncludesForCOC());
    tests.add(new HideOperationalCapabilityGeneralizationsForCOC());
    tests.add(new HidePropertyValuesForCOC());
    return tests;
  }
