    ...
    return new PerformAutomatedTransitionAdapter() {
      ...
      public void linkPressed(HyperlinkEvent event, EObject rootSemanticModel, Session session) {
        ...
        if (modelElement != null) {
          TransactionHelper.getExecutionManager(modelElement).execute(TransitionCommandHelper.getInstance()
              .getFunctionalTransitionCommand(Collections.singleton((Object) modelElement), new NullProgressMonitor()));
