...
import org.polarsys.capella.core.explorer.activity.ui.hyperlinkadapter.la.NewScenarioDiagramAdapter;
import org.polarsys.capella.core.model.helpers.ModelQueryHelper;

public class ISLogicalActivityExplorerTestCase extends FunctionalScenarioActivityExplorerTestCase {
  
  @Override
  public AbstractCapellaNewDiagramHyperlinkAdapter createLink() {
    return new NewScenarioDiagramAdapter() {
      @Override
  ...
  public ModelElement getTestModelElement() {
    ...
    return ModelCreationHelper.selectCapabilityAndCreateScenario(project, logicalArchitecture,
        null);
  }
  ...
  public String getDefaultName() {
    return "[IS] CapabilityRealization 1";
