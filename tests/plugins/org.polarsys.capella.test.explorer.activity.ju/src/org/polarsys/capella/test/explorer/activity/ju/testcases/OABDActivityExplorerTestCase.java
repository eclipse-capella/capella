...
public class OABDActivityExplorerTestCase extends DiagramActivityExplorerTestCase {

  @Override
  protected AbstractCapellaNewDiagramHyperlinkAdapter createLink() {
    return new NewOperationalActivityBreakdownDiagramAdapter() {
      @Override
  ...
  public ModelElement getTestModelElement() {
    return (ModelElement) ((NewOperationalActivityBreakdownDiagramAdapter) link).getModelElement(project);
  }
