...
import org.polarsys.capella.core.explorer.activity.ui.hyperlinkadapter.pa.NewFunctionalScenarioAdapter;
import org.polarsys.capella.core.model.helpers.ModelQueryHelper;

public class FSPhysicalActivityExplorerTestCase extends FunctionalScenarioActivityExplorerTestCase {
  
  @Override
  public AbstractCapellaNewDiagramHyperlinkAdapter createLink() {
    return new NewFunctionalScenarioAdapter() {
      @Override
  ...
  public String getDefaultName() {
    return "[FS] CapabilityRealization 1";
  }
}
