...
public class SimpleResolver implements IResolver {
  ...
  /**
   * @see org.polarsys.capella.core.tiger.IResolver#resolve(org.eclipse.emf.ecore.EObject, java.util.List, java.lang.String, java.lang.String, boolean, org.polarsys.capella.core.tiger.ITransfo)
   */
  @Override
  public List<EObject> resolve(EObject source_p, List<EObject> items_p, String title_p, String message_p, boolean multipleSelection_p, ITransfo transfo_p, EObject[] context) {
