...
public class CreateRule_IS2IS_ItfEI_03 extends CreateRule_Scenario_IS2IS {
  ...
  public void performTest() throws Exception {
    ...
    //InstanceRole shall refer to the new exchangeItem
    //All operations shall refer to a new interface refering the new exchangeItem
    ...
    ExchangeItem transitedSharedData = mustBeMonoTransitioned(SharedData);
    ExchangeItem transitedOperation = mustBeMonoTransitioned(Operation);
    
    InstanceRole role = mustBeMonoTransitioned(IR_SharedData);
    assertTrue(((ExchangeItemInstance)role.getRepresentedInstance()).getAbstractType() == transitedSharedData);
    
    SequenceMessage message = mustBeMonoTransitioned(SM1_SharedData);
    assertEquals(((ExchangeItemAllocation)SequenceMessageExt.getOperation(message)).getAllocatedItem(), transitedSharedData);
    ...
    assertEquals(((ExchangeItemAllocation)SequenceMessageExt.getOperation(message2)).getAllocatedItem(), transitedSharedData);
    ...
    assertEquals(((ExchangeItemAllocation)SequenceMessageExt.getOperation(message3)).getAllocatedItem(), transitedSharedData);
    ...
    assertEquals(((ExchangeItemAllocation)SequenceMessageExt.getOperation(message4)).getAllocatedItem(), transitedOperation);
