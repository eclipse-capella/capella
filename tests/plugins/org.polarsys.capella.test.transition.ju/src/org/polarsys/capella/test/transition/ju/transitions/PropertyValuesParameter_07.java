...
public class PropertyValuesParameter_07 extends TopDownTransitionTestCase {
  ...
  private void step1() {
    ...
    performPropertyValueTransition(Arrays.asList(getObject(id_pvp1)));
    mustBeTransitioned(id_pvp1);
    mustBeTransitioned(id_bpv11);
    mustBeTransitioned(id_ipv12);
