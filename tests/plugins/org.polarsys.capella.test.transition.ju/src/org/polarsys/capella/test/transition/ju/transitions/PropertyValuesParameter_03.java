...
public class PropertyValuesParameter_03 extends TopDownTransitionTestCase {
  ...
  private void step1() {
    ...
    shouldNotBeTransitioned(id_bpv11);
    ...
    mustBeTransitionedAndLinkedTo(id_sf111, id_bpv11,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndNotLinkedToTransitioned(id_sf111, id_bpv11,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);

    mustBeLinkedTo(id_sf111, id_bpv111, CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndLinkedTo(id_sf111, id_bpv111,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndNotLinkedToTransitioned(id_sf111, id_bpv111,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);

    mustBeLinkedTo(id_sf111, id_bpv1111, CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndLinkedTo(id_sf111, id_bpv1111,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndNotLinkedToTransitioned(id_sf111, id_bpv1111,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);

    mustBeLinkedTo(id_sf111, id_bpv11_1, CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndLinkedTo(id_sf111, id_bpv11_1,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
    mustBeTransitionedAndNotLinkedToTransitioned(id_sf111, id_bpv11_1,
        CapellacorePackage.Literals.CAPELLA_ELEMENT__APPLIED_PROPERTY_VALUES);
  }
