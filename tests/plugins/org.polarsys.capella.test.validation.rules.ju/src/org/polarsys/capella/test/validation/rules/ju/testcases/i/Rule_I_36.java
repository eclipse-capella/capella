...
public class Rule_I_36 extends AbstractRulesOnIntegrityTest {
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"f4a96328-5b2b-48b7-86b7-b636f7ce6d54",     // pre/post condition of Capability
				...
				"e57caeaa-086a-4c3b-8149-c42bd1b21a27"});   // Constraint OK
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] {
			new OracleDefinition("f4a96328-5b2b-48b7-86b7-b636f7ce6d54", 1),
			new OracleDefinition("366eef0b-37ab-4037-a618-7c14d1f38685", 1),
			new OracleDefinition("a4bcfd4f-5b59-4164-b141-02e20fa25dbc", 1),
			new OracleDefinition("6865fef6-fa31-4a6b-836f-0061929df538", 1),
			new OracleDefinition("9ca7eda0-d5c5-4b7f-a823-83987284722a", 1),
			new OracleDefinition("9f5fd4d4-1273-4c5d-bbeb-e7c4e4d5b12e", 1),
			new OracleDefinition("2303f3f0-d1db-457e-af6a-f21e8a25da80", 1)});
	}                             
}
