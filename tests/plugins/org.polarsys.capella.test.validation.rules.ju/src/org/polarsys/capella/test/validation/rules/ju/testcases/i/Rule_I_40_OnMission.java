 ...
 * @generated
 */
public class Rule_I_40_OnMission extends AbstractRulesOnIntegrityTest {

  private final static String MISSION_1 = "75f29c7e-09bd-4475-a2cd-1adfe4f35a67";
  private final static String MISSION_2 = "0c29dd27-b23f-4255-8abf-6603f6d81c89";
  ...
  protected List<String> getScopeDefinition() {
    return Arrays.asList(new String[] { MISSION_1, MISSION_2 });
  }
  ...
  protected List<OracleDefinition> getOracleDefinitions() {
    return Arrays
        .asList(new OracleDefinition[] { new OracleDefinition(MISSION_1, 1), new OracleDefinition(MISSION_2, 0) });
  }
}
