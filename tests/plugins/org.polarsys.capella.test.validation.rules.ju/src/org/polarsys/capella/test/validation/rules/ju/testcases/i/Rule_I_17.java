...
/**
 * test on I_17: This rule checks that context packages contain at least one component (the root component) of the correct level.
 * @generated
 */
public class Rule_I_17 extends AbstractRulesOnIntegrityTest {
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"0d633b9a-fc02-4ec0-9b2a-8d53fe43ce00",
				"6f14c2e9-5cde-41e5-8c92-c70bdad319a1" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"6f14c2e9-5cde-41e5-8c92-c70bdad319a1", 1) });
	}
}
