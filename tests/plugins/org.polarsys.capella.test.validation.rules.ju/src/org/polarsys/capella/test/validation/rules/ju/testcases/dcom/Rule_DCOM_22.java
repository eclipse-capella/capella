...
/**
 * Test the validation rule for unsynchronized exchange items on function ports
 */
public class Rule_DCOM_22 extends ValidationRulePartialTestCase {
  ...
  protected String getRequiredTestModel() {
    return "testUnsynchronizedExchangeItems"; //$NON-NLS-1$
  }
  ...
  protected String getRuleID() {
    return "org.polarsys.capella.core.data.fa.validation.DCOM_22"; //$NON-NLS-1$
  }
