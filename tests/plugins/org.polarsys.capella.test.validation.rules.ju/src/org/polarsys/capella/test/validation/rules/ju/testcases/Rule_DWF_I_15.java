...
public class Rule_DWF_I_15 extends ValidationRuleTestCase {
  ...
  protected List<OracleDefinition> getOracleDefinitions() {
    return Arrays.asList(new OracleDefinition[] { new OracleDefinition("d74adaeb-393b-426c-b5c9-a507f9ea02d6", 1), //$NON-NLS-1$
  ...
  public void testRule_DWF_I_15() throws Exception {
    test();
  }
}
