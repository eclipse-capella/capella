...
public class Rule_DWF_DF_18 extends Project_DWF_DF_for_SL_CN {
  ...
  protected List<OracleDefinition> getOracleDefinitions() {
    return Arrays.asList(new OracleDefinition[] { new OracleDefinition(OA_SEQUENCE_LINK_4, 1),
        new OracleDefinition(SA_SEQUENCE_LINK_4, 1), new OracleDefinition(LA_SEQUENCE_LINK_4, 1) });
  }
}
