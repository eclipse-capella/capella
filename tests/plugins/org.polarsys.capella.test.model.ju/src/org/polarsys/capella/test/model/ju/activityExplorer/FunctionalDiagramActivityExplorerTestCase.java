...
public abstract class FunctionalDiagramActivityExplorerTestCase extends MiscModel {
  Session session;
  SessionContext context;
  CapellaModel model;
  Project project;
  AbstractCapellaNewDiagramHyperlinkAdapter link;
  AbstractFunction structure;
  ...
  public abstract AbstractFunction getStructure();
  ...
  public void test() throws Exception {
    ...
    assertEquals((AbstractFunction) modelElement, structure);
