...
public class InsertAssociationOnCDBTestSuite extends BenchmarkTestSuite {
  /**
   * Returns the suite. This is required to unary launch this test.
   */
  public static Test suite() {
    return new InsertAssociationOnCDBTestSuite();
  }

  @Override
  protected BasicTestArtefact initMainTestCase(List<DiagramContext> contexts) {
    return new InsertAssociationOnCDBTestCase(contexts);
  }

  @Override
  protected BasicTestArtefact initSetUpTestCase(List<DiagramContext> contexts, BasicTestArtefact mainTestCase) {
    return new InsertAssociationOnCDBSetUpTestCase(contexts, mainTestCase);
  }
}
