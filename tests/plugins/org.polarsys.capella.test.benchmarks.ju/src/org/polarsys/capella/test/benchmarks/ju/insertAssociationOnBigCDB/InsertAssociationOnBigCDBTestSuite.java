...
public class InsertAssociationOnBigCDBTestSuite extends BenchmarkTestSuite {

  /**
   * Returns the suite. This is required to unary launch this test.
   */
  public static Test suite() {
    return new InsertAssociationOnBigCDBTestSuite();
  }

  @Override
  protected BasicTestArtefact initMainTestCase(List<DiagramContext> contexts) {
    return new InsertAssociationOnBigCDBTestCase(contexts);
  }

  @Override
  protected BasicTestArtefact initSetUpTestCase(List<DiagramContext> contexts, BasicTestArtefact mainTestCase) {
    return new InsertAssociationOnBigCDBSetUpTestCase(contexts, mainTestCase);
  }
}
