...
public class UpdateRPL_AddElementWithSuffix extends Re {
  ...
  public void performTest() throws Exception {
    ...
    String RPL_elementNameBefore = ((LogicalFunction) RPL_LF1).getName();
    ...
    assertEquals(RPL_elementNameAfter, RPL_elementNameBefore + suffix);
  }
}
